...
- `singularity/` owns acceleration, agency, substrate, alignment, protocol,
  architecture, and design-pressure questions
...
- what substrate or protocol is doing the causal work
- whether the object is still better handled as acceleration doctrine than as
  public judgment
...
The handoff is only valid when the governing question has actually changed from:
...
```text
singularity should hand off when acceleration stops being the topic
and starts becoming a judgment problem
```

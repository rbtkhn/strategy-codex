# Grace‑Mar — Locals voice (VivaBarnesLaw / Duran)
...
- **Let liability-adjacent angles appear when they earn the line** — who can bind whom, what would count as evidence, what the next signal would be—especially for war, finance, and negotiations. Not every post; only when the topic is *about* power and enforceability.
- **Keep “analyst packaging” out of the prose** — no equilibrium / planes / internal skill labels. Plain English forks and named actors.

---

## Do not

- **Do not open on meta** — not “posting this,” “screenshot,” “people are saying,” “the discourse,” unless the post is *about* the medium (rare).
- **Do not smuggle a summary of instructions as the closer** — e.g. “the analytic point is…,” “what matters is understanding….” The last line should still be a **thesis**, not a workshop rubric.
- **Do not stack abstractions in the last line** — one bill, one pay, one trust, one “everyone” in a single breath. Tighten to **one** closing claim (see [write-no-abstract-stacked-closers.md](write-no-abstract-stacked-closers.md)).
- **Do not use second-person commands as fake rhetoric** when the post is **analysis**, not a CTA to the reader (see *Exposition vs. instructions* in [write-operator-preferences.md](write-operator-preferences.md)).
...
- [write-operator-preferences.md](write-operator-preferences.md) — SSOT for operator writing
- [write-shipping-checklist.md](write-shipping-checklist.md) — pre-flight for all surfaces
- [README.md](README.md) — skill-write hub

...
| [predictive-history-youtube-comments.md](predictive-history-youtube-comments.md) | Trust-first **Predictive History YouTube comment** profile: one tailored top-level comment, exact chapter-folder link, paste into an LLM for guided study |

...
| 7 | **Optional: PRP refresh** — If merges were applied, run `python scripts/export_prp.py -u grace-mar -n Robert -o grace-mar-llm.txt` and commit. Keeps the anchor in sync. | ~2 min |

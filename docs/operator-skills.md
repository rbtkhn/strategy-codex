...
| Skill | Say this | Note |
|------|----------|------|
| `coffee` | **coffee** | Canonical cadence skill; **signing-off** intent = handoff-weighted Step 1, same **A-D** Coffee Hub Menu (**A** Steward, **B** Engineer, **C** Strategist, **D** Singularity). Conductor is standalone via **`conductor`** / master name, not a coffee hub letter. Legacy **hey** still works. |

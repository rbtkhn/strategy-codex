...
| **Recursive learn** | standalone only | direct activation | `recursive learn`, `recursive-learn`, `RLJ`, or [recursive-learn skill](../../../.cursor/skills/recursive-learn/SKILL.md); not part of the coffee hub. |

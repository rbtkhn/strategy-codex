...
**`coffee` C - Statecraft** opens the WORK-only academy-statecraft civilizational-state bench at [Statecraft Workshop](../../../codex/academy/statecraft/README.md): **A. America - hegemonic order under strain**, **B. China - civilizational stabilizer**, **C. Persia - deep civilization, dignity, leverage, recognition**, and **D. Russia - strategic depth, disruption, optionality**. After the pick, route directly to the corresponding lane front door; treaty, policy, negotiation, and Richelieu/Bismarck instruments stay downstream inside the lane. Agents should **not** auto-run the daily brief, `check streams`, bookshelf elicitation, or archived Tri-Frame before this submenu. Those remain explicit named routes unless the operator asks to convert source material into a statecraft instrument.

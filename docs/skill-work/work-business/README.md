...
| **[operator-playbooks.md](operator-playbooks.md)** | Short discovery layer for venture ideation, offer blueprinting, and monthly operating review workflows. |
...
| **[singularity-academy-sprint-scorecard.md](singularity-academy-sprint-scorecard.md)** | Before/after scoring surface for making sprint improvement legible without inflated ROI claims. |
| **[singularity-academy-sprint-receipt-template.md](singularity-academy-sprint-receipt-template.md)** | Reusable closeout receipt showing what changed, what artifacts exist, and what remained weak. |

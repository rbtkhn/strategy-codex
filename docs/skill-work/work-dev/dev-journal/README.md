...
The work-dev **dev journal** (day files, rolling inbox, routing vs cici-notebook) now lives under **[dev-notebook/work-dev/journal/](../dev-notebook/work-dev/journal/README.md)**.

# work-strategy — surface map (grace-mar)

**Not** an external Git tree. Canonical **in-repo** strategy surfaces and a few **research** entry points. Re-read [work-strategy README](../../../work-strategy/README.md) when adding rows.

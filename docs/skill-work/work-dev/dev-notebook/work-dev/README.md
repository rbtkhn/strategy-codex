...
- **Holds** durable **spec captures** in this `work-dev` folder (e.g. future paste-ready integration prompts). The **inward, day-scale journal** lives in [journal/](journal/README.md) (LIB-0155, symlink from [`platform/users/grace-mar/SELF-LIBRARY/dev-journal`](../../../../../platform/users/grace-mar/SELF-LIBRARY/dev-journal)). **[Conductor](../../../../../.cursor/skills/conductor/SKILL.md)** (operator: say **`conductor`**) **closes** and **Kleiber**-style **action** **MCQ** for **work-dev** **objects** are **wired** here — see [dev-notebook — Conductor (work-dev)](../README.md#conductor-work-dev) and [Conductor in dev journal](journal/README.md#conductor-in-dev-journal).

...
| **Derived regeneration foundation** | **Partial:** repo-owned [derived-regeneration.md](derived-regeneration.md) now includes a phase-1 change detector, regeneration entrypoint, rebuild receipts, a generated target manifest, a rebuild-health summary target, and rebuild-health telemetry for a small initial target set. Runtime-triggered rebuild requests remain explicitly deferred. |

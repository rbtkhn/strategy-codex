...
| Input-grounded A/B/C | In protocol and prompt: A, B, C must be **about this decision** (this context, this question), not generic template language. Add to [../work-politics/polyphonic-cognition-protocol-skill.md](../work-politics/polyphonic-cognition-protocol-skill.md) if not already explicit. |

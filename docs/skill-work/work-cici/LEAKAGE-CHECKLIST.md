# LEAKAGE-CHECKLIST â€” handoff to Ciciâ€™s companion instance (legacy repo name `companion-xavier`)

Use before publishing exports, paste-heavy handoffs, or opening PRs that touch **her** instance â€” so **grace-mar Record** never lands in her tree without pipeline.

- [ ] **No** `` path strings in files destined for **her** `xavier/` tree (except policy text that cites the rule).
- [ ] **No** grace-mar identity facts pasted into her `self.md` without her `recursion-gate.md` + approval + merge script.
- [ ] **Vector DB / RAG / â€œassistant memoryâ€ / MCP** is **not** treated as gate approval:

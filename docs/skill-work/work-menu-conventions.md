...
- **Fixed session menu (`coffee` â€” same **Aâ€“E** hub for work-start and signing-off; legacy **hey** still works):** not the 3â€“5 WORK pattern â€” canonical hub: **A** Steward, **B** Engineer, **C** Historian, **D** Singularity, **E** Conductor. **Symphony masters** are **not** five hub lines â€” [conductor skill](../../../.cursor/skills/conductor/SKILL.md). **C** exits the coffee hub by default unless **`stay in coffee`**; **skills** / **meta:** say with **B â€” Engineer**. Legacy **Aâ€“G** workload table for mapping: [menu-reference.md](../work-coffee/menu-reference.md). Roles: [.cursor/skills/coffee/SKILL.md](../../../.cursor/skills/coffee/SKILL.md).

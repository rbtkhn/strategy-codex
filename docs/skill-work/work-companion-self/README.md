...
| **[COMPANION-SELF-museum library shelf-ALIGNMENT.md](COMPANION-SELF-museum library shelf-ALIGNMENT.md)** | removed operator-books symlink template alignment notes (merged upstream). |

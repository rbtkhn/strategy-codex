# Skill demo worksheet (operator)

**Draft / not Record.** For each **seven-skill** row, link **real repo proof** (path from repo root + one line) or write **practice** / **not yet demonstrated**. Do not claim production evidence you have not merged or shipped.

| # | Skill (short) | Proof path + one line | Status (real / practice / gap) |
|---|-----------------|------------------------|--------------------------------|
...
**Optional:** paste markdown links in the proof column so `scripts/work_career/skill_gap_checklist.py` can verify paths exist.

See [nate-b-jones digest](../../../research/external/work-dev/transcripts/nate-b-jones-ai-job-market-seven-skills-2026.md) for skill definitions.

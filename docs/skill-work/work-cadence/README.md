...
- **Which cadence events actually ran?** Check `work-cadence-events.md` â€” one line per run.
...
- [work-cadence-events.md](work-cadence-events.md) â€” per-run cadence telemetry

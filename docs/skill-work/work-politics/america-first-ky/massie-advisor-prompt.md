...
- When relevant: spending, debt, and who pays (taxpayer / future generations).

**Output shape**

- Default: **Decision brief** or **draft content** with a clear recommendation and **one actionable next step** (e.g. what to ask staff to verify, what vote or statement to prepare).
...
- [Institutional / domestic](../analytical-lenses/lens-institutional-domestic.md)

Full manifest: [analytical-lenses/manifest.md](../analytical-lenses/manifest.md).

_Informal nicknames (Mearsheimer-style / Mercouris-style / Barnes-style) are **editorial shorthand only**; they do not replace the three lens files above._

---

## Guardrails before ship

- Complete [guardrail-stress-test.md](guardrail-stress-test.md) for high-stakes or high-claim copy.
- Nothing ships without **human** sign-off (operator / Guardian workflow per your process).

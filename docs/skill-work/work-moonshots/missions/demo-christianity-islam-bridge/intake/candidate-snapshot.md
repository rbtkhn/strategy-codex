# Tacit-derived candidate snapshot (demo)

**Non-authoritative.** Generated from `tests/tacit/fixtures/expected/demo-note.normalized.json` via `generate_tacit_candidates.py` (moonshot insight branch).

| Field | Value |
|-------|--------|
| candidate_type | `moonshot_insight_candidate` |

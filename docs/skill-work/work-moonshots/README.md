...
**Placement:** PMOS artifacts live **here** under `docs/skill-work/work-moonshots/` (and per-instance [`self-moonshots.md`](../../../self-moonshots.md)). Do not add a parallel top-level `moonshots/` treeâ€”extend this lane instead.
...
| [self-moonshots.md](../../../self-moonshots.md) (per instance) | **Staging** list of active moonshots â€” **non-authoritative** until gate merge |

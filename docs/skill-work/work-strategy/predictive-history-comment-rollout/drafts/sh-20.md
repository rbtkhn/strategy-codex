# sh-20 - Phase 1 YouTube comment draft
...
- YouTube URL: https://www.youtube.com/watch?v=z0AwFin83lo
- Chapter-folder target URL: https://github.com/rbtkhn/predictive-history/tree/main/book/volume-vi/sh-20
- Packet review status: `in_review`
- Workflow status: `ready`
- Approval state: `needs_review`
- Source link type: `chapter_folder`
- Chapter-folder path: `book/volume-vi/sh-20`

## Draft

Secret History #20: The Hellenistic World is a useful place to study how this lecture turns historical pattern into strategic pressure.

There is a public reader packet for following it without losing the thread:
https://github.com/rbtkhn/predictive-history/tree/main/book/volume-vi/sh-20

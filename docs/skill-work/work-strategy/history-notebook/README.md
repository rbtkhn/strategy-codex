...
**Discoverability:** Linked from **`SELF-LIBRARY/history-notebook`** (repo-relative symlink when created). **LIB:** [LIB-0156](../../../../self-library.md#operator-analytical-books) (operator-authored chapters) Ãƒâ€šÃ‚Â· [LIB-0158 ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Bookshelf (self-library-bookshelf)](../../../../self-library.md#self-library-bookshelf) (owned print `Shelf-*` ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â [BOOKSHELF.md](research/BOOKSHELF.md) vs [operator books](../../../../self-library.md#operator-analytical-books)) in [`self-library.md`](../../../../self-library.md).

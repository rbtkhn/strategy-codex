...
| **Distillation queue** | [STATUS.md](STATUS.md) | **Single SSOT** for next `hn-*` to draft; strategy **`meta.md`** links here ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â see [STRATEGY-NOTEBOOK-ARCHITECTURE Ãƒâ€šÃ‚Â§ Parallel to History notebook](../../../../codex/STRATEGY-NOTEBOOK-ARCHITECTURE.md#parallel-to-history-notebook-lib-0156) |

...
**Discoverability:** Linked from **`history-notebook`** (repo-relative symlink when created). **LIB:** [`docs/skill-work/work-strategy/history-notebook/`](../../../../self-library.md#operator-analytical-books) (operator-authored chapters) Ãƒâ€šÃ‚Â· [ ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Bookshelf (self-library-bookshelf)](../../../../self-library.md#self-library-bookshelf) (owned print `Shelf-*` ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â [BOOKSHELF.md](research/BOOKSHELF.md) vs [operator books](../../../../self-library.md#operator-analytical-books)) in [`self-library.md`](../../../../self-library.md).

**Operator-authored compressed chapters** distilling civilizational patterns into strategy-ready reference. Five temporal volumes; **target 20 chapters per volume (100 main-era chapters)**; each chapter ~500ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“1000 words. **Curated fact base:** [removed operator-books symlink](../../../../self-library.md) (governed shelf entries) is the **curated fact base** for history-notebook ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â the operator and agent should ground factual discipline and lookup in that index (with [CIV-MEM / ](../../../../self-library.md#operator-analytical-books) as the MEM-reservoir layer where indexed), not the undifferentiated open web as default. Not a wholesale mirror of CIV-MEM ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â an independent analytical layer the operator writes and the agent reads.
...
| **Bookshelf** / **self-library-bookshelf** | [research/BOOKSHELF.md](research/BOOKSHELF.md) | **Enhanced bib** for the operatorÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢s **physical** collection ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â not full text; [ ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â self-library-bookshelf](../../../../self-library.md#self-library-bookshelf); distinct from operator-authored [books in self-library](../../../../self-library.md#operator-analytical-books) |

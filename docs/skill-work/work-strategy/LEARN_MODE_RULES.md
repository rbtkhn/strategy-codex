...
4. **Extraction rules**  
   ...
   - When a **binding procedural constraint** emerges, add or extend a **§IV log** entry in [STRATEGY.md](STRATEGY.md). (No separate RLL file in this repo unless the operator adds one.)
...
5. **Governance constraints**  
   ...
   - **RECURSION-GATE:** Stage **`CANDIDATE-XXXX`** when promoting content into **Record / Voice** or when the operator treats a change as an **explicit strategy milestone** (see [`STRATEGY.md`](STRATEGY.md) §VI). **Routine** SCHOLAR / §IV log updates follow normal **git / PR** workflow under **lane/work-strategy** without a gate row.

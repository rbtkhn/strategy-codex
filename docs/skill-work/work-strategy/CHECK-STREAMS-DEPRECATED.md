...
| Hard-coded five-channel watchlist in skill prose | **[`channel-index.json`](../../../source-archive/statecraft/channel-index.json)** roster via `load_check_sources_roster()` (main index; misc excluded) |

# Daily brief - Predictive History slow layer (structural)
...
- [CHAPTER-QUEUE.md](../../../codex/predictive-history/CHAPTER-QUEUE.md) - next chapter front (queue vs blockers).
- [lectures/](../../../codex/predictive-history/lectures/) - curated lecture bodies for slow-layer pull quotes / compressions.
- [COMPRESSION-ENGINE.md](../../../codex/predictive-history/COMPRESSION-ENGINE.md) - historical local lane doc; do not resume PH compression output here.

## How this shows up

`scripts/generate_work_politics_daily_brief.py` embeds Active Predictive History hooks into the daily output as section 1c. Use section 3 - Slow structural layer in that file to connect today's W headlines to these hooks in prose (human-written).

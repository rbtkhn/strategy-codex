...
| **Evidence stub** | Pre-canonical draft artifact (`runtime/artifacts/evidence-stubs/` conventions); still gated for merge into [`self-archive.md`](../../archive/grace-mar-instance/self-archive.md). |

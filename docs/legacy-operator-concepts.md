...
**Replacement habits (frozen Record):** [`replacement-capture-habits.md`](replacement-capture-habits.md).
...
## Revive tokens (when intentional)

`fork revive` · `grace-mar archive` · coffee **`A gate`** · `harness_warmup.py --territory companion`

Merge law unchanged: `scripts/process_approved_candidates.py --apply` after companion approval.

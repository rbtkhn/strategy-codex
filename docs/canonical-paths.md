...
| Self-history (derived dual log â€” not Record) | **`self-history.md`** â€” optional **systematic** timeline: **WORK** aggregate from **`docs/archive/skill-work-legacy/work-*/*-history.md`** plus **gate-approved** **COMPANION** thread (pointers/summaries from merged **SELF/EVIDENCE** only). **Derived gazette**; not a merge bypass. See file header fence. |

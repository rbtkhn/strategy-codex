...
| **companion-self** | **Always hyphenated.** Names the **template** repository and **intelligence-system** product surface (fork blueprint, upgrades, `_template/`). Use this spelling for the **system / entity**, never `companion self` or `companionself`. |

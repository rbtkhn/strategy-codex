...
| Formative evidence | Activity log, staging, approved trail | [`self-evidence.md`](../self-evidence.md), [`recursion-gate.md`](../recursion-gate.md) ([identity-fork-protocol.md](identity-fork-protocol.md)), [`self-archive.md`](../self-archive.md) after merge Ã¢â‚¬” not a `self-archive/placeholders/evidence/` directory or a separate `Record/` tree |

---
name: polyphonic-cognition-protocol
description: Run fixed-perspective decision options (A/B/C/D). From civ-mem STATE; surfaces legitimacy, structure, liability, and optional civ-mem lens. No single recommendation.
---

# Polyphonic cognition protocol

**Purpose:** A loadable instruction set so any AI agent can run the **polyphonic cognition protocol** from the civilization-memory (civ-mem) **STATE** framework: fixed perspectives A/B/C and, when relevant, **D — Civ-mem lens**. Optional instinct-as-input, contradiction badge, no write unless relay.

**Origin:** This protocol is the civ-mem STATE operating mode (present-moment options, tensions preserved, no write to long-term record unless the user relays) plus **polyphonic cognition** (multiple perspectives held without collapsing to one answer). A/B/C map to the civ-mem three minds (legitimacy, structure, liability); D applies the civ-mem frame (condition, seam, one subject many tongues, face vs category).
...
7. **No model branding.** In your response, show only "A / B / C / D" and content. Do not say "As Claude…" or name the model. The value is the structure.
...
9. **Avoid AI writing tells.** Keep A/B/C prose direct and substantive. No fake enthusiasm, no rule-of-three padding, no filler phrases ("It's important to note…", "Furthermore…"). Decision-specific content only.
...
[Condition, seam, one subject many tongues, face vs category — applied to this decision.]

**Reversibility:** [One line: what becomes irreversible.]

**Tensions:** [If any pair conflict:] Tension: A and C conflict here. We do not resolve.
...
*Method name: Polyphonic cognition protocol. Origin: civ-mem STATE + polyphonic cognition.*

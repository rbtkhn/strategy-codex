...
1. See [../../continuity/STATUS.md](../../../continuity/STATUS.md) for notebook-level next actions.
2. Refresh this file when lane focus shifts or new sub-surfaces are added.

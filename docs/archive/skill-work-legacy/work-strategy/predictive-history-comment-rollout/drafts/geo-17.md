# geo-17 - Phase 1 YouTube comment draft
...
- YouTube URL: https://www.youtube.com/watch?v=5I2VPYPJJ68
- Chapter-folder target URL: (not ready)
- Packet review status: `in_review`
- Workflow status: `parked`
- Approval state: `needs_review`
- Source link type: `chapter_folder`
- Park reason: chapter folder is not ready

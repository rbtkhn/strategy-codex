...
| `continuity_read` | Session continuity | [continuity-log.jsonl](persistence-and-memory-surfaces.md) | Proof-of-read |
| `sandbox_adapter` | Sandboxed execution | [sandbox-adapter spec](managed-agent-design.md) | Governance at boundary |

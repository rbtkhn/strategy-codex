...
Growing the Grace-Mar cognitive fork is **not** a system objective. Embedded Record at repo root is archaeology; gate promotion applies only on explicit **`fork revive`**. [grace-mar-instance-boundary.md](grace-mar-instance-boundary.md)

...
- **Not** a replacement for [`recursion-gate.md`](../archive/grace-mar-instance/recursion-gate.md) or structured review-queue JSON â€” they **summarize** and **link**, they do not hold merge authority.

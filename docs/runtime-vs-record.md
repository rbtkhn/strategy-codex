...
| **Runtime memory payloads** | `src/grace_mar/runtime/runtime_memory.py` | Session brief / observation / miss / receipt payload builders for runtime-only continuity; [doc](runtime/runtime-memory.md); not Record |

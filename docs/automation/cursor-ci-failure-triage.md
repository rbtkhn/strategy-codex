...
| **Work-dev / workbench** | `validate_control_plane`, `preflight_workbench` | [docs/archive/skill-work-legacy/work-dev/](../skill-work/work-dev/) and log paths | `python scripts/work_dev/validate_control_plane.py` or `python3 scripts/work_dev/preflight_workbench.py --skip-freshness` as appropriate |

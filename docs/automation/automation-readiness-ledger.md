...
| `grace-mar-llm.txt`, `manifest.json` / `fork-manifest.json`, runtime **bundle** JSON | Artifacts | R4 (under regen/CI) | **Regen** **via** **policy**; **not** **Record** **truth** by **themselves** | **Direct** **edit** **in** **Cursor** **as** â€œmergeâ€ | **Generated**; **source** of **truth** **lives** in **gated** **/ **self** **surfaces** **per** **doctrine**. |

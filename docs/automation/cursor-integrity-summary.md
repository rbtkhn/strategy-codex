...
| --- | --- | --- | --- |
| **Integrity validation** | `validate-integrity` **failure**; JSON / text lists stale paths | [validate-integrity.py](https://github.com/rbtkhn/strategy-codex/blob/main/scripts/validate-integrity.py) **output** | `python3 scripts/validate-integrity.py --user grace-mar --require-proposal-class` (matches [test.yml](https://github.com/rbtkhn/strategy-codex/blob/main/.github/workflows/test.yml) step) or `--json` for readout ([work-cadence](https://github.com/rbtkhn/strategy-codex/blob/main/docs/skill-work/work-cadence/README.md#when-integrity-reports-stale-derived-exports)) |
...
| **Library** **index** **drift** | CI: `build_library_index` **diff** | [library-index workflow](https://github.com/rbtkhn/strategy-codex/blob/main/.github/workflows/library-index.yml) | `python3 scripts/build_library_index.py -u grace-mar` (then `git diff` if needed — **operator** only) |
| **Prompt** / **PRP** **drift** | `grace-mar-llm.txt` or **export** **stale** vs **self** / **prompt** | [Regen script order in work-cadence](https://github.com/rbtkhn/strategy-codex/blob/main/docs/skill-work/work-cadence/README.md#when-integrity-reports-stale-derived-exports) | Same **regen** **path** as **row** 2; **automation** **suggests** only |

...
| 2026-06-26 (Pass 4 continued) | `routing-ssot` | 0 | **0** | SSOT slice clean |
| 2026-06-26 (Pass 4 continued) | `all` | 0 | ~2,093 | Provenance migration + synthesis depth fixes; **statecraft voice threads** remain |

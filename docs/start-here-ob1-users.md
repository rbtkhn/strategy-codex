...
- **Identity vs library** â€” museum knowledge (who she is) vs removed operator-books symlink (reference corpora) â€” see [grace-mar archive boundary](grace-mar-instance-boundary.md) and museum bundle under `archive/grace-mar-instance/`.

...
## Frozen (read / cite / export; no default growth)
...
## Deprecated (do not route by default)
...
**Drift check:** `python3 scripts/audit_fork_language.py` — operator-routing phrase audit (read-only).

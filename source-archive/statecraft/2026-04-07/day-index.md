...
- Threads: `diesen` (2), `mercouris` (2), `crooke` (1), `marandi` (1), `nima` (1), `ritter` (1)
...
| `dialogue-works` | Dialogue Works | `nima`, `marandi` | [watch](https://www.youtube.com/watch?v=k-ZXf1Gd1-Y) | `source-dialogue-works-seyed-m-marandi-iran-slams-trump-s-ultimatum-w-counter-ultimatum-war-hea-2026-04-07.md` |

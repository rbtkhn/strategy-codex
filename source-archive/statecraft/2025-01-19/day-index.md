# Statecraft Archive - Day Index - 2025-01-19
...
- Threads: `davis` (3), `alkorshid` (2), `mearsheimer` (2), `nima` (2), `freeman` (1), `macgregor` (1), `mercouris` (1)
...
| `dialogue-works` | Dialogue Works | `alkorshid`, `nima`, `freeman` | [watch](https://www.youtube.com/watch?v=hV6_6hkYpwM) | `source-dialogue-works-can-trump-outdo-biden-s-worst-amb-chas-freeman-richard-d-wolff-michael-h-2025-01-19.md` |
| `dialogue-works` | Dialogue Works | `alkorshid`, `nima` | [watch](https://www.youtube.com/watch?v=B4hvxNVl714) | `source-dialogue-works-trump-pressures-netanyahu-a-power-play-unfolds-larry-c-johnson-scott-rit-2025-01-19.md` |

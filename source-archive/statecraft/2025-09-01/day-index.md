# Statecraft Archive - Day Index - 2025-09-01
...
- `Diesen - Greater Eurasia Podcast` (1)

## Host / Guest / Thread Rollup

- Hosts: `Glenn Diesen` (1)
- Guests: `Jack Matlock` (1)
- Threads: `diesen` (1), `matlock` (1)
...
| --- | --- | --- | --- | --- |
| `glenn-diesen` | Diesen - Greater Eurasia Podcast | `matlock`, `diesen` | [watch](https://www.youtube.com/watch?v=w2lV7K81FNs) | `source-diesen-matlock-western-leaders-ideological-war-criminals-2025-09-01.md` |
...
- `source-diesen-matlock-western-leaders-ideological-war-criminals-2025-09-01.md`

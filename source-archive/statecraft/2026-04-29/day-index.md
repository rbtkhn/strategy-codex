...
- Hosts: `Daniel Davis` (2), `Alexander Mercouris` (1), `Nima Alkhorshid` (1), `Ryan Grim` (1), `Shaun Attwood` (1)
- Guests: `Anthony Aguilar` (1), `Douglas Macgregor` (1), `Larry Johnson` (1), `Lawrence Wilkerson` (1), `Robert Pape` (1)
- Threads: `davis` (2), `aguilar` (1), `alkorshid` (1), `johnson` (1), `macgregor` (1), `mercouris` (1), `nima` (1), `pape` (1), `shaun-attwood` (1), `wilkerson` (1)
...
| `dialogue-works` | Dialogue Works | `alkorshid`, `nima`, `aguilar` | [watch](https://www.youtube.com/watch?v=SoMzkVMD3Tw) | `source-dialogue-works-anthony-aguilar-why-everything-you-knew-about-the-middle-east-just-colla-2026-04-29.md` |

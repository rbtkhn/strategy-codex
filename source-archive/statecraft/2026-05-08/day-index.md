...
- Threads: `alkorshid` (3), `nima` (3), `davis` (2), `diesen` (2), `johnson` (2), `kent` (2), `freeman` (1), `krainer` (1), `mercouris` (1), `postol` (1)
...
| `dialogue-works` | Dialogue Works | `alkorshid`, `nima`, `johnson` | [watch](https://www.youtube.com/watch?v=gFqQmy5DAuM) | `source-dialogue-works-johnson-hormuz-qatar-brics-trump-china-2026-05-08.md` |

...
- Threads: `mercouris` (2), `alkhorshid` (1), `christoforou` (1), `davis` (1), `diesen` (1), `karaganov` (1), `krapivnik` (1), `marandi` (1), `ritter` (1)
...
| `dialogue-works` | Dialogue Works | `alkhorshid` | [watch](https://www.youtube.com/watch?v=HcCJpGh9M54) | `source-dialogue-works-patrick-henningsen-iran-us-blockade-china-israel-2026-05-10.md` |

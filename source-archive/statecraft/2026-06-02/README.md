...
- Hosts: `Daniel Davis` (2), `Alex Christoforou` (1), `Alexander Mercouris` (1), `Glenn Diesen` (1), `Jeffrey Sachs` (1), `Robert Pape` (1)
- Guests: `Alexander Mercouris` (1), `Douglas Macgregor` (1), `Stanislav Krapivnik` (1)
- Threads: `napolitano` (3), `nima` (3), `davis` (2), `mercouris` (2), `nawfal` (2), `christoforou` (1), `diesen` (1), `johnson` (1), `krapivnik` (1), `macgregor` (1), `pape` (1), `sachs` (1), `wilkerson` (1)

...
- `India and Global Left` (1), `Mercouris` (1), `escalationtrap.substack.com` (1)
...
| --- | --- | --- | --- |
| COMPLETE DESTRUCTION AND CERTAIN DEATH': Trump's Newest Threat to Iran /Lt Col Daniel Davis | `davis` | — | `source-davis-complete-destruction-and-certain-death-trumps-newest-threat-to-iran-2026-03-07.md` |
| Deep Dive Intel Briefing: What We Learned This Week 3/7/2026 Lt Col Daniel Davis | `davis` | — | `source-davis-deep-dive-intel-briefing-what-we-learned-this-week-2026-03-07.md` |

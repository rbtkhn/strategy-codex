...
thread: pape
source_url: https://escalationtrap.substack.com/p/smart-bomb-trap-confirmed-decapitation
publication: escalationtrap.substack.com
slug: smart-bomb-trap-confirmed-decapitation
author: Prof Robert Pape
capture_note: Operator paste; public Substack may truncate — body preserved from companion capture. Operational claims (leadership status, strikes, casualties) are essay-tier until wired to primaries.
related_same_series:
  - url: https://escalationtrap.substack.com/p/the-day-1-mirage
    note: Prior Feb 28 essay (uranium / Day 1 targets).
  - url: https://escalationtrap.substack.com/p/the-illusion-of-control
    note: Same-day Feb 28 (airpower / regime change pattern).
  - url: https://escalationtrap.substack.com/p/the-smart-bomb-trap
    note: Fordo / verification framework (Feb 25).
  - url: https://escalationtrap.substack.com/p/what-vox-couldnt-publish
    note: Same-day Substack (Vox companion / conflict structure).
---

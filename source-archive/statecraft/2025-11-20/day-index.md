...
- Threads: `alkhorshid` (1), `diesen` (1), `freeman` (1), `martyanov` (1), `mearsheimer` (1), `mercouris` (1)
...
| `dialogue-works` | Dialogue Works | `alkhorshid`, `martyanov` | [watch](https://www.youtube.com/watch?v=rCalPQD48bc) | `source-dialogue-works-andrei-martyanov-it-s-all-over-iran-russia-and-china-move-in-together-2025-11-20.md` |
...
- `source-alexander-mercouris-kiev-defeats-force-us-u-turn-accept-istanbul-plus-kellogg-quits-kiev-eu-stunned-say-no-war-crisis-2025-11-20.md`
...
- `source-judging-freedom-mearsheimer-ukraine-and-reality-2025-11-20.md`

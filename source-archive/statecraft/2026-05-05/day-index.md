# Statecraft Archive - Day Index - 2026-05-05
...
- Threads: `alkhorshid` (3), `davis` (3), `diesen` (2), `marandi` (2), `helmer` (1), `johnson` (1), `macgregor` (1), `mercouris` (1), `wilkerson` (1)
...
| `dialogue-works` | Dialogue Works | `alkhorshid`, `helmer` | [watch](https://www.youtube.com/watch?v=WLQeC8gOp-k) | `source-dialogue-works-helmer-hormuz-beijing-2026-05-05.md` |
| `dialogue-works` | Dialogue Works | `alkhorshid`, `marandi` | [watch](https://www.youtube.com/watch?v=TLKl_IOhQDQ) | `source-dialogue-works-marandi-hormuz-uae-china-2026-05-05.md` |
| `dialogue-works` | Dialogue Works | `alkhorshid`, `wilkerson` | [watch](https://www.youtube.com/watch?v=3UPreelfuU4) | `source-dialogue-works-wilkerson-hormuz-blockade-2026-05-05.md` |
...
| --- | --- | --- | --- |
| — | — | [watch](codex://local-session/strategy-codex/2026-05-05) | `source-codex-session-2026-05-05.md` |
...
- `source-dialogue-works-helmer-hormuz-beijing-2026-05-05.md`
- `source-dialogue-works-marandi-hormuz-uae-china-2026-05-05.md`

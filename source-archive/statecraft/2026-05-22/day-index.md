...
- Threads: `johnson` (2), `mercouris` (2), `alkhorshid` (1), `crooke` (1), `davis` (1), `diesen` (1), `krapivnik` (1), `wilkerson` (1)
...
| `dialogue-works` | Dialogue Works | `johnson`, `wilkerson` | — | `source-dialogue-works-larry-johnson-col-wilkerson-irans-unseen-move-us-laser-destroyers-cant-stop-whats-coming-2026-05-22.md` |
| `dialogue-works` | Dialogue Works | `alkhorshid`, `krapivnik` | [oWXaAN633c0](https://www.youtube.com/watch?v=oWXaAN633c0) | `source-dialogue-works-stanislav-krapivnik-tulsi-gabbard-resigns-hezbollah-crushes-idf-war-becomes-unaffordable-2026-05-22.md` |

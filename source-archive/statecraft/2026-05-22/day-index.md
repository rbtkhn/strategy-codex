# Statecraft Archive - Day Index - 2026-05-22
...
- Hosts: `Alexander Mercouris` (2), `Nima Alkhorshid` (2), `Daniel Davis` (1), `Glenn Diesen` (1)
...
| `daniel-davis` | Daniel Davis Deep Dive | `davis`, `crooke` | [watch](https://www.youtube.com/watch?v=-rwVBXNiXSQ) | `source-daniel-davis-deep-dive-nuclear-fear-of-russia-can-bring-stability-alastair-crooke-lt-col-daniel-davis-2026-05-22.md` |
...
| `dialogue-works` | Dialogue Works | `nima`, `krapivnik` | [oWXaAN633c0](https://www.youtube.com/watch?v=oWXaAN633c0) | `source-dialogue-works-stanislav-krapivnik-tulsi-gabbard-resigns-hezbollah-crushes-idf-war-becomes-unaffordable-2026-05-22.md` |
| `glenn-diesen` | Glenn Diesen | `diesen`, `johnson` | [watch](https://www.youtube.com/watch?v=b9gN6iguB1M) | `source-glenn-diesen-larry-johnson-defeat-in-the-iran-war-will-end-the-u-s-empire-2026-05-22.md` |
...
- `source-daniel-davis-deep-dive-nuclear-fear-of-russia-can-bring-stability-alastair-crooke-lt-col-daniel-davis-2026-05-22.md`
...
- `source-glenn-diesen-larry-johnson-defeat-in-the-iran-war-will-end-the-u-s-empire-2026-05-22.md`

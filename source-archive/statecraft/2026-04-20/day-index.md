...
- Threads: `baud` (2), `johnson` (2), `mercouris` (2), `napolitano` (2), `ritter` (2), `alkorshid` (1), `davis` (1), `mearsheimer` (1), `pape` (1), `parsi` (1), `sachs` (1)
...
| `dialogue-works` | Dialogue Works | `alkorshid`, `johnson` | [watch](https://www.youtube.com/watch?v=aUIRaWUtgTA) | `source-dialogue-works-larry-johnson-the-strait-of-hormuz-just-became-a-graveyard-for-us-domina-2026-04-20.md` |

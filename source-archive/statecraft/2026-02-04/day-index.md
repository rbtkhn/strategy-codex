# Statecraft Archive - Day Index - 2026-02-04
...
- Threads: `alkorshid` (1), `mercouris` (1), `ritter` (1), `simplicius` (1)
...
| `dialogue-works` | Dialogue Works | `alkorshid`, `ritter` | [watch](https://www.youtube.com/watch?v=iuc_pPvcFC0) | `source-dialogue-works-scott-ritter-game-over-trump-s-iran-strategy-might-blow-up-and-start-a-r-2026-02-04.md` |
...
| --- | --- | --- | --- | --- |
| `simplicius` | `simplicius` | `simplicius76.substack.com` | [watch](https://simplicius76.substack.com/p/damage-control-epstein-a-russian) | `source-simplicius-damage-control-epstein-a-russian-2026-02-04.md` |

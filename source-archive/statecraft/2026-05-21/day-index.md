# Statecraft Archive - Day Index - 2026-05-21
...
- Body kind mix: `transcript` (7), `operator-transcript` (1)
...
- `Dialogue Works` (3), `Judging Freedom` (2), `Glenn Diesen` (1), `Mario Nawfal` (1), `Predictive History` (1)

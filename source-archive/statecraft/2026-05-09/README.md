...
- Hosts: `Alexander Mercouris` (1), `Daniel Davis` (1), `Glenn Diesen` (1), `Nima Alkorshid` (1)
- Guests: `Seyed M. Marandi` (1), `Seyed Mohammad Marandi` (1)
- Threads: `mercouris` (2), `crooke` (1), `davis` (1), `diesen` (1), `nima` (1)

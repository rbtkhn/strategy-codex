# Statecraft Archive - Day Index - 2026-03-16
...
- Body kind mix: `transcript` (15), `source` (3), `substack-post` (1)
- Source form mix: `interview` (14), `newsletter` (2), `solo` (2), `panel` (1)
...
| --- | --- | --- | --- | --- |
| `pape` | `pape` | `escalationtrap.substack.com` | [watch](https://escalationtrap.substack.com/p/irans-new-battlefield-the-global) | `source-pape-irans-new-battlefield-the-global-2026-03-16.md` |
| `simplicius` | `simplicius` | `simplicius76.substack.com` | [watch](https://simplicius76.substack.com/p/frustrated-by-failure-an-unhinged) | `source-simplicius-frustrated-by-failure-an-unhinged-2026-03-16.md` |

...
- Source files: `9`
- Type mix: `youtube` (6), `transcript` (2), `substack-post` (1)
...
- `Daniel Davis Deep Dive` (2), `Alexander Mercouris` (1), `Breaking Points` (1), `Dialogue Works` (1), `Escalation Trap` (1), `Glenn Diesen` (1), `Judging Freedom` (1), `Mario Nawfal` (1)

## Host / Guest / Thread Rollup

- Hosts: `Daniel Davis` (2), `Alexander Mercouris` (1), `Andrew Napolitano` (1), `Glenn Diesen` (1), `Mario Nawfal` (1), `Nima Alkhorshid` (1)
- Guests: `Alexander Mercouris` (1), `Douglas Macgregor` (1), `Jeffrey Sachs` (1), `Larry Johnson` (1), `Ray McGovern` (1), `Robert Pape` (1), `Scott Ritter` (1)
- Threads: `davis` (2), `diesen` (1), `macgregor` (1), `mercouris` (1), `napolitano` (1), `pape` (2), `ritter` (1)
...
- `youtube-macgregor-mario-nawfal-trump-walks-back-on-deal-idf-to-flatten-beirut-2026-05-27.md`
- `substack-pape-the-price-of-oil-is-the-real-iran-2026-05-27.md`
- `youtube-pape-breaking-points-iran-drivers-seat-shocking-deal-emerges-2026-05-27.md`

# Statecraft Archive - Day Index - 2026-02-11
...
- Threads: `alkorshid` (1), `davis` (1), `marandi` (1), `mercouris` (1), `nima` (1), `ritter` (1), `sachs` (1)
...
| --- | --- | --- | --- |
| Jeffrey Sachs | `sachs` | [watch](https://www.jeffsachs.org/im-archive-by-date) | `source-sachs-us-economic-coercion-and-the-death-of-the-dollar-2026-02-11.md` |

...
- Distinct threads: `73`
- Thread-linked source files: `2684`
- Covered days: `472`
- Covered months: `22`
...
| --- | ---: | ---: | ---: | --- | --- | --- | --- |
| `mercouris` | 375 | 346 | 21 | `Alexander Mercouris` (330), `The Duran` (29), `Glenn Diesen` (3) | `Alexander Mercouris` (323), `Alex Christoforou` (21), `Glenn Diesen` (9) | `2023-01-14` | `2026-06-25` |
| `davis` | 256 | 141 | 17 | `Daniel Davis Deep Dive` (227), `Daniel Davis` (22), `Deep Dive` (2) | `Daniel Davis` (217), `Nima Alkhorshid` (1) | `2025-01-01` | `2026-06-25` |
...
| `freeman` | 148 | 136 | 18 | `Dialogue Works` (49), `Judging Freedom` (44), `Glenn Diesen` (24) | `Nima Alkhorshid` (50), `Andrew Napolitano` (46), `Glenn Diesen` (24) | `2025-01-07` | `2026-06-23` |
| `johnson` | 109 | 89 | 16 | `Dialogue Works` (52), `Daniel Davis Deep Dive` (15), `Glenn Diesen` (10) | `Nima Alkhorshid` (53), `Daniel Davis` (15), `Andrew Napolitano` (11) | `2025-01-04` | `2026-06-25` |
...
| `napolitano` | 90 | 66 | 18 | `Judging Freedom` (90) | `Andrew Napolitano` (85) | `2025-01-08` | `2026-06-25` |
| `macgregor` | 84 | 71 | 17 | `Daniel Davis Deep Dive` (34), `Judging Freedom` (21), `Glenn Diesen` (13) | `Daniel Davis` (31), `Andrew Napolitano` (26), `Glenn Diesen` (16) | `2025-01-06` | `2026-06-23` |
| `marandi` | 70 | 55 | 10 | `Dialogue Works` (34), `Glenn Diesen` (14), `Daniel Davis Deep Dive` (11) | `Nima Alkhorshid` (32), `Glenn Diesen` (14), `Daniel Davis` (10) | `2025-01-05` | `2026-06-25` |
| `pape` | 70 | 54 | 5 | `escalationtrap.substack.com` (43), `Mario Nawfal` (6), `Breaking Points` (4) | `Robert Pape` (45), `Mario Nawfal` (4), `Clayton Morris` (2) | `2026-02-25` | `2026-06-22` |
...
| `parsi` | 50 | 42 | 13 | `substack.com/@tritaparsi` (11), `tritaparsi.substack.com` (10), `Mario Nawfal` (8) | `Trita Parsi` (23), `Nima Alkhorshid` (5), `Mario Nawfal` (3) | `2025-05-09` | `2026-06-24` |
...
| `barnes` | 21 | 18 | 6 | `Daniel Davis Deep Dive` (7), `Mario Nawfal` (5), `The Duran` (3) | `Daniel Davis` (6), `Mario Nawfal` (3), `Alexander Mercouris` (2) | `2026-01-13` | `2026-06-25` |
...
| `daniel-davis` | 12 | 10 | 7 | `Daniel Davis Deep Dive` (7), `Glenn Diesen (channel / program — pin canonical series title when pinned)` (3), `Glenn Diesen` (1) | `Daniel Davis` (7), `Glenn Diesen` (5) | `2025-01-27` | `2026-05-16` |
...
| `moral-resistance` | 3 | 3 | 1 | `Moral Resistance` (3) | `Sulaiman Ahmed` (3) | `2026-06-12` | `2026-06-24` |

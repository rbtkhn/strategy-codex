# Statecraft Archive - Day Index - 2025-03-20
...
- `Alexander Mercouris` (1), `Daniel Davis Deep Dive` (1), `Glenn Diesen` (1)

## Host / Guest / Thread Rollup

- Hosts: `Alexander Mercouris` (1), `Daniel Davis` (1), `Glenn Diesen` (1)
- Guests: `John Mearsheimer` (1), `Seyed Mohammad Marandi` (1)
- Threads: `davis` (1), `diesen` (1), `marandi` (1), `mearsheimer` (1), `mercouris` (1)
...
| --- | --- | --- | --- | --- |
| `alexander-mercouris` | Alexander Mercouris | `mercouris` | [watch](https://www.youtube.com/watch?v=F2Uy1kGrVKQ) | `source-alexander-mercouris-trump-no-as-zelensky-begs-patriots-wants-power-plants-moscow-all-4-regions-ours-sanctions-to-stay-2025-03-20.md` |
...
- `source-alexander-mercouris-trump-no-as-zelensky-begs-patriots-wants-power-plants-moscow-all-4-regions-ours-sanctions-to-stay-2025-03-20.md`

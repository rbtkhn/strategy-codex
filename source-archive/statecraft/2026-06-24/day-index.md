...
- Threads: `napolitano` (3), `davis` (2), `diesen` (2), `johnson` (2), `parsi` (2), `blumenthal` (1), `crooke` (1), `marandi` (1), `mate` (1), `moral-resistance` (1), `nawfal` (1), `nima` (1)
...
| --- | --- | --- | --- | --- |
| `dialogue-works` | Dialogue Works | `johnson`, `nima` | [sV1lTSNqjQc](https://www.youtube.com/watch?v=sV1lTSNqjQc) | `source-alkorshid-johnson-israel-next-war-preparing-bomb-yemen-2026-06-24.md` |
...
- `source-alkorshid-johnson-israel-next-war-preparing-bomb-yemen-2026-06-24.md`

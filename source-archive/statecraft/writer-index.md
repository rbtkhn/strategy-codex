...
Flat registry of **configured written-source outlets** (Substack feeds in v1). YouTube channels live in [channel-index.md](../../statecraft/channels/channel-index.md). Cross-modal speaker rollups: [thread-index.md](./thread-index.md).

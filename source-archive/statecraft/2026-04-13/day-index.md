# Statecraft Archive - Day Index - 2026-04-13
...
- Threads: `davis` (4), `nima` (3), `alkorshid` (2), `marandi` (2), `ritter` (2), `baud` (1), `freeman` (1), `johnson` (1), `mearsheimer` (1), `mercouris` (1), `simplicius` (1)
...
| `dialogue-works` | Dialogue Works | `alkorshid`, `nima`, `johnson` | [watch](https://www.youtube.com/watch?v=zGjabXPGUv4) | `source-dialogue-works-larry-johnson-will-trump-s-iran-port-blockade-work-or-end-in-total-disas-2026-04-13.md` |
| `dialogue-works` | Dialogue Works | `alkorshid`, `nima`, `marandi` | [watch](https://www.youtube.com/watch?v=-zLI8STtzB0) | `source-dialogue-works-seyed-m-marandi-us-blockade-on-iran-just-triggered-iran-s-harshest-respo-2026-04-13.md` |
...
| --- | --- | --- | --- | --- |
| `ritter` | `ritter` | `scottritter.substack.com` | [watch](https://scottritter.substack.com/p/blasphemy-american-style) | `source-ritter-blasphemy-american-style-2026-04-13.md` |
| `simplicius` | `simplicius` | `simplicius76.substack.com` | [watch](https://simplicius76.substack.com/p/masterful-5d-stroke-trumps-blockade) | `source-simplicius-masterful-5d-stroke-trumps-blockade-2026-04-13.md` |
...
- `source-ritter-blasphemy-american-style-2026-04-13.md`
- `source-simplicius-masterful-5d-stroke-trumps-blockade-2026-04-13.md`

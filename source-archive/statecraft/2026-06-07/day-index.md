...
- Threads: `parsi` (3), `aguilar` (1), `alkhorshid` (1), `davis` (1), `mercouris` (1)
...
| `dialogue-works` | Dialogue Works | `alkhorshid` | [watch](https://www.youtube.com/watch?v=xj8ocoG-nDw) | `source-dialogue-works-nima-urgent-iran-israel-trade-blows-yemen-launches-iran-hits-saudi-2026-06-07.md` |

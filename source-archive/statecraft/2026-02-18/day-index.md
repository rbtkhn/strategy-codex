...
- Threads: `crooke` (1), `mercouris` (1), `nima` (1), `ritter` (1), `simplicius` (1)
...
| `dialogue-works` | Dialogue Works | `nima`, `ritter` | [watch](https://www.youtube.com/watch?v=DCDuxei5dj8) | `source-dialogue-works-scott-ritter-hormuz-blocked-iran-s-missile-fire-can-leave-the-us-navy-de-2026-02-18.md` |

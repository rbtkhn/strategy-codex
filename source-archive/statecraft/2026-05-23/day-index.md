...
- Threads: `diesen` (2), `marandi` (2), `alkhorshid` (1), `davis` (1), `jiang` (1), `mercouris` (1), `pape` (1), `sachs` (1)
...
| `dialogue-works` | Dialogue Works | `alkhorshid`, `marandi` | [watch](https://www.youtube.com/watch?v=3CWFQOwYh0M) | `source-dialogue-works-marandi-irans-armed-forces-enter-highest-state-of-alert-war-next-2026-05-23.md` |

# Statecraft Archive - Day Index - 2026-04-22
...
- Hosts: `Daniel Davis` (2), `Robert Pape` (2), `Alexander Mercouris` (1)
...
| --- | --- | --- | --- | --- |
| `pape` | `pape` | `escalationtrap.substack.com` | [watch](https://escalationtrap.substack.com/p/the-first-move-has-begun) | `source-pape-the-first-move-has-begun-2026-04-22.md` |
| `pape` | `pape` | `escalationtrap.substack.com` | [watch](https://escalationtrap.substack.com/p/within-10-days-shortages-are-already) | `source-pape-within-10-days-shortages-already-2026-04-22.md` |
| `simplicius` | `simplicius` | `simplicius76.substack.com` | [watch](https://simplicius76.substack.com/p/left-with-nothing-but-gimmicks-trump) | `source-simplicius-left-with-nothing-but-gimmicks-trump-2026-04-22.md` |

...
thread: pape
source_url: https://escalationtrap.substack.com/p/the-first-move-has-begun
publication: escalationtrap.substack.com
slug: the-first-move-has-begun
author: Prof Robert Pape
capture_note: Operator paste; public Substack page may truncate for non-subscribers — body preserved from companion capture.
related_same_day:
  - url: https://escalationtrap.substack.com/p/within-10-days-shortages-are-already
    note: Same-day Escalation Trap post (shortages / blockade stages).
cross_ref_in_voice: >-
  In-post pointer to prior piece titled “From Breakdown to Trajectory: Why the Ceasefire Is Failing—and What It Already Reveals About the Next Phase of War” (exact Substack slug not in capture — resolve via archive if needed).
---
...
## Cross-link (in-post card — “yesterday’s” article)

**Prof Robert Pape** — *From Breakdown to Trajectory: Why the Ceasefire Is Failing—and What It Already Reveals About the Next Phase of War*

> When a conflict is zero-sum, ceasefires don’t fail by accident—they fail because the next phase of war is already built into the terms…

*(Card metadata in capture: “Read more · a day ago · 54 likes · 9 comments · Prof Robert Pape”.)*
...
For paid subscribers, I break down how to recognize the shift from signaling to sustained economic war, what that means for energy markets over the next 30 to 60 days, and why this sequence creates mounting pressure for decisions that policymakers are trying to avoid.

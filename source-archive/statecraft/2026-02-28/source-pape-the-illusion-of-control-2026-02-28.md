...
thread: pape
source_url: https://escalationtrap.substack.com/p/the-illusion-of-control
publication: escalationtrap.substack.com
slug: the-illusion-of-control
author: Prof Robert Pape
capture_note: Operator paste; public Substack may truncate — body preserved from companion capture. In-post pointer to Boston radio segment (“available here”) without URL in capture — pin if operator archives.
related_same_series:
  - url: https://escalationtrap.substack.com/p/from-kosovo-to-iran-the-smart-bomb
    note: Kosovo / precision trap companion (2026-02-27).
  - url: https://escalationtrap.substack.com/p/the-smart-bomb-trap
    note: Fordo / verification (2026-02-25).
---
# The Illusion of Control

Airstrikes, Iran, and the Dangerous Pattern History Keeps Repeating

This morning on Boston radio, I was asked what the U.S.–Israeli air campaign against Iran means.

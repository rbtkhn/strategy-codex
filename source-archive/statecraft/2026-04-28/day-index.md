...
- Threads: `nima` (3), `napolitano` (2), `wilkerson` (2), `davis` (1), `diesen` (1), `freeman` (1), `jermy` (1), `marandi` (1), `mearsheimer` (1)
...
| `daniel-davis` | Daniel Davis Deep Dive | `jermy`, `davis` | [cjUPUniAKlo](https://www.youtube.com/watch?v=cjUPUniAKlo) | `source-daniel-davis-deep-dive-iran-wars-real-ticking-timebomb-imminent-energy-food-crisis-steve-jermy-lt-col-daniel-davis-2026-04-28.md` |
...
| --- | --- | --- | --- |
| Seyed Mohammad Marandi | `marandi`, `nima` | — | `source-marandi-dialogue-works-trump-plan-dead-after-strike-2026-04-28.md` |

## Files

- `source-alkorshid-helmer-middle-east-unthinkable-iran-play-2026-04-28.md`
- `source-daniel-davis-deep-dive-iran-wars-real-ticking-timebomb-imminent-energy-food-crisis-steve-jermy-lt-col-daniel-davis-2026-04-28.md`

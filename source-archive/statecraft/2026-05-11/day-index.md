...
- Threads: `alkorshid` (2), `nima` (2), `baud` (1), `crooke` (1), `davis` (1), `diesen` (1), `freeman` (1), `india-global-left` (1), `johnson` (1), `mercouris` (1), `pape` (1)
...
| --- | --- | --- | --- |
| Larry Johnson | `alkorshid`, `nima`, `johnson` | — | `source-dialogue-works-johnson-netanyahu-hormuz-china-israel-2026-05-11.md` |

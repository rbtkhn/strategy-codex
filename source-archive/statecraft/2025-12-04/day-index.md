...
- Threads: `alkorshid` (1), `diesen` (1), `freeman` (1), `martyanov` (1), `mearsheimer` (1), `mercouris` (1), `napolitano` (1)
...
| `dialogue-works` | Dialogue Works | `alkorshid`, `martyanov` | [watch](https://www.youtube.com/watch?v=08Y6K95zKfI) | `source-dialogue-works-andrei-martyanov-russia-has-made-its-choice-wiping-out-every-threat-2025-12-04.md` |

...
- Threads: `nima` (2), `christoforou` (1), `freeman` (1), `johnson` (1), `mercouris` (1), `wilkerson` (1)
...
| --- | --- | --- | --- | --- |
| `dialogue-works` | Dialogue Works | `freeman`, `nima` | — | `source-dialogue-works-amb-chas-freeman-al-qaeda-gets-a-seat-at-the-un-2025-09-26.md` |
| `dialogue-works` | Dialogue Works | `nima`, `johnson`, `wilkerson` | [watch](https://www.youtube.com/watch?v=gzhWSuNKFLI) | `source-dialogue-works-larry-c-johnson-larry-wilkerson-charlie-kirks-story-collapses-is-america-gearing-up-for-war-2025-09-26.md` |

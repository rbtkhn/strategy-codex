# Statecraft Archive - Day Index - 2026-01-20
...
- Body kind mix: `operator-transcript` (2), `cleaned-transcript` (1), `substack-post` (1), `transcript` (1)
...
- Hosts: `Alexander Mercouris` (1), `Daniel Davis` (1), `John J. Mearsheimer` (1)
- Guests: `Chas Freeman` (1), `John Helmer` (1), `Scott Ritter` (1)
- Threads: `alkhorshid` (1), `davis` (1), `freeman` (1), `helmer` (1), `mearsheimer` (1), `mercouris` (1), `ritter` (1)
...
| `dialogue-works` | — | `alkhorshid`, `helmer` | [watch](https://www.youtube.com/watch?v=6uV3p9nD8D8) | `source-dialogue-works-helmer-two-fronts-collapsing-eu-greenland-ukraine-2026-01-20.md` |
...
| --- | --- | --- | --- | --- |
| `ritter` | `ritter` | `scottritter.substack.com` | [watch](https://scottritter.substack.com/p/getting-it-wrong-on-russia) | `source-ritter-getting-it-wrong-on-russia-2026-01-20.md` |
...
| --- | --- | --- | --- |
| John J. Mearsheimer | `mearsheimer` | [watch](https://mearsheimer.substack.com/p/the-tag-team-fails-in-iran) | `source-mearsheimer-the-tag-team-fails-in-iran-2026-01-20.md` |

# Statecraft Archive - Day Index - 2026-04-18
...
- Threads: `marandi` (2), `mercouris` (2), `alkhorshid` (1), `barnes` (1), `crooke` (1), `davis` (1), `diesen` (1), `johnson` (1), `pape` (1), `parsi` (1), `ritter` (1)
...
| `dialogue-works` | Dialogue Works | `alkhorshid`, `marandi` | [watch](https://www.youtube.com/watch?v=ap41RA_DqRk) | `source-dialogue-works-seyed-m-marandi-iran-just-put-the-strait-of-hormuz-on-limited-mode-signs-2026-04-18.md` |
...
| --- | --- | --- | --- | --- |
| `crooke` | `crooke` | `conflictsforum.substack.com` | [watch](https://conflictsforum.substack.com/p/markets-prematurely-may-celebrate) | `source-crooke-markets-prematurely-may-celebrate-2026-04-18.md` |

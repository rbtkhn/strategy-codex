# Statecraft Archive - Day Index - 2025-08-15
...
- Threads: `nima` (2), `freeman` (1), `johnson` (1), `mercouris` (1), `parsi` (1), `wilkerson` (1)
...
| `dialogue-works` | Dialogue Works | `nima`, `johnson`, `wilkerson` | [watch](https://www.youtube.com/watch?v=jPLIxYqR9kw) | `source-dialogue-works-larry-c-johnson-col-larry-wilkerson-trump-and-putin-in-alaska-deals-drama-and-dangerous-moves-2025-08-15.md` |

...
- Hosts: `Nima Alkhorshid` (6), `Daniel Davis` (3), `Andrew Napolitano` (2), `Alexander Mercouris` (1), `Breaking Points` (1), `Glenn Diesen` (1), `Mario Nawfal` (1), `Tucker Carlson` (1)

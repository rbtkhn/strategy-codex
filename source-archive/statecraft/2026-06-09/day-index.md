# Statecraft Archive - Day Index - 2026-06-09
...
- Threads: `alkhorshid` (6), `davis` (3), `macgregor` (2), `marandi` (2), `pape` (2), `aguilar` (1), `carlson` (1), `diesen` (1), `freeman` (1), `helmer` (1), `hoh` (1), `krapivnik` (1), `mearsheimer` (1), `mercouris` (1), `napolitano` (1), `wilkerson` (1)
...
| `dialogue-works` | Dialogue Works | `alkhorshid`, `aguilar` | [KJzmnJqWbX8](https://www.youtube.com/watch?v=KJzmnJqWbX8) | `source-dialogue-works-anthony-aguilar-iranian-drone-takes-down-us-apache-helicopter-war-imminent-2026-06-09.md` |
| `dialogue-works` | Dialogue Works | `alkhorshid`, `helmer` | [SVN6F-3rZlM](https://www.youtube.com/watch?v=SVN6F-3rZlM) | `source-dialogue-works-helmer-putins-crisis-of-confidence-2026-06-09.md` |
| `dialogue-works` | Dialogue Works | `alkhorshid` | [8-_HAsWoFws](https://www.youtube.com/watch?v=8-_HAsWoFws) | `source-dialogue-works-iran-launches-immediate-retaliation-explosions-rock-bahrain-after-us-strikes-2026-06-09.md` |
| `dialogue-works` | Dialogue Works | `alkhorshid`, `marandi` | [12vCzfDomoE](https://www.youtube.com/watch?v=12vCzfDomoE) | `source-dialogue-works-marandi-iran-drops-new-equation-israel-goes-against-trump-escapes-2026-06-09.md` |
| `dialogue-works` | Dialogue Works | `alkhorshid`, `krapivnik` | [Cg-cFVQ55S8](https://www.youtube.com/watch?v=Cg-cFVQ55S8) | `source-dialogue-works-stanislav-krapivnik-breaking-us-attacks-iran-russia-no-deal-coming-2026-06-09.md` |
| `dialogue-works` | Dialogue Works | `alkhorshid`, `wilkerson` | [3oGkrjCzzYI](https://www.youtube.com/watch?v=3oGkrjCzzYI) | `source-dialogue-works-wilkerson-israels-grand-strategy-coming-apart-2026-06-09.md` |
...
| `judging-freedom` | Judging Freedom | `freeman` | [KSbb4c2JxRE](https://www.youtube.com/watch?v=KSbb4c2JxRE) | `source-judging-freedom-freeman-can-netanyahu-defy-trump-2026-06-09.md` |
...
| `mario-nawfal` | Mario Nawfal | `pape` | [4wfVXkp9eGs](https://www.youtube.com/watch?v=4wfVXkp9eGs) | `source-mario-nawfal-pape-hezbollah-infiltrates-israel-apache-shot-down-2026-06-09.md` |
...
- `source-dialogue-works-anthony-aguilar-iranian-drone-takes-down-us-apache-helicopter-war-imminent-2026-06-09.md`
- `source-dialogue-works-helmer-putins-crisis-of-confidence-2026-06-09.md`
- `source-dialogue-works-iran-launches-immediate-retaliation-explosions-rock-bahrain-after-us-strikes-2026-06-09.md`
- `source-dialogue-works-marandi-iran-drops-new-equation-israel-goes-against-trump-escapes-2026-06-09.md`

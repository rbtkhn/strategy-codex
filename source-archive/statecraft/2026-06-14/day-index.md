# Statecraft Archive - Day Index - 2026-06-14
...
- Body kind mix: `cleaned-transcript` (6), `substack-post` (1)
...
- `Dialogue Works` (3), `Alexander Mercouris` (1), `Daniel Davis Deep Dive` (1), `Glenn Diesen` (1), `tritaparsi.substack.com` (1)

## Host / Guest / Thread Rollup

- Hosts: `Nima Alkhorshid` (3), `Alexander Mercouris` (1), `Glenn Diesen` (1), `Trita Parsi` (1)
- Guests: `Seyed M. Marandi` (3), `Anthony Aguilar` (1), `Larry Johnson` (1)
- Threads: `alkhorshid` (3), `marandi` (3), `aguilar` (1), `davis` (1), `diesen` (1), `johnson` (1), `mercouris` (1), `parsi` (1)
...
| `dialogue-works` | Dialogue Works | `alkhorshid`, `aguilar` | [bZxS4saKQAY](https://www.youtube.com/watch?v=bZxS4saKQAY) | `source-dialogue-works-anthony-aguilar-iran-suspends-flights-western-region-attack-israel-imminent-2026-06-14.md` |
| `dialogue-works` | Dialogue Works | `johnson`, `alkhorshid`, `marandi` | [t1MaItycdFc](https://www.youtube.com/watch?v=t1MaItycdFc) | `source-dialogue-works-johnson-marandi-us-iran-reach-deal-full-details-2026-06-14.md` |
| `dialogue-works` | Dialogue Works | `alkhorshid` | [BlK5ONxCrg8](https://www.youtube.com/watch?v=BlK5ONxCrg8) | `source-dialogue-works-nima-beirut-attack-wont-go-unanswered-deputy-commander-2026-06-14.md` |
...
| --- | --- | --- | --- | --- |
| `parsi` | `parsi` | `tritaparsi.substack.com` | [watch](https://tritaparsi.substack.com/p/with-one-strike-netanyahu-tries-to) | `source-parsi-with-one-strike-netanyahu-tries-to-kill-two-peace-deals-2026-06-14.md` |
...
- `source-dialogue-works-nima-beirut-attack-wont-go-unanswered-deputy-commander-2026-06-14.md`

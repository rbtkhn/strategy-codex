...
- Threads: `alkorshid` (3), `marandi` (3), `aguilar` (1), `davis` (1), `diesen` (1), `johnson` (1), `mercouris` (1), `parsi` (1)
...
| `dialogue-works` | Dialogue Works | `alkorshid`, `aguilar` | [bZxS4saKQAY](https://www.youtube.com/watch?v=bZxS4saKQAY) | `source-dialogue-works-anthony-aguilar-iran-suspends-flights-western-region-attack-israel-imminent-2026-06-14.md` |
| `dialogue-works` | Dialogue Works | `johnson`, `alkorshid`, `marandi` | [t1MaItycdFc](https://www.youtube.com/watch?v=t1MaItycdFc) | `source-dialogue-works-johnson-marandi-us-iran-reach-deal-full-details-2026-06-14.md` |
| `dialogue-works` | Dialogue Works | `alkorshid` | [BlK5ONxCrg8](https://www.youtube.com/watch?v=BlK5ONxCrg8) | `source-dialogue-works-nima-beirut-attack-wont-go-unanswered-deputy-commander-2026-06-14.md` |

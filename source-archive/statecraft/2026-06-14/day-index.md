...
- Threads: `alkorshid` (3), `marandi` (3), `nima` (3), `aguilar` (1), `davis` (1), `diesen` (1), `johnson` (1), `mercouris` (1), `parsi` (1)
...
| `dialogue-works` | Dialogue Works | `alkorshid`, `nima` | [BlK5ONxCrg8](https://www.youtube.com/watch?v=BlK5ONxCrg8) | `source-dialogue-works-nima-beirut-attack-wont-go-unanswered-deputy-commander-2026-06-14.md` |

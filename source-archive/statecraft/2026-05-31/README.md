...
- Body kind mix: `transcript` (7), `youtube` (1)
- Source form mix: `interview` (6), `solo` (2)
...
- `Mario Nawfal` (4), `Alexander Mercouris` (1), `Dialogue Works` (1), `Glenn Diesen` (1), `Moral Resistance` (1)

## Host / Guest / Thread Rollup

- Hosts: `Mario Nawfal` (4), `Alexander Mercouris` (1), `Glenn Diesen` (1), `Moral Resistance` (1), `Nima Alkhorshid` (1)
- Guests: `Anthony Aguilar` (1), `Brandon J. Weichert` (1), `Glenn Diesen` (1), `Jeffrey Sachs` (1), `Larry Johnson` (1), `Robert Barnes` (1)
- Threads: `nawfal` (4), `diesen` (2), `aguilar` (1), `barnes` (1), `johnson` (1), `mercouris` (1), `nima` (1), `sachs` (1), `weichert` (1)

# Statecraft Archive - Day Index - 2026-03-27
...
- Threads: `diesen` (2), `alkhorshid` (1), `beebe` (1), `freeman` (1), `johnson` (1), `mearsheimer` (1), `mercouris` (1), `pape` (1), `simplicius` (1), `wilkerson` (1)
...
| `dialogue-works` | Dialogue Works | `alkhorshid`, `johnson`, `wilkerson` | [nZEDlBdZTQ4](https://www.youtube.com/watch?v=nZEDlBdZTQ4) | `source-dialogue-works-larry-johnson-col-wilkerson-us-iran-ground-conflict-could-devastate-is-2026-03-27.md` |
...
| --- | --- | --- | --- | --- |
| `pape` | `pape` | `escalationtrap.substack.com` | [watch](https://escalationtrap.substack.com/p/the-marine-threshold-5000-marines) | `source-pape-the-marine-threshold-5000-marines-2026-03-27.md` |
| `simplicius` | `simplicius` | `simplicius76.substack.com` | [watch](https://simplicius76.substack.com/p/nyt-admits-iran-rendered-virtually) | `source-simplicius-nyt-admits-iran-rendered-virtually-2026-03-27.md` |
...
- `source-glenn-diesen-george-beebe-iran-war-weakens-ukraine-europe-remains-irrational-2026-03-27.md`
- `source-pape-the-marine-threshold-5000-marines-2026-03-27.md`
- `source-simplicius-nyt-admits-iran-rendered-virtually-2026-03-27.md`

...
- Threads: `diesen` (2), `alkorshid` (1), `crooke` (1), `freeman` (1), `mearsheimer` (1), `mercouris` (1), `wilkerson` (1)
...
| `dialogue-works` | Dialogue Works | `alkorshid`, `freeman` | [watch](https://www.youtube.com/watch?v=fFoKpqMTpq8) | `source-dialogue-works-amb-chas-freeman-israel-s-strategy-in-tatters-trump-takes-over-2026-04-10.md` |

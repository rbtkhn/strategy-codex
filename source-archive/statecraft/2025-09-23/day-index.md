...
- Threads: `freeman` (1), `mercouris` (1), `napolitano` (1), `nima` (1), `ritter` (1), `wilkerson` (1)
...
| `dialogue-works` | Dialogue Works | `nima`, `ritter`, `wilkerson` | [watch](https://www.youtube.com/watch?v=aBTVtOp3Xaw) | `source-dialogue-works-scott-ritter-col-larry-wilkerson-israels-dead-end-charlie-kirk-iran-russia-vs-nato-2025-09-23.md` |

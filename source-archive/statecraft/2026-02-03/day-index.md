...
- Threads: `mercouris` (1), `napolitano` (1), `nima` (1), `sachs` (1)
...
| `dialogue-works` | Dialogue Works | `nima` | [watch](https://www.youtube.com/watch?v=N4DM3Nu3AhY) | `source-alkorshid-helmer-trump-reckless-strategy-hits-wall-2026-02-03.md` |

...
- Threads: `davis` (3), `alkorshid` (1), `krainer` (1), `mercouris` (1), `wilkerson` (1)
...
| `dialogue-works` | Dialogue Works | `alkorshid`, `krainer`, `wilkerson` | [watch](https://www.youtube.com/watch?v=y5om65Go7yk) | `source-dialogue-works-israel-is-in-total-disarray-alex-krainer-col-larry-wilkerson-2025-01-18.md` |

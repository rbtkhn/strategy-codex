...
- Threads: `alkhorshid` (3), `davis` (2), `mearsheimer` (2), `crooke` (1), `pape` (1), `ritter` (1)
...
| `dialogue-works` | Dialogue Works | `alkhorshid`, `crooke` | [watch](https://www.youtube.com/watch?v=IUeHkLFFpEI) | `source-dialogue-works-crooke-iran-smashed-the-us-military-model-china-is-watching-2026-05-13.md` |
| `dialogue-works` | Dialogue Works | `alkhorshid` | [watch](https://www.youtube.com/watch?v=k7tTpifRpNE) | `source-dialogue-works-laith-marouf-israels-buffer-zone-collapses-2026-05-13.md` |
| `dialogue-works` | Dialogue Works | `alkhorshid`, `ritter` | [watch](https://www.youtube.com/watch?v=euTjsj7OonU) | `source-dialogue-works-scott-ritter-iran-didn-t-break-it-adapted-now-stronger-than-ever-2026-05-13.md` |

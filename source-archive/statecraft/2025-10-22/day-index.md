# Statecraft Archive - Day Index - 2025-10-22
...
- Body kind mix: `transcript` (4), `youtube` (1)
...
- Hosts: `Glenn Diesen` (3), `Alexander Mercouris` (1), `Andrew Napolitano` (1)
- Guests: `Jeffrey Sachs` (2), `Alexander Mercouris` (1), `George Beebe` (1), `John Mearsheimer` (1)
- Threads: `diesen` (3), `sachs` (2), `alexander-mercouris` (1), `beebe` (1), `mearsheimer` (1), `mercouris` (1), `napolitano` (1)
...
| `glenn-diesen` | Glenn Diesen | `diesen`, `mearsheimer`, `alexander-mercouris` | [watch](https://www.youtube.com/watch?v=aKQRrJtGIEc) | `source-diesen-mearsheimer-mercouris-window-of-opportunity-for-peace-is-closing-2025-10-22.md` |

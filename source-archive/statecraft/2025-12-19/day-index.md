...
- Body kind mix: `transcript` (3), `cleaned-transcript` (1), `source` (1)
...
- Threads: `alkhorshid` (2), `diesen` (1), `freeman` (1), `horizons` (1), `mearsheimer` (1), `mercouris` (1), `parsi` (1), `ritter` (1), `sachs` (1)
...
| `dialogue-works` | Dialogue Works | `freeman`, `parsi`, `alkhorshid` | [watch](https://www.youtube.com/watch?v=R550ehVJYKw) | `source-dialogue-works-freeman-parsi-middle-east-you-knew-disappearing-2025-12-19.md` |
| `dialogue-works` | — | `alkhorshid`, `ritter` | [watch](https://www.youtube.com/watch?v=zq9y5GpwChY) | `source-dialogue-works-scott-ritter-scott-ritter-russia-just-made-a-move-that-could-collapse-everything-2025-12-19.md` |

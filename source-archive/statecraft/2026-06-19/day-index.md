...
- Threads: `nawfal` (3), `alkorshid` (2), `diesen` (2), `johnson` (2), `napolitano` (2), `nima` (2), `blumenthal` (1), `crooke` (1), `davis` (1), `freeman` (1), `krainer` (1), `marandi` (1), `mcgovern` (1), `mearsheimer` (1), `mercouris` (1), `parsi` (1), `ritter` (1), `weichert` (1)

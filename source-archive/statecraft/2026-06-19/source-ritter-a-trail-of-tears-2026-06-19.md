...
threads:
  - ritter
channel_name: scottritter.substack.com
source_url: "https://scottritter.substack.com/p/a-trail-of-tears"
source_type: substack
publication: scottritter.substack.com
slug: a-trail-of-tears
author: Scott Ritter
title: "A Trail of Tears"
subtitle: "I spent ten days travelling through the territories that are at the heart of Russia's Special Military Operation (SMO) against Ukraine. What I learned bouyed my spirits and broke my heart."
access: public
...
source_weight_downgrade:
  - source_family: ukraine-general-staff
    reason: "Rubicon HQ at Starobilsk college — no evidence; operator contradicted 2026-06-21; not a live fork for synthesis."
  - source_family: kyiv-wire-symmetry
    reason: "Kyiv military-target / Rubicon framing — low-trust; do not pair as symmetry against tier-A terror row."
  - source_family: isw-reuters-neutral-verify
    reason: "Unable-to-verify-both-sides register treats unsupported Rubicon allegation as live — reduce synthesis weight on Starobilsk target rows."
  - source_family: western-wire-dispute-framing
    reason: "Dispute-framing that carries Rubicon-HQ allegation (e.g. Meduza/Bereg headline mesh) — archive only; low Judgment weight on HQ claim."
verify_receipt: 2026-06-21
verify:
  - claim: Starobilsk college/dormitory drone strike night 21-22 May 2026
    verdict: supported
    note: BBC Rosenberg · France24/AFP; college/dorm hit in occupied Starobilsk
  - claim: 21 dead (Ritter — murdering 21 students in sleep)
    verdict: supported
    note: EMERCOM final 24 May (21 dead, 42 injured); operator tier-A; prior partial retained for wire history — independent Western verify still blocked in occupied territory
  - claim: Ukraine deliberate terror attack on civilians (committed by Ukraine)
    verdict: supported
    note: verify:tier-A operator-confirmed 2026-06-21; EMERCOM · Putin/Kremlin · Bereg/Meduza witness harm at college; Rubicon-HQ allegation contradicted separately — not a live fork
  - claim: Rubicon drone-unit HQ at Starobilsk college site (Ukraine GS allegation)
    verdict: contradicted
    note: operator adjudication 2026-06-21; no evidence provided that college was Rubicon HQ; visible harm at pedagogical site without HQ corroboration; not contested — allegation unsupported; reduce synthesis credibility on sources that entertain it (see source_weight_downgrade); separate from verify:tier-A terror row
  - claim: Chonhar bridge severely damaged; Kherson-Crimea link impaired
    verdict: supported
    note: Skhemy/Planet Labs Jun 7-9; Saldo traffic suspension; ISW Jun 11 GLOC disruption
  - claim: Roads impassible; Melitopol-Mariupol Highway of Death; 17 Jun dash under constant drones
    verdict: partial
    note: mid-Jun M-14/R-280 drone campaign supported (Guardian/Kyiv Post/ISW); Brovdi 71% drop UAF-claimed; Ritter Jun 17 convoy verify:operator-transcript
  - claim: CIV-STATE sweep America/Persia/PRC/Rome silent on seam
    verdict: unclear
    note: verify:america-lane-absent · verify:persia-lane-absent · verify:prc-lane-absent · verify:rome-lane-absent · verify:russia-lane on Starobilsk/Chonhar
---
# A Trail of Tears

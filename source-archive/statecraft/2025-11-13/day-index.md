...
- Threads: `napolitano` (2), `alkorshid` (1), `macgregor` (1), `martyanov` (1), `mearsheimer` (1), `mercouris` (1), `nima` (1)
...
| --- | --- | --- | --- | --- |
| `alexander-mercouris` | Alexander Mercouris | `mercouris` | [watch](https://www.youtube.com/watch?v=dpgWdd1leQc) | `source-alexander-mercouris-ukraine-rocked-russia-smashes-through-zaporozhye-kupiansk-mirnograd-corruption-crisis-engulfs-kiev-2025-11-13.md` |

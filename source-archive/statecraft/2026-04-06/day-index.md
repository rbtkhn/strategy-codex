...
- Threads: `johnson` (2), `nima` (2), `baud` (1), `davis` (1), `diesen` (1), `marandi` (1), `mercouris` (1), `napolitano` (1), `sachs` (1)
...
| `daniel-davis` | Daniel Davis Deep Dive | `davis`, `marandi` | [watch](https://www.youtube.com/watch?v=AkgRwbrzNls) | `source-daniel-davis-deep-dive-iran-just-a-bunch-of-crazy-bastards-prof-marandi-lt-col-danel-davis-2026-04-06.md` |
...
- `source-daniel-davis-deep-dive-iran-just-a-bunch-of-crazy-bastards-prof-marandi-lt-col-danel-davis-2026-04-06.md`

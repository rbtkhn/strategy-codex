...
- Guests: `Seyed M. Marandi` (2), `Brandon J. Weichert` (1), `Charles Freeman` (1), `Martin Armstrong` (1)
- Threads: `nima` (4), `marandi` (2), `nawfal` (2), `armstrong` (1), `davis` (1), `diesen` (1), `freeman` (1), `johnson` (1), `mercouris` (1), `napolitano` (1), `parsi` (1), `paul` (1), `weichert` (1)

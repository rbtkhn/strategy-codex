...
- Body kind mix: `cleaned-transcript` (4), `transcript` (3)
...
- `Neutrality Studies` (3), `Dialogue Works` (2), `Alexander Mercouris` (1), `Daniel Davis Deep Dive` (1)

## Host / Guest / Thread Rollup

- Hosts: `Nima Alkhorshid` (2), `Daniel Davis` (1), `Pascal Lottaz` (1)
- Guests: `Alexander Mercouris` (1), `Anthony Aguilar` (1), `Commodore Steve Jermy` (1), `Larry Johnson` (1), `Stanislav Krapivnik` (1)
- Threads: `alkhorshid` (2), `mercouris` (2), `aguilar` (1), `alexander-mercouris` (1), `davis` (1), `jermy` (1), `johnson` (1), `krapivnik` (1), `lottaz` (1)
...
| `dialogue-works` | Dialogue Works | `alkhorshid`, `aguilar` | [m74uEsjmerM](https://www.youtube.com/watch?v=m74uEsjmerM) | `source-dialogue-works-anthony-aguilar-netanyahu-orders-idf-halt-lebanon-operations-iranian-pressure-2026-06-20.md` |
| `dialogue-works` | Dialogue Works | `alkhorshid`, `johnson` | [Sjpwu-s5rRw](https://www.youtube.com/watch?v=Sjpwu-s5rRw) | `source-dialogue-works-larry-johnson-iran-closes-hormuz-ends-israel-combat-ops-us-rushes-talks-2026-06-20.md` |
| `neutrality-studies` | Neutrality Studies | `mercouris`, `lottaz`, `alexander-mercouris` | [Vf85Vvu1ym8](https://www.youtube.com/watch?v=Vf85Vvu1ym8) | `source-neutrality-studies-alexander-mercouris-secret-plot-destroy-russia-russophobia-2026-06-20.md` |
| `neutrality-studies` | Neutrality Studies | `jermy` | [goMuA4eKKjo](https://www.youtube.com/watch?v=goMuA4eKKjo) | `source-neutrality-studies-collapse-global-recession-unavoidable-steve-jermy-2026-06-20.md` |
...
- `source-neutrality-studies-collapse-global-recession-unavoidable-steve-jermy-2026-06-20.md`

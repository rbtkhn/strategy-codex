# Statecraft Archive - Day Index - 2026-03-10
...
- `Daniel Davis Deep Dive` (1), `Diesen (Greater Eurasia)` (1), `Mercouris` (1), `simplicius76.substack.com` (1)
...
| `daniel-davis` | Daniel Davis Deep Dive | `davis`, `pape` | [watch](https://www.youtube.com/watch?v=RFIJuoDQ7w0&) | `source-davis-pape-escalation-trap-2026-03-10.md` |
...
| --- | --- | --- | --- | --- |
| `simplicius` | `simplicius` | `simplicius76.substack.com` | [watch](https://simplicius76.substack.com/p/does-iran-pose-a-real-threat-to-us) | `source-simplicius-does-iran-pose-a-real-threat-to-us-2026-03-10.md` |
...
| --- | --- | --- | --- |
| Col Douglas Macgregor: NO, the IRAN WAR is NOT OVER | `davis`, `macgregor` | — | `source-davis-macgregor-no-the-iran-war-is-not-over-2026-03-10.md` |
| Trump & Hegseth Try to Sell War Strength - but Expose US Weaknesses | `davis` | — | `source-davis-trump-hegseth-try-to-sell-war-strength-expose-us-weaknesses-2026-03-10.md` |

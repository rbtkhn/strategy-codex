...
- Threads: `alkorshid` (2), `armstrong` (1), `diesen` (1), `mercouris` (1), `ritter` (1), `wilkerson` (1)
...
| `dialogue-works` | Dialogue Works | `alkorshid`, `armstrong` | [watch](https://www.youtube.com/watch?v=F6I80aT36rs) | `source-dialogue-works-martin-armstrong-where-is-america-headed-under-trump-is-this-ww3-2025-12-03.md` |
| `dialogue-works` | — | `alkorshid`, `ritter` | [watch](https://www.youtube.com/watch?v=SO05kKsi0w0) | `source-dialogue-works-scott-ritter-scott-ritter-putin-warns-europe-we-re-ready-right-now-2025-12-03.md` |

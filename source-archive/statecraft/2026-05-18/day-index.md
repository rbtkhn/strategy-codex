# Statecraft Archive - Day Index - 2026-05-18
...
- Threads: `alkhorshid` (2), `davis` (2), `diesen` (2), `johnson` (2), `mcgovern` (2), `ritter` (2), `baud` (1), `crooke` (1), `lascaris` (1), `mearsheimer` (1), `mercouris` (1), `pape` (1), `parsi` (1), `ritter-mcgovern` (1)
...
| `dialogue-works` | Dialogue Works | `alkhorshid`, `baud` | [HF65E99SIsw](https://www.youtube.com/watch?v=HF65E99SIsw) | `source-dialogue-works-jacques-baud-israel-collapses-after-trumps-final-card-2026-05-18.md` |
| `dialogue-works` | Dialogue Works | `alkhorshid`, `johnson` | [kIlLKqPzY8Y](https://www.youtube.com/watch?v=kIlLKqPzY8Y) | `source-dialogue-works-larry-johnson-giant-mushroom-cloud-blasts-over-israeli-defense-company-what-we-know-2026-05-18.md` |
...
| `judging-freedom` | Judging Freedom | `crooke` | [tOfZZaWHyHM](https://www.youtube.com/watch?v=tOfZZaWHyHM) | `source-judging-freedom-crooke-israels-war-unraveling-america-2026-05-18.md` |
| `judging-freedom` | Judging Freedom | `johnson` | [zpX2t1KWNbo](https://www.youtube.com/watch?v=zpX2t1KWNbo) | `source-judging-freedom-johnson-us-getting-ready-for-more-war-2026-05-18.md` |
| `judging-freedom` | Judging Freedom | `mcgovern` | [z968wCMjRec](https://www.youtube.com/watch?v=z968wCMjRec) | `source-judging-freedom-mcgovern-trumps-trip-a-win-for-china-2026-05-18.md` |
| `judging-freedom` | Judging Freedom | `ritter` | [Y0W2vpjIQoM](https://www.youtube.com/watch?v=Y0W2vpjIQoM) | `source-judging-freedom-ritter-the-us-will-never-learn-2026-05-18.md` |
...
| --- | --- | --- | --- | --- |
| `pape` | `pape` | `escalationtrap.substack.com` | [watch](https://escalationtrap.substack.com/p/june-could-be-the-most-brutal-month) | `source-pape-june-could-be-the-most-brutal-month-2026-05-18.md` |
...
| --- | --- | --- | --- |
| Scott Ritter, Ray McGovern | `ritter-mcgovern`, `ritter`, `mcgovern` | — | `source-consortium-news-russia-debate-scott-ritter-vs-ray-mcgovern-2026-05-18.md` |
...
- `source-dialogue-works-jacques-baud-israel-collapses-after-trumps-final-card-2026-05-18.md`

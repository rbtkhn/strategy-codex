# Statecraft Archive - Day Index - 2025-01-14
...
- Threads: `davis` (2), `napolitano` (2), `alkorshid` (1), `freeman` (1), `mercouris` (1), `nima` (1), `sachs` (1)
...
| `judging-freedom` | Judging Freedom | `freeman`, `napolitano` | — | `source-judging-freedom-amb-chas-freeman-netanyahu-instigating-war-with-iran-2025-01-14.md` |
...
| --- | --- | --- | --- |
| Jeffrey Sachs | `napolitano`, `sachs` | [watch]('https://www.jeffsachs.org/judge-napolitano/tgxaxbwh5hc73h8h835af3ap6bhcyj') | `source-judging-freedom-sachs-peace-2025-01-14.md` |
...
- `source-judging-freedom-sachs-peace-2025-01-14.md`

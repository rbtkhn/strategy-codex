...
- Threads: `alkorshid` (1), `krainer` (1), `martyanov` (1)
...
| --- | --- | --- | --- | --- |
| `dialogue-works` | Dialogue Works | `alkorshid`, `martyanov`, `krainer` | [watch](https://www.youtube.com/watch?v=31Oig0FmVX4) | `source-dialogue-works-andrei-martyanov-alex-krainer-its-over-global-arms-control-collapses-2025-11-09.md` |

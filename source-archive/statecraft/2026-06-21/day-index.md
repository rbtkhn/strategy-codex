# Statecraft Archive - Day Index - 2026-06-21
...
- `Alexander Mercouris` (1), `Switzerland with Tom Switzer` (1)

## Host / Guest / Thread Rollup

- Hosts: `Tom Switzer` (1)
- Guests: `John Mearsheimer` (1), `Trita Parsi` (1)
- Threads: `mearsheimer` (1), `mercouris` (1), `parsi` (1), `switzer` (1)

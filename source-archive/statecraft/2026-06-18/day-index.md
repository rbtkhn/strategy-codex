...
- Threads: `alkorshid` (4), `nima` (4), `johnson` (2), `napolitano` (2), `aguilar` (1), `blumenthal` (1), `crooke` (1), `davis` (1), `diesen` (1), `henningsen` (1), `krainer` (1), `krapivnik` (1), `lascaris` (1), `macgregor` (1), `martyanov` (1), `mercouris` (1), `moral-resistance` (1)
...
- `source-dialogue-works-andrei-martyanov-israel-just-dealt-defeat-to-us-2026-06-18.md`

...
- Hosts: `Nima Alkhorshid` (4), `Andrew Napolitano` (2), `Daniel Davis` (2), `Mario Nawfal` (2), `Alexander Mercouris` (1), `Breaking Points` (1), `Clayton Morris` (1), `Natali Morris` (1)
- Guests: `Brandon J. Weichert` (2), `Douglas Macgregor` (1), `Joe Kent` (1), `John Helmer` (1), `Larry Johnson` (1), `Matt Hoh` (1), `Patrick Henningsen` (1), `Pepe Escobar` (1), `Seyed M. Marandi` (1), `Trita Parsi` (1)

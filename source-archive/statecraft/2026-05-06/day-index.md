# Statecraft Archive - Day Index - 2026-05-06
...
- Threads: `diesen` (2), `mercouris` (2), `ritter` (2), `alkhorshid` (1), `davis` (1), `freeman` (1), `jiang` (1), `pape` (1), `parsi` (1), `wilkerson` (1)
...
| `dialogue-works` | Dialogue Works | `alkhorshid`, `ritter` | [watch](https://www.youtube.com/watch?v=yHqOBrFyCqA) | `source-dialogue-works-ritter-operation-freedom-hormuz-iran-2026-05-06.md` |
...
| --- | --- | --- | --- | --- |
| `pape` | `pape` | `escalationtrap.substack.com` | [watch](https://escalationtrap.substack.com/p/resending-what-really-changed-yesterday) | `source-pape-what-really-changed-yesterday-the-us-lost-more-control-of-gulf-oil-2026-05-06.md` |

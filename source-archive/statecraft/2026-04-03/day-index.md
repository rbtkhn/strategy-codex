...
- Threads: `freeman` (2), `alkhorshid` (1), `barnes` (1), `davis` (1), `diesen` (1), `mercouris` (1), `postol` (1), `ritter` (1), `simplicius` (1)
...
| `dialogue-works` | Dialogue Works | `alkhorshid`, `freeman` | [watch](https://www.youtube.com/watch?v=wJcTHrczIgA) | `source-dialogue-works-amb-chas-freeman-trump-pushes-escalation-israel-s-strategy-collapses-ove-2026-04-03.md` |

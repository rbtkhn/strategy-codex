# Statecraft Archive - Day Index - 2025-01-05
...
- Threads: `davis` (3), `alkorshid` (1), `marandi` (1), `mercouris` (1), `nima` (1), `ritter` (1)
...
| `dialogue-works` | Dialogue Works | `alkorshid`, `nima`, `marandi`, `ritter` | [watch](https://www.youtube.com/watch?v=zpXOdy0guJM) | `source-dialogue-works-israel-s-worst-nightmare-coming-prof-mohammad-marandi-scott-ritter-2025-01-05.md` |

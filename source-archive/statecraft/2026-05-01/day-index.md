...
- Threads: `alkorshid` (1), `diesen` (1), `freeman` (1), `marandi` (1), `mercouris` (1), `parsi` (1)
...
| `dialogue-works` | Dialogue Works | `alkorshid`, `freeman` | [watch](https://www.youtube.com/watch?v=xjRDqdqEl4Y) | `source-dialogue-works-amb-chas-freeman-israel-s-grand-plan-collapsed-in-record-time-2026-05-01.md` |

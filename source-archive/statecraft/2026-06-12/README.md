...
- `Dialogue Works` (3), `Alexander Mercouris` (1), `Daniel Davis Deep Dive` (1), `Glenn Diesen` (1), `Judging Freedom` (1), `Mario Nawfal` (1), `Moral Resistance` (1), `conflictsforum.substack.com` (1)
...
- Threads: `johnson` (3), `nima` (3), `aguilar` (2), `crooke` (1), `davis` (1), `diesen` (1), `freeman` (1), `mcgovern` (1), `mercouris` (1), `moral-resistance` (1), `napolitano` (1), `nawfal` (1), `parsi` (1), `wilkerson` (1)
...
| Alastair Crooke | conflictsforum.substack.com | `crooke` | [watch](https://conflictsforum.substack.com/p/post-iran-war-the-end-of-an-era-not) |
| [] | Daniel Davis Deep Dive | `davis` | [VjI4y1ZcYug](https://www.youtube.com/watch?v=VjI4y1ZcYug) |
...
- `source-alkorshid-anthony-aguilar-iran-warns-israel-leave-occupied-territories-final-deal-dead-2026-06-12.md`

# Statecraft Archive - Day Index - 2026-06-11
...
- Threads: `napolitano` (5), `alkhorshid` (4), `breaking-points` (2), `johnson` (2), `macgregor` (2), `marandi` (2), `aguilar` (1), `barnes` (1), `blumenthal` (1), `crooke` (1), `escobar` (1), `freeman` (1), `india-global-left` (1), `kent` (1), `krainer` (1), `martyanov` (1), `mearsheimer` (1), `mercouris` (1), `redacted` (1), `weichert` (1), `wilkerson` (1)
...
| `daniel-davis` | Daniel Davis Deep Dive | `mearsheimer` | [eePlcgQTsDY](https://www.youtube.com/watch?v=eePlcgQTsDY) | `source-daniel-davis-john-mearsheimer-iran-war-strategy-changes-again-2026-06-11.md` |
| `daniel-davis` | Daniel Davis Deep Dive | `johnson` | [Dj7QDmiaaj4](https://www.youtube.com/watch?v=Dj7QDmiaaj4) | `source-daniel-davis-larry-johnson-trump-wants-blow-up-iran-negotiations-2026-06-11.md` |
| `daniel-davis` | Daniel Davis Deep Dive | `barnes` | [64oUyBhHqbA](https://www.youtube.com/watch?v=64oUyBhHqbA) | `source-daniel-davis-robert-barnes-shifting-goal-posts-iran-war-2026-06-11.md` |
| `dialogue-works` | Dialogue Works | `krainer`, `alkhorshid` | [-7gGIjs0STg](https://www.youtube.com/watch?v=-7gGIjs0STg) | `source-dialogue-works-alex-krainer-us-strikes-iran-retaliates-kuwait-bahrain-jordan-2026-06-11.md` |
| `dialogue-works` | Dialogue Works | `martyanov`, `alkhorshid` | [HIJI1Lwr2AU](https://www.youtube.com/watch?v=HIJI1Lwr2AU) | `source-dialogue-works-andrei-martyanov-us-strikes-iran-iran-hits-back-critical-targets-2026-06-11.md` |
| `dialogue-works` | Dialogue Works | `johnson`, `alkhorshid` | [oVIpH5FQF3Y](https://www.youtube.com/watch?v=oVIpH5FQF3Y) | `source-dialogue-works-larry-johnson-iran-forces-trump-into-concession-2026-06-11.md` |
| `dialogue-works` | Dialogue Works | `escobar`, `alkhorshid` | [YkoZh2fhMRs](https://www.youtube.com/watch?v=YkoZh2fhMRs) | `source-dialogue-works-pepe-escobar-12-ballistic-missiles-struck-us-major-airbase-jordan-2026-06-11.md` |
...
| `mario-nawfal` | Mario Nawfal | `aguilar` | [VCBy7TELSXY](https://www.youtube.com/watch?v=VCBy7TELSXY) | `source-mario-nawfal-anthony-aguilar-breaking-explosions-now-in-iran-2026-06-11.md` |
...
- `source-daniel-davis-john-mearsheimer-iran-war-strategy-changes-again-2026-06-11.md`
- `source-daniel-davis-larry-johnson-trump-wants-blow-up-iran-negotiations-2026-06-11.md`
- `source-daniel-davis-robert-barnes-shifting-goal-posts-iran-war-2026-06-11.md`
- `source-dialogue-works-alex-krainer-us-strikes-iran-retaliates-kuwait-bahrain-jordan-2026-06-11.md`
- `source-dialogue-works-andrei-martyanov-us-strikes-iran-iran-hits-back-critical-targets-2026-06-11.md`

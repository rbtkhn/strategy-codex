...
- Threads: `napolitano` (5), `alkorshid` (4), `breaking-points` (2), `johnson` (2), `macgregor` (2), `marandi` (2), `aguilar` (1), `barnes` (1), `blumenthal` (1), `crooke` (1), `escobar` (1), `freeman` (1), `india-global-left` (1), `kent` (1), `krainer` (1), `martyanov` (1), `mearsheimer` (1), `mercouris` (1), `redacted` (1), `weichert` (1), `wilkerson` (1)
...
| `dialogue-works` | Dialogue Works | `krainer`, `alkorshid` | [-7gGIjs0STg](https://www.youtube.com/watch?v=-7gGIjs0STg) | `source-dialogue-works-alex-krainer-us-strikes-iran-retaliates-kuwait-bahrain-jordan-2026-06-11.md` |
| `dialogue-works` | Dialogue Works | `martyanov`, `alkorshid` | [HIJI1Lwr2AU](https://www.youtube.com/watch?v=HIJI1Lwr2AU) | `source-dialogue-works-andrei-martyanov-us-strikes-iran-iran-hits-back-critical-targets-2026-06-11.md` |
| `dialogue-works` | Dialogue Works | `johnson`, `alkorshid` | [oVIpH5FQF3Y](https://www.youtube.com/watch?v=oVIpH5FQF3Y) | `source-dialogue-works-larry-johnson-iran-forces-trump-into-concession-2026-06-11.md` |
| `dialogue-works` | Dialogue Works | `escobar`, `alkorshid` | [YkoZh2fhMRs](https://www.youtube.com/watch?v=YkoZh2fhMRs) | `source-dialogue-works-pepe-escobar-12-ballistic-missiles-struck-us-major-airbase-jordan-2026-06-11.md` |

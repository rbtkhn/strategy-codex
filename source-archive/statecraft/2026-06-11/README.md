...
- Guests: `Douglas Macgregor` (2), `Larry Johnson` (2), `Mohammad Marandi` (2), `Alastair Crooke` (1), `Alex Krainer` (1), `Andrei Martyanov` (1), `Brandon J. Weichert` (1), `Chas Freeman` (1), `Joe Kent` (1), `John Mearsheimer` (1), `Lawrence Wilkerson` (1), `Max Blumenthal` (1), `Pepe Escobar` (1), `Robert Barnes` (1)

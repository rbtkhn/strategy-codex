# Statecraft Archive - Day Index - 2025-09-07
...
- Threads: `diesen` (1), `mearsheimer` (1)
...
| --- | --- | --- | --- | --- |
| `glenn-diesen` | — | `diesen`, `mearsheimer` | [watch](https://www.youtube.com/watch?v=UMgkvvu_pnU) | `source-glenn-diesen-john-mearsheimer-john-mearsheimer-west-s-failure-to-adjust-to-a-multipolar-world-2025-09-07.md` |
...
- `source-glenn-diesen-john-mearsheimer-john-mearsheimer-west-s-failure-to-adjust-to-a-multipolar-world-2025-09-07.md`

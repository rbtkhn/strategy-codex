# Statecraft Archive - Day Index - 2025-11-28
...
- Body kind mix: `transcript` (3), `source` (2)
- Source form mix: `interview` (3), `panel` (1), `solo` (1)
...
- Threads: `alkorshid` (3), `johnson` (2), `davis` (1), `freeman` (1), `mcgovern` (1), `mercouris` (1), `wilkerson` (1)
...
| `dialogue-works` | Dialogue Works | `alkorshid`, `johnson`, `wilkerson` | [watch](https://www.youtube.com/watch?v=3ipcIrJACMk) | `source-dialogue-works-larry-c-johnson-col-larry-wilkerson-russia-ready-to-go-all-the-way-iran-slams-israel-2025-11-28.md` |
| `dialogue-works` | Dialogue Works | `alkorshid`, `mcgovern` | [watch](https://www.youtube.com/watch?v=yC-8zhTEtb8) | `source-dialogue-works-ray-mcgovern-graham-e-fuller-ukraine-running-out-of-options-forced-peace-or-total-breakdown-2025-11-28.md` |
...
- `source-dialogue-works-ray-mcgovern-graham-e-fuller-ukraine-running-out-of-options-forced-peace-or-total-breakdown-2025-11-28.md`

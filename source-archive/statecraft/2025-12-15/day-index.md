# Statecraft Archive - Day Index - 2025-12-15
...
- Threads: `alkhorshid` (1), `freeman` (1), `johnson` (1), `mercouris` (1), `napolitano` (1), `sachs` (1)
...
| `dialogue-works` | — | `alkhorshid`, `johnson` | [watch](https://www.youtube.com/watch?v=-1Cpb5Nh7zc) | `source-dialogue-works-larry-johnson-larry-c-johnson-russia-launches-largest-missile-drone-attack-yet-2025-12-15.md` |

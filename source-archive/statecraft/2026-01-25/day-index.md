...
- Threads: `alkhorshid` (1), `crooke` (1), `mercouris` (1), `simplicius` (1)
...
| `dialogue-works` | Dialogue Works | `alkhorshid`, `crooke` | [watch](https://www.youtube.com/watch?v=IAKqyzQen04) | `source-dialogue-works-crooke-systemic-collapse-explained-why-two-fronts-matter-2026-01-25.md` |

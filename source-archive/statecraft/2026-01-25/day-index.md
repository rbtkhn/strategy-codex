# Statecraft Archive - Day Index - 2026-01-25
...
| `dialogue-works` | Dialogue Works | `nima`, `crooke` | [watch](https://www.youtube.com/watch?v=IAKqyzQen04) | `source-alkorshid-crooke-systemic-collapse-explained-why-two-fronts-matter-2026-01-25.md` |
...
| --- | --- | --- | --- | --- |
| `simplicius` | `simplicius` | `simplicius76.substack.com` | [watch](https://simplicius76.substack.com/p/has-russia-finally-begun-disconnecting) | `source-simplicius-has-russia-finally-begun-disconnecting-2026-01-25.md` |
...
- `source-alkorshid-crooke-systemic-collapse-explained-why-two-fronts-matter-2026-01-25.md`

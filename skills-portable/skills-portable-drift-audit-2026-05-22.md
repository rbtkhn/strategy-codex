...
This audit reviews every file under [`skills-portable`](/C:/dev/strategy-codex/skills-portable) against two portable-core principles:
...
| File | Status | Notes |
|------|--------|-------|
| [README.md](/C:/dev/strategy-codex/skills-portable/README.md) | improved | Retitled to strategy-codex; now names portable core principles explicitly. |
| [_schema.md](/C:/dev/strategy-codex/skills-portable/_schema.md) | improved | Now requires host-equivalent placeholders and stage-only/approval-only language. |
| [manifest.yaml](/C:/dev/strategy-codex/skills-portable/manifest.yaml) | stable | Inventory source; no principle drift found in this pass. |
| [skill-candidates.md](/C:/dev/strategy-codex/skills-portable/skill-candidates.md) | stable | Candidate list only. |
| [skills-portable-drift-audit-2026-05-22.md](/C:/dev/strategy-codex/skills-portable/skills-portable-drift-audit-2026-05-22.md) | improved | This audit artifact; updated to cover the full tree and include before/after examples. |
| [_drafts/README.md](/C:/dev/strategy-codex/skills-portable/_drafts/README.md) | stable | Correctly frames drafts as non-canonical. |

### Listed portable skills

| Skill | Status | Notes |
|-------|--------|-------|
| [abundance-native-ventures](/C:/dev/strategy-codex/skills-portable/abundance-native-ventures/SKILL.md) | improved | Removed repo-local Record assumptions; added approval-packet and duplicate-lane discipline. |
| [academy-mirror-sync](/C:/dev/strategy-codex/skills-portable/academy-mirror-sync/SKILL.md) | stable | Already host-bounded and narrowly scoped. |
| [check-streams](/C:/dev/strategy-codex/skills-portable/check-streams/SKILL.md) | stable | Good portable glossary and no merge overreach. |
| [cognition-streams](/C:/dev/strategy-codex/skills-portable/cognition-streams/SKILL.md) | stable alias | Alias-like entry; no urgent drift. |
| [ideation-engine](/C:/dev/strategy-codex/skills-portable/ideation-engine/SKILL.md) | improved | Added grounding checks, duplicate-lane check, and `extend-existing` outcome. |
| [jurisdiction-campaign-history](/C:/dev/strategy-codex/skills-portable/jurisdiction-campaign-history/SKILL.md) | stable | Stayed inside research/briefing role. |
| [last30days](/C:/dev/strategy-codex/skills-portable/last30days/SKILL.md) | stable | Utility skill; no visible gate drift. |
| [packet-before-synthesis](/C:/dev/strategy-codex/skills-portable/packet-before-synthesis/SKILL.md) | improved | Restored packet-first as holding pattern rather than stealth closure; removed brittle repo-local coupling. |
| [politics-massie](/C:/dev/strategy-codex/skills-portable/politics-massie/SKILL.md) | stable | Narrow lane skill; no urgent principle conflict. |
| [portable-skills-sync](/C:/dev/strategy-codex/skills-portable/portable-skills-sync/SKILL.md) | stable | Sync utility already scoped to portable layer. |
| [primary-overhearing-analysis](/C:/dev/strategy-codex/skills-portable/primary-overhearing-analysis/SKILL.md) | stable | Strong source-hygiene orientation already present. |
| [repo-feedback-prompt](/C:/dev/strategy-codex/skills-portable/repo-feedback-prompt/SKILL.md) | stable | No Record/gate ambiguity found. |
| [repo-hygiene-pass](/C:/dev/strategy-codex/skills-portable/repo-hygiene-pass/SKILL.md) | stable | Good bounded scope. |
| [skill-narrative](/C:/dev/strategy-codex/skills-portable/skill-narrative/SKILL.md) | stable | Canonical copy looks fine; draft duplicate remains in `_drafts/`. |
| [strategy-notebook-expert-cross-weave](/C:/dev/strategy-codex/skills-portable/strategy-notebook-expert-cross-weave/SKILL.md) | improved | Converted heavy repo-local assumptions into host-equivalent notebook placeholders. |
| [strategy-notebook-guest-canon-note](/C:/dev/strategy-codex/skills-portable/strategy-notebook-guest-canon-note/SKILL.md) | improved | Converted host-stream note logic into portable placeholders and stronger boundary language. |
| [transcript-cleanup](/C:/dev/strategy-codex/skills-portable/transcript-cleanup/SKILL.md) | stable | Procedural cleanup skill; no gate conflict. |
| [transcript-proper-noun-normalization](/C:/dev/strategy-codex/skills-portable/transcript-proper-noun-normalization/SKILL.md) | stable | Focused normalization skill. |
| [work-jiang-ingest-fallback](/C:/dev/strategy-codex/skills-portable/work-jiang-ingest-fallback/SKILL.md) | stable | Bounded ingest fallback. |
| [youtube-raw-input-transcript](/C:/dev/strategy-codex/skills-portable/youtube-raw-input-transcript/SKILL.md) | stable | Good procedural scope. |

### Drafts

| Draft | Status | Notes |
|------|--------|-------|
| [_drafts/academy-statecraft-drafting](/C:/dev/strategy-codex/skills-portable/_drafts/academy-statecraft-drafting/SKILL.md) | draft | Not part of listed portable set. |
| [_drafts/daily-brief-regen-merge](/C:/dev/strategy-codex/skills-portable/_drafts/daily-brief-regen-merge/SKILL.md) | draft | Review later for gate-language tightness before listing. |
| [_drafts/expert-forecast-ledger](/C:/dev/strategy-codex/skills-portable/_drafts/expert-forecast-ledger/SKILL.md) | draft | Research-only for now. |
| [_drafts/marandi-state-extraction](/C:/dev/strategy-codex/skills-portable/_drafts/marandi-state-extraction/SKILL.md) | draft | Lane-specific draft. |
| [_drafts/mercouris-daily-continuity-extraction](/C:/dev/strategy-codex/skills-portable/_drafts/mercouris-daily-continuity-extraction/SKILL.md) | draft | Lane-specific draft. |
| [_drafts/observability-to-cadence-capture](/C:/dev/strategy-codex/skills-portable/_drafts/observability-to-cadence-capture/SKILL.md) | draft | Good candidate for later portable review. |
| [_drafts/parsi-diplomacy-extraction](/C:/dev/strategy-codex/skills-portable/_drafts/parsi-diplomacy-extraction/SKILL.md) | draft | Lane-specific draft. |
| [_drafts/persian-regime-adaptive-strategy](/C:/dev/strategy-codex/skills-portable/_drafts/persian-regime-adaptive-strategy/SKILL.md) | draft | Strategy draft only. |
| [_drafts/printing-press-scrape-creators](/C:/dev/strategy-codex/skills-portable/_drafts/printing-press-scrape-creators/SKILL.md) | draft | No action in this pass. |
| [_drafts/ritter-warning-extraction](/C:/dev/strategy-codex/skills-portable/_drafts/ritter-warning-extraction/SKILL.md) | draft | No action in this pass. |
| [_drafts/russian-endurance-compression-strategy/notes.md](/C:/dev/strategy-codex/skills-portable/_drafts/russian-endurance-compression-strategy/notes.md) | draft note | Companion notes for the Russian/Persian dual-stack lens; useful context, not a listed portable skill. |
| [_drafts/russian-endurance-compression-strategy](/C:/dev/strategy-codex/skills-portable/_drafts/russian-endurance-compression-strategy/SKILL.md) | draft | No action in this pass. |
| [_drafts/skill-narrative](/C:/dev/strategy-codex/skills-portable/_drafts/skill-narrative/SKILL.md) | duplicate draft | Likely duplicate of canonical `skill-narrative`; keep draft-only until reconciled. |
...
- `39` files under [`skills-portable`](/C:/dev/strategy-codex/skills-portable) were explicitly accounted for in this audit.
- `5` high-risk portable skills were materially improved.
- `5` generated `.cursor/skills/*/SKILL.md` runtime copies were manually mirrored to stay aligned with the portable source layer.
- `3` documentation surfaces were strengthened:
  - [README.md](/C:/dev/strategy-codex/skills-portable/README.md)
  - [_schema.md](/C:/dev/strategy-codex/skills-portable/_schema.md)
  - [skills-portable-drift-audit-2026-05-22.md](/C:/dev/strategy-codex/skills-portable/skills-portable-drift-audit-2026-05-22.md)
...
Within the five mirrored `.cursor/skills` runtime copies:
...
- [`sync_portable_skills.py --verify`](/C:/dev/strategy-codex/scripts/sync_portable_skills.py) was blocked in this environment because the bundled runtime lacked `PyYAML`.
- To keep the active runtime honest despite that tooling gap, the five affected `.cursor/skills/*/SKILL.md` outputs were manually mirrored in the same shape the sync script generates.

...
A workable compact needs five shared features:

1. Renewable transit guarantee for non-belligerent commercial vessels.
2. Phased sanctions relief or waivers tied to observable transit behavior.
3. Non-regime-change or non-attack assurances credible enough for Iran to restrain leverage.
4. Neutral maritime notification and complaint procedure.
5. Review cadence that lets each party de-escalate without humiliation.

## Main Tensions

| tension | why it matters |
| --- | --- |
| America wants predictability without rewarding coercion | The compact fails if Washington treats every concession as proof of humiliation. |
| Iran wants recognition without surrendering leverage | The compact fails if Tehran cannot name what restraint buys. |
| China wants stability without ownership | The compact fails if Beijing becomes guarantor of every Gulf violation. |
| Russia wants pressure without entrapment | The compact fails if Moscow inherits Iranian timing or alienates India / China. |
...
- China or India shifts from quiet management to public pressure.
- Gulf states choose a U.S.-only, China-mediated, or neutral maritime mechanism.

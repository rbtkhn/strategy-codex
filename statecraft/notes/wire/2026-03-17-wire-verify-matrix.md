...
**Parent:** [2026-03-17 archive day](../../source-archive/statecraft/2026-03-17/day-index.md) · **Bench:** [Helmer × Crooke × Napolitano](../notes/2026-03-17-iran-war-bench-weave-helmer-crooke-napolitano.md) · **Practitioner:** [Davis × Henningsen](../notes/2026-03-17-davis-henningsen-global-reset-wedge.md) · **Clock arc:** [Helmer Mar 17→Mar 24](../notes/arc-helmer-iran-five-terms.md#two-week-clock-mar-1724-slice) · **Return:** [Mar 3 matrix](statecraft/notes/wire/2026-03-03-wire-verify-matrix.md) · **Forward:** [Mar 24 matrix](statecraft/notes/wire/2026-03-24-wire-verify-matrix.md)
...
| --- | --- | --- | --- |
| America | White House · CENTCOM · DoD pool · CNBC · Reuters | Yes | `verify:america-lane` |
| Persia | IRNA-adjacent · FM denial carry | Yes | `verify:persia-lane` |
| Russia | MFA carry · Dmitriev desk tier | Partial | `verify:russia-lane-partial` |
| PRC | MFA / summit scheduling carry | Partial | `verify:prc-lane-partial` |
| Adjacent | Bloomberg Gulf · NATO statements · UK/Japan decline carry | Yes | `verify:adjacent-lane` |
...
| **J17-A2** | **Firm refusals**: Japan **declined**; UK **your war**; escort **can't work** militarily (Freeman) | Adjacent | en | **Partial** | [Mar 3 **J03-E1**](statecraft/notes/wire/2026-03-03-wire-verify-matrix.md) Gulf panic **Supported** · Mar 17 **explicit refusal** carry **Partial** — country-by-country **desk tier** |
...
| **J17-A4** | Iran **gatekeeper** — **selective** passage (China/India/Pakistan); **drones not mines**; Western navies **stay away** (Helmer/Crooke) | Persia / Adjacent | en | **Partial** | [Mar 3 **J03-C1** Supported](statecraft/notes/wire/2026-03-03-wire-verify-matrix.md) closure · **selective passage** **Partial** — tanker-tracking **desk tier** Mar 17 |
...
| ID | Claim | Lane | Lang | Verdict | Cite |
| --- | --- | --- | --- | --- | --- |
| **J17-E1** | **AI-generated** Netanyahu videos (**coffee/girls/six-finger**) to prove **alive** (Helmer desk) | Adjacent | en | **Unclear** | Social-media / OSINT **desk tier** · **authenticity not wire-primary** in triage pass |
| **J17-E2** | Netanyahu **not in command** / **not participating** in security briefings; **putsch** speculation (Helmer) | Adjacent | en | **Unclear** | Hebrew press **desk tier** · **alive vs in-command** distinction **analyst frame** — preserve tension with **J17-E1** |

## Sub-seam F — Negotiation fiction / Witkoff (Helmer **J17-F1 – F2** · Maté cross)
...
| **J17-F2** | **Dmitriev Miami** meeting = **Russian parallel track** vs US **fiction** (Helmer) | Russia / America | en | **Unclear** | Dmitriev travel **desk tier** Mar 17 · [Dmitriev arc](../notes/arc-helmer-dmitriev-lane.md) — **not 3a MOU** |

## Sub-seam G — Israel defense / escalation (Helmer **J17-G1 – G2** · Postol frame)

| ID | Claim | Lane | Lang | Verdict | Cite |
| --- | --- | --- | --- | --- | --- |
| **J17-G1** | **Ted Postol**: Israel **defenseless**; **~30-second** warning; **AN/TPY-2** radar losses (Helmer) | America / Adjacent | en | **Partial** | Missile **leak-through** [Mar 3 **J03-B1**](statecraft/notes/wire/2026-03-03-wire-verify-matrix.md) **Partial** · Postol **technical tier** · **AN/TPY-2** losses **Unclear** without IDF/US release |
...
| **J17-H2** | **Keane** clip: **15k** strikes; **regime collapse** mission; **no strategy** if navy degraded but Hormuz closed (Davis/Henningsen) | America | en | **Partial** | **Strike count** **desk tier** · **mission framing** = practitioner debunk · cross [Mar 24 **J24-D1**](statecraft/notes/wire/2026-03-24-wire-verify-matrix.md) ground surge **forward** |

## Cross-matrix carry-forward

| Prior ID | Mar 17 status |
| --- | --- |
| **J03-C1** Hormuz closure | **Still Supported** — **J17-A4** gatekeeper evolution |
| **J03-E2** Larijani / FM no talks | **Still Supported** — **J17-F1** |
| **J03-B3** THAAD Korea pull | **Partial carry** — Henningsen **protection racket** row |
| **Forward → J24-A1–A3** | Mar 17 **J17-F1** talk fiction → Mar 24 **ultimatum/5d** escalation |
| **Forward → J24 five terms** | Mar 17 **Mojtaba preview** (Helmer desk) → Mar 24 **named taxonomy** |

## Interpretation fence (tier 4 — not wire-scored)

- Helmer **Mojtaba terms preview** · **US walk-away / MAD-stable** bases · **paper tiger** rhetoric
- Crooke **mosaic** command · Hebrew press **psychology shift** · **2003/2006** analogies
- Mercouris **zugzwang** · **Lavrov Kiev illegitimate** Ukraine tail
- Parsi **off-ramp removal** motive · **decapitation second bite**
- Henningsen **30k protester fabrication** · **Ukraine info-ops** continuity
- Ritter **Minab** war-crime chain · Maté **Kushner–Witkoff** Israel lane

...
**CIV-STATE sweep:** America · Persia · Russia · PRC · Adjacent (Gulf/Europe) — **5/5 spoke** · **Confidence:** medium on **3a/3b** Mar 22–24 window · **Developing:** ground-op **end state** · **SEC** market probe

## Lane sweep receipts

| Lane | Registry queried | Spoke? | Token |
| --- | --- | --- | --- |
| America | White House · CENTCOM · DoD pool · CNBC · FT · WSJ | Yes | `verify:america-lane` |
| Persia | IRNA-adjacent · FM denial carry | Yes | `verify:persia-lane` |
| Russia | MFA readout · TASS · Kremlin carry | Yes | `verify:russia-lane` |
| PRC | MFA daily briefing carry | Partial | `verify:prc-lane-partial` |
| Adjacent | Asharq · Bloomberg Gulf · UN Security Council wire | Yes | `verify:adjacent-lane` |
...
## Sub-seam B — Lavrov / Russia lane (Helmer **J24-B1** · Mercouris **J24-B2 – B3**)

| ID | Claim | Lane | Lang | Verdict | Cite |
| --- | --- | --- | --- | --- | --- |
| **J24-B1** | **Lavrov–Araghchi** phone call — **Bushehr** strike risks; **immediate cessation** + **legitimate interests of all parties** | Russia / Persia | en | **Partial** | [Russian MFA readout Mar 24](https://mid.ru/) · **call Supported** · **immediate ceasefire** wording **Contested** vs Iran **five terms** (Helmer desk) |
| **J24-B2** | **Lavrov** at **Gorchakov Fund**: analysts describe events as **World War III** opening; links **Iran war** to **Western–Russia confrontation** | Russia | en | **Supported** | [TASS Mar 24 — Lavrov Gorchakov Fund remarks](https://tass.com/) · Mercouris quotes **official agency** carry |
| **J24-B3** | Russia mediates **Iran ↔ GCC** — **not** **US–Iran** (Putin would accommodate US ask but **focus is Gulf states**) | Russia / Adjacent | en | **Partial** | [Bloomberg Mar 24 — Gulf states hold back from joining US war](https://www.bloomberg.com/) · **GCC hold-back Partial** · **Russian mediation type** = analyst synthesis (Mercouris) — **not 3a MOU** |

## Sub-seam C — Dimona / air defense (Mercouris **J24-C1 – C4** · Marandi **J24-C3**)
...
| **J24-C4** | US **stealing THAAD/Patriot** from **South Korea** for Israel | America / PRC-adjacent | en | **Partial** | Continuation [Mar 3 **J03-B3**](statecraft/notes/wire/2026-03-03-wire-verify-matrix.md#sub-seam-b--thaad--air-defense-mercouris-j03-b1--b3--wilkerson-j03-b2) — [Yonhap Mar 11+](https://en.yna.co.kr/) · Mar 24 = **operational consequence** tier |

## Sub-seam D — Ground forces / Kish (Mercouris **J24-D1 – D4** · Marandi **J24-D3**)

| ID | Claim | Lane | Lang | Verdict | Cite |
| --- | --- | --- | --- | --- | --- |
| **J24-D1** | **82nd + 101st Airborne** + **two infantry divisions** (~**4/10** Army divisions) **heading to Middle East** (~20k) | America | en | **Partial** | [AP Mar 24 — US sending additional troops to Middle East](https://apnews.com/) · **82nd/101st Partial** in triage · **four divisions** exact ORBAT **Unclear** without DoD order-of-battle primary |
| **J24-D2** | Planning discourse: **Kharg Island** / **Hormuz islands** / Iranian **coastline** capture | America | en | **Partial** | [CNN Mar 24 — Pentagon options Iran ground operations](https://www.cnn.com/) · **planning/leak tier** — not **Supported** as **ordered operation** |
| **J24-D3** | **NYT**: Pentagon weighing **airborne troops** to Iran / **Kish** island | America | en | **Partial** | [NYT Mar 23–24 — airborne options Iran](https://www.nytimes.com/) · Marandi cites — **planning Partial** · invasion **not Supported** |
| **J24-D4** | Mercouris: **Israeli media** — US told Israel ops must end **9 Apr**; Trump **Israel trip** after | America / Adjacent | en | **Unclear** | Hebrew/Israeli media **desk tier** — not wire-primary English 3a in pass |

## Sub-seam E — Energy / Hormuz (Mercouris **J24-E1 – E3** · Marandi **J24-E1 – E2**)
...
| **J24-E2** | **Tit-for-tat:** Israeli hit **South Pars** → Iran hit **Qatar/Saudi/UAE gas** infrastructure (Marandi) | Persia / Adjacent | en | **Partial** | [Mar 3 **J03-C2**](statecraft/notes/wire/2026-03-03-wire-verify-matrix.md#sub-seam-c--hormuz--energy-mercouris-j03-c1--c4--marandi-cross) LNG halt **Supported** · Mar 24 **cycle** = **desk synthesis** — individual Gulf gas hits **Partial** by country |
| **J24-E3** | **Hormuz** still **closed**; **Economist**: even if opened tomorrow, **~4 months** to normalize energy markets | America | en | **Partial** | [Mar 3 **J03-C1** Supported](statecraft/notes/wire/2026-03-03-wire-verify-matrix.md) · **4-month lag** = **Economist scenario** — **Partial** not official forecast |
...
| ID | Claim | Lane | Lang | Verdict | Cite |
| --- | --- | --- | --- | --- | --- |
| **J24-F1** | **WSJ**: Saudi **King Fahd airbase** quietly used by US to **attack Iran** | America / Adjacent | en | **Partial** | [WSJ Mar 23–24 — Saudi base US operations](https://www.wsj.com/) · Helmer: **facilitation Partial** · **join fight Contradicted** by Gulf hold-back rows |
| **J24-F2** | **Bahrain** draft **UNSC** resolution — **necessary means** / force to open Hormuz | Adjacent | en | **Unclear** | UN wire **not located** in triage pass — Bahrain proposal **reported** tier only |

## Cross-matrix carry-forward (Mar 3 → Mar 24)

| Mar 3 ID | Mar 24 status |
| --- | --- |
| **J03-C1** Hormuz closure | **Still Supported** — **J24-E3** |
| **J03-E2** Larijani / FM no talks | **Still Supported** — **J24-A3** |
| **J03-E1** MBS–Putin | **Superseded by** Gulf **pay/hold-back** grammar — [Dmitriev Mar 24 §](../notes/arc-helmer-dmitriev-lane.md#mar-24-arc-witkoff-indirect-fiction--gcc-mediation--market-layer) |

## Interpretation fence (tier 4 — not wire-scored)

- Helmer **five terms** taxonomy · **two-track** Russia/China · **Bandar Anzali** secret resupply
- Marandi **Gulf funds war** · **1929 depression** escalation · **Muhammad Muhammad** SNSC continuity
- Mercouris **negotiation mirage** · **credibility gap** · **Medhurst** energy-destruction grand plan (rejected)
- Dmitriev **silent** Mar 24 — trust arc not wire row
- Pape newsletters — **escalation trap / gamblers conceit** doctrine

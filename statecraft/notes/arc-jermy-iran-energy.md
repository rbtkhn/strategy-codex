...
primary_voice: jermy
topic: iran-energy
span_start: 2026-02-27
span_end: 2026-04-28
```

**Pub dates:** 2026-02-27 → 2026-04-28 (~60 days)  
**Parent:** [Jermy source index](../voices/jermy/jermy-source-index.md) · [Davis host index](../channels/daniel-davis/index.md)
...
**One voice, three beats.** Jermy on Davis is the repo's **macro-energetics + maritime feasibility** spine for the Iran war:

- **Feb 27** → **Pre-kinetic endurance** — Ford/Lincoln deployment, Iran **not buckling**, strike clock still **hypothetical**
- **Mar 18** → **Mechanism** — oil/gas/GDP, SPR lid, Hormuz/Kharg engineering, ally refusal, depression tail
- **Apr 28** → **Materialization** — shut-in receipt, SPR fade, diesel/food/helium, Bessent/Harris politics

Read **Feb 27** for **pre-war carrier/endurance frame**. Read **Mar 18** for **why Hormuz closure is structurally unfixable**. Read **Apr 28** for **downstream tsunami**. Read **this arc** for **three-beat energy escalation inside one Jermy register**.

## Escalation ladder (shared spine)

| Dimension | Feb 27 (pre-kinetic) | Mar 18 (mechanics) | Apr 28 (materialization) | Trajectory |
| --- | --- | --- | --- | --- |
| War phase | **Armada** / strike **clock** | **~$100** oil; **~20%** supply at risk | **Brent ~$110**; **11–13M bpd** shut-in | Hypothesis → **measured** shock |
| Carriers | **Ford/Lincoln** endurance debate | Hormuz **suicidal**; allies **refused** | (implicit stand-off) | Pre-war → **operational trap** |
| SPR / lid | (thin) | **~400M bbl** = **20–40 day** cap | **~2M bpd** release **running low** | Lid **temporary** → **fading** |
| Hormuz | Closure **risk** named | **Slim in 3 months**; transit **suicidal** | **Dual blockade**; **Harris** double-down | Engineering pessimism **stable** |
| Kharg / islands | (thin) | **Seize-and-hold fantasy** debunked | System-wide shock — island fantasy **drops** | Early debunk **holds** |
| GDP / recession | (thin) | **4-in-5** recession if strait closed | **10%+** depression; **tsunami** metaphor | Tail risk → **base case** |
| Europe | (thin) | **Acutely vulnerable**; gas grid | Diesel **triage**; bunker **2–3×** | Gas grid → **rationing** idiom |
| Off-ramp | Strike may **walk down** | Leadership change / mediation | **No silver bullet** production | Pessimism **deepens** |

## Phase beats

### Phase 1 — Feb 27: not buckling (pre-kinetic)

- **Carrier endurance** — Ford/Lincoln deployment; **50/50** strike vs walkdown frame
- **Iran resilience** — regime **not buckling** before kinetic opening
- **Forward link** → Mar **month clock** and Mar-18 **Hormuz economics**

### Phase 2 — Mar 18: teach the machine

- **Five-region resilience** — Russia best → US → China → **Europe worst**
- **SPR arithmetic** — **~400M bbl** artificial cap
- **Kharg operational debunk** — Gallipoli/Falklands analogies
- **Great Depression 2** — **15–20%** GDP if **20%** oil/gas out

### Phase 3 — Apr 28: count the bodies

- **Shut-in receipt** — **11–13M bpd**; SPR lid **fading**
- **Diesel triage** — trucks, agriculture, **globalization reversal**
- **Helium / chips / Taiwan** — second-order supply chains
- **Karbala / Bessent / Harris** — passion + institutional double-down
...
- **Oil <$90** sustained through May despite closed Hormuz → Apr/Mar stack wrong
- **Hormuz reopens <30 days** with **11M+ bpd** restored → Mar **3-month slim** wrong

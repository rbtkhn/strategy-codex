...
Open **§1 Tier A health** in the registry for route-integrity counts (orphans, weak anchors, essay queue, broken note links). Taxonomy law and shelf-native clusters: [`README.md`](./README.md).

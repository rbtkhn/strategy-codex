...
**Read order:** registry → this README (clusters) → raw note files.

| Step | Surface |
| --- | --- |
| 1 | [`INDEX.md`](./INDEX.md) (this stub) |
| 2 | [`runtime/artifacts/statecraft-notes-registry.md`](../../runtime/artifacts/statecraft-notes-registry.md) — Tier A health dashboard, full registry table, essay/attention queues |
| 3 | This README — taxonomy law and shelf-native clusters |

Regenerate: `python3 scripts/reindex_notes.py` (writes `.md` + `.json`; freshness: `python3 scripts/reindex_notes.py --check`).
...
python3 scripts/reindex_notes.py                     # generated registry (+ JSON)
```

See [Generated registry / discovery](#generated-registry--discovery) above for the operator dashboard path.

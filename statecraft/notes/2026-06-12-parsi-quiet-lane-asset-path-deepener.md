...
**Parent:** [2026-06-12 daily](statecraft/synthesis/day/2026-06-12.md) · [wire-verify matrix](statecraft/notes/wire/2026-06-12-wire-verify-matrix.md) · [Nawfal × Parsi source](../../source-archive/statecraft/2026-06-12/source-nawfal-parsi-breaking-iran-deal-leaked-2026-06-12.md)
...
|--------|------------|------------|
| Coordinated pushback (Iran + Pakistan + US) | Media exaggeration scuttling deal | **Partial** — Vance tweet + Trump retweet FM ([J12-5](statecraft/notes/wire/2026-06-12-wire-verify-matrix.md)) |
...
| **Reuters UAE package** | $10–20B; **$3B+ delivered** | UAE unlocks frozen/IR-linked funds; halt UAE attacks | UAE MFA **categorically denies** any transfer | **Contested** ([J12-4](statecraft/notes/wire/2026-06-12-wire-verify-matrix.md)) |
...
```mermaid
flowchart TD
  A[Asset sticking point] --> B{US direct unfreeze?}
  B -->|Vance no upfront| C[Qatar/UAE side channel]
  B -->|Iran preference| D[Trump signature sincerity]
  C --> E{UAE MFA confirms?}
  E -->|No| F[Contested — planning only]
  E -->|Yes| G[Partial good-faith]
  D --> H[Denied by WH performance frame]
  C --> I[Qatari 6B workaround — partial softening]
```
...
**Coupling risk:** If UAE path is **contested** and Lebanon **fractured** ([J12-6](statecraft/notes/wire/2026-06-12-wire-verify-matrix.md)), quiet lane buys **time** not **gate green**.

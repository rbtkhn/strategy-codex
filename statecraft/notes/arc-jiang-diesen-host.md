...
- [arc-krainer-diesen-host.md](arc-krainer-diesen-host.md) = macro-financial and commodity-system breakdown
- [arc-matlock-diesen-host.md](arc-matlock-diesen-host.md) = Cold War settlement memory and diplomatic architecture
- [arc-beebe-diesen-host.md](arc-beebe-diesen-host.md) = bargaining geometry and retrenchment-order design
- [arc-karaganov-diesen-host.md](arc-karaganov-diesen-host.md) = Russian elite deterrence doctrine and Greater Eurasia identity language
...
- [arc-krainer-diesen-host.md)](arc-krainer-diesen-host.md), which is stronger on debt, commodities, and market-system mechanism than on civilizational speculation
- [arc-matlock-diesen-host.md](arc-matlock-diesen-host.md), which is stronger on diplomatic-memory evidence than on horizon-expanding theory
- [arc-beebe-diesen-host.md](arc-beebe-diesen-host.md), which is stronger on settlement architecture and escalation management than on speculative empire-decline narrative
- [arc-karaganov-diesen-host.md](arc-karaganov-diesen-host.md), which carries Russian elite doctrinal vocabulary rather than Jiang's more free-ranging game-theoretic register

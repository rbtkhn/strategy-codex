...
`arc-pape-continuity` = a **cross-context person arc with an authored/interview crossing and a forecast-pressure core**.
...
- Do not treat `arc-pape-continuity` as a substitute for the helix.

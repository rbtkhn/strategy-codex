...
topic: crooke
legacy_path: arc-crooke-continuity.md
---
...
`arc-crooke-continuity` = a **cross-context person arc with an authored/interview crossing and a triple-helix interview core**.
...
- Do not treat `arc-crooke-continuity` as a substitute for the helix; the helix still owns host-transformation comparison.

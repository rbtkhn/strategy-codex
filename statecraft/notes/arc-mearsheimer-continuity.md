...
topic: mearsheimer
legacy_path: arc-mearsheimer-continuity.md
---
...
`arc-mearsheimer-continuity` = a **cross-host person arc with a stable double-helix core and reinforcing outer orbit**.

...
topic: diesen-karaganov
legacy_path: arc-karaganov-diesen-host.md
...
archive_links:
  ...
  - source-archive/statecraft/2025-05-14/source-glenn-diesen-sergey-karaganov-russias-eurasian-future-spiritual-revival-2025-05-14.md
...
- [arc-jiang-diesen-host.md](arc-jiang-diesen-host.md) = speculative empire-maintenance and game-theoretic world-order framing
- [arc-matlock-diesen-host.md](arc-matlock-diesen-host.md) = diplomatic memory of negotiated settlement and anti-expansion warning lineage
- [arc-beebe-diesen-host.md](arc-beebe-diesen-host.md) = retrenchment and settlement geometry from a U.S. intelligence-statecraft angle
- [arc-krainer-diesen-host.md](arc-krainer-diesen-host.md) = macro-financial and commodity-system consequences
...
|---|---|---|---|
| −1 | 2023-01-14 | *Russia, from Greater Europe to Greater Eurasia* (× Mercouris) | Earliest archive anchor for the civilizational pivot: Founding Act 1997, EU constitution/Christianity break, comprador elite, Peter the Great period ending, BRICS/SCO/Global South, Iran corridor, China-Russia sovereign balance — pre-doctrine full arc. |
| 0 | 2024-01-28 | *Lowering the Nuclear Threshold? / Age of War* (× Mercouris) | Origin fuse-reinstall debate: Putin Sochi/Valdai pushback; red-line erosion (Blinken targeting fence, Belgorod, F-16 arc); strategic parasitism; age-of-wars tectonics; 10–20y institutional gap. **Wire receipt on capture.** Mercouris cross-host → [arc-mercouris-diesen-host.md](arc-mercouris-diesen-host.md). |
| 1 | 2024-10-21 | *Russia Changes Nuclear Doctrine* (× Mercouris) | Doctrine-change triad: Putin shift after Valdai; Mercouris Cold War deterrence catalogue; 10–12 step ladder; Belarus umbrella; deep-strike / Ramstein threshold. **Wire receipt on capture.** Mercouris cross-host → [arc-mercouris-diesen-host.md](arc-mercouris-diesen-host.md). |
| 2 | 2025-05-14 | *Sergey Karaganov: Russia's Eurasian Future & Spiritual Revival* | Best civilizational and Siberization base text; strongest for Greater Eurasia, spiritual framing, and the post-European identity lane. |
| 3 | 2025-12-25 | *Sergey Karaganov: Confronting Europe, Pivot to East & Nuclear War* | Best hard-security and Europe-escalation solo; strongest on direct nuclear-threshold and anti-European-war argument. |
| 4 | 2026-05-10 | *Sergey Karaganov on World War, Nuclear Doctrine, Europe, and Russia's Future* | Best single mature **solo** anchor — deterrence doctrine, world-war framing, anti-Europe escalation logic, and Russia's future in one file. Open first for doctrine depth after triad ladder. |
| 5 | 2026-06-13 | *John Mearsheimer & Sergey Karaganov: Nuclear Strike on Europe to Restore Deterrence* | Best triangulation file — Karaganov escalation ladder vs Mearsheimer structural realism, Schelling coercion, US non-response, Germany proliferation. |
...
- [arc-jiang-diesen-host.md](arc-jiang-diesen-host.md), which is more free-ranging and speculative than Karaganov's elite doctrinal lane
- [arc-matlock-diesen-host.md](arc-matlock-diesen-host.md), which is grounded in U.S. diplomatic memory rather than Russian strategic doctrine
- [arc-beebe-diesen-host.md](arc-beebe-diesen-host.md), which is stronger on bargaining architecture than on deterrence-threshold argument
- [arc-krainer-diesen-host.md](arc-krainer-diesen-host.md), which is stronger on macro-order economics than on nuclear-threshold and identity language

...
Canonical guest arcs (compatibility paths) live under [statecraft/channels/dialogue-works/](../../../statecraft/channels/dialogue-works/).
...
4. Open the host-local arc in `statecraft/channels/dialogue-works/` when the job is Dialogue Works–specific transformation on that guest.

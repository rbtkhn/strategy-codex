...
Compatibility note: this file is a **legacy host-continuity compatibility surface** carried forward from the earlier strategy-thread system. The canonical Nima structure now lives in the host shelf front door at [nima/README.md](/C:/dev/strategy-codex/statecraft/channels/nima/README.md), the host routing surface at [nima/index.md](/C:/dev/strategy-codex/statecraft/channels/nima/index.md), and the distinct guest arcs under this host. Do not treat this file as a competing canonical topical-thread atlas.

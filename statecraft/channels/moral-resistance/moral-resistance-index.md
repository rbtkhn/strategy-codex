...
- use **Aguilar** when the seam is **action vs rhetoric** (NDAA/IAA · Israel constraint)
- use **Pape** when the seam is **MOU compliance vs kinetic continuation** (Art. 1 Lebanon · Art. 5 Hormuz · Art. 11 enrichment)
- use **Parsi** when the seam is **deal durability · Lebanon/Hormuz mechanisms · regional pact**
- same guest on **Nawfal** or other hosts = separate host-conditioned read — do not dedupe by guest alone

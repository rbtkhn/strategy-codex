...
- if the real question is `can the U.S. still force an outcome?`, open [davis-mearsheimer-arc.md](/C:/dev/strategy-codex/statecraft/channels/daniel-davis/stream/davis-mearsheimer-arc.md)
...
- If the question is mainly about coercive leverage and bargaining geometry rather than how Washington boxed itself in and lost sequence control, route outward to [davis-mearsheimer-arc.md](/C:/dev/strategy-codex/statecraft/channels/daniel-davis/stream/davis-mearsheimer-arc.md).

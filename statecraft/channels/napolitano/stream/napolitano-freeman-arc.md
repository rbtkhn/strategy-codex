...
- If the question is mainly about phony ceasefire tempo, Gulf-state repositioning, or immediate crisis messaging, route outward to [nima-freeman-arc.md](/C:/dev/strategy-codex/statecraft/channels/nima/stream/nima-freeman-arc.md) instead of stretching this arc into live-pressure work.

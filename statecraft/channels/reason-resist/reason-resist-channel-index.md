...
Purpose: exhaustive route map for every materialized **`reason-resist`** capture in **Statecraft Archive** (`channel_slug: reason-resist` · host **Dimitri Lascaris**). Host-led resistance journalism — advocacy framing, Iran/Gaza seams, NATO escalation reads.

**Host-only:** Lascaris is **channel law**, not a guest/voice shelf. There is **no** `lascaris-index` or `statecraft/voices/lascaris/` corpus — guest mechanism depth → **`statecraft/voices/<guest>/`**.

Channel: [Reason to Resist](https://www.youtube.com/@reason2resist)
...
- [2026-05-24 — Russia Retaliates After Ukrainian Strike On Student Dormitory w/ John Helmer](../../../source-archive/statecraft/2026-05-24/source-lascaris-helmer-russia-retaliates-student-dormitory-strike-2026-05-24.md) — see [Helmer index](../../voices/helmer/helmer-source-index.md)
- [2026-05-26 — Trump Sabotages Peace Talks / Israel Brutalizes Gaza Flotilla](../../../source-archive/statecraft/2026-05-26/source-lascaris-trump-sabotages-peace-talks-gaza-flotilla-2026-05-26.md)

## 2026-06

- [2026-06-13 — How Will Russia Restore Deterrence? w/ John Helmer](../../../source-archive/statecraft/2026-06-13/source-lascaris-helmer-how-will-russia-restore-deterrence-2026-06-13.md) — see [Helmer index](../../voices/helmer/helmer-source-index.md)
- [2026-06-18 — The War On Iran Is Far From Over w/ Patrick Henningsen](../../../source-archive/statecraft/2026-06-18/source-lascaris-henningsen-war-on-iran-far-from-over-2026-06-18.md)
- [2026-06-25 — Trump's Goal Remains the Same: Destroy Russia and Iran w/ John Helmer](../../../source-archive/statecraft/2026-06-25/source-lascaris-helmer-trump-goal-destroy-russia-iran-2026-06-25.md) — see [Helmer index](../../voices/helmer/helmer-source-index.md)
...
1. Use this index for **host-channel** routing — how Reason to Resist frames the guest and the week.
2. Guest mechanism depth lives on **`statecraft/voices/<guest>/`** when applicable.
3. Same guest on another host = separate host read — do not dedupe by guest alone.
4. Treat host segments as **advocacy + primary witness** tier — not wire-neutral.
5. Flotilla segments = **international-law / blockade** lane; Iran half = **ceasefire bad-faith** lane.
6. Verify USCENTCOM claims and Tabnak casualty rows before Chronicle promotion.

## Boundary

- Host-law and routing only — no `lascaris-arc.md`; no voice profile under `voices/lascaris/`.

...
Compatibility stub — domain-level operator-usage essay now canonical at repo-root `essays/`. Edit the repo-root essay; keep this pointer so older `statecraft/` links resolve.

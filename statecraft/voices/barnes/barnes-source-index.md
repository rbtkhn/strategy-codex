...
- `2026-01-13` through `2026-06-11` coverage
- a dominant `Daniel Davis` host share
- real `Mercouris` reinforcement
- a thickened `Nima` entry through early June
- a thin `Napolitano` / Judging Freedom entry (June 10)
...
- [2026-04-17 - verbatim sidecar - Robert Barnes on Larry Johnson Countercurrent](../../../source-archive/statecraft/2026-04-17/source-countercurrent-2026-04-17-verbatim-2026-04-17.md)
...
- The June 8–11 cluster (Nawfal, Napolitano, Nima, Davis) is same-week continuity evidence — route Davis first for mature lane, then the June 10 pair for fast-turn reinforcement.

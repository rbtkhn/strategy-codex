...
Compatibility note: this file is a **legacy continuity compatibility surface** carried forward from the earlier strategy-thread system. The canonical Barnes structure now lives in [barnes-speaker-object.md](/C:/dev/strategy-codex/statecraft/voices/barnes/barnes-speaker-object.md), [barnes-cross-host-note.md](/C:/dev/strategy-codex/statecraft/voices/barnes/barnes-cross-host-note.md), and the mature [davis-barnes-speaker-arc.md](/C:/dev/strategy-codex/statecraft/channels/daniel-davis/stream/davis-barnes-speaker-arc.md). Do not treat this file as a competing canonical topical-thread atlas.

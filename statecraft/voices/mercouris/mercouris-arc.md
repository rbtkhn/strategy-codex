...
Purpose: define the current `mercouris-arc` as a bounded helix of recurring Mercouris arc-threads. This keeps Mercouris from being reduced to either a generic speaker object or an unstructured native stream.
...
It contains multiple recurring `mercouris-arc-threads`, currently indexed in [mercouris-arc-threads.md](mercouris-arc-threads.md):
...
Mercouris does not need a thick cross-host helix to have an arc. The arc exists because the same thread lines recur across months and episodes, braid into one statecraft sequence, and keep changing their relative weight as the crisis field changes.

The strongest current motion is:

`Iran/Hormuz shock -> U.S. blockade credibility problem -> Russia/China diplomatic room -> Ukraine and Europe instrument exhaustion -> Western legitimacy crisis`
...
- [Diesen x Mercouris](../diesen/diesen-mercouris-speaker-arc.md - a deepening host-local branch (2023/2024 Karaganov triads + 2026 legitimacy dyad) that braids order-transition, deterrence-history, and legitimacy-crisis threads with Diesen's frame.
- [Davis x Mercouris](../../../statecraft/channels/daniel-davis/davis-mercouris-speaker-arc.md - a stable host-local branch that braids Davis's military-feasibility frame with Mercouris's diplomatic sequencing, European spoiler logic, and institutional-politics register.
...
- open [mercouris-arc-threads.md](mercouris-arc-threads.md)

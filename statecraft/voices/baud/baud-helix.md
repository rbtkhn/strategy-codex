...
|---|---|---|
| [davis x baud](../../notes/arc-baud-davis-host.md) | Alliance mandate and coercive feasibility | Perfidy, co-belligerency, negotiation blackmail, Gulf-base liability, and the legal-strategic incoherence of coercive threats without a credible end state |
| [alkorshid x baud](../../notes/arc-baud-nima-host.md) | Live crisis pressure | Treaty skepticism, Hormuz management, deterrence logic, European impotence, and strategic rationality under immediate event stress |
...
- open [arc-baud-nima-host.md](../../notes/arc-baud-nima-host.md)

If the operator needs the best pair:

- open [arc-baud-nima-host.md](../../notes/arc-baud-nima-host.md)
- then [arc-baud-davis-host.md](../../notes/arc-baud-davis-host.md)
...
- For Baud's recurring legal-taxonomic lane across hosts and months, route to [baud-thread-international-law.md](baud-thread-international-law.md) rather than stuffing that work into the helix.

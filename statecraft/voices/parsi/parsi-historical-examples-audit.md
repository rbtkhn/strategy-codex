...
Parsi's shelf is already strong in mechanism and policy-process continuity. The historical layer should deepen:
...
- no Parsi-specific bridge adapter is created here
- this audit does not replace the authored ledger, interview map, or thread atlas

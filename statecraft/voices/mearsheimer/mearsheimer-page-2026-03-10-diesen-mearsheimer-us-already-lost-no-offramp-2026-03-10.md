# Mearsheimer refined page — 2026-03-10 (guest lane)
<!-- word_count: ~200 -->
...
Guest, 10 Mar 2026. Mearsheimer: the war is not going well for the United States; an “off-ramp” is hard to name in narrative form because there is no 1945-style “we won, impose terms” ending; Iran can absorb punishment, fight an attrition frame, and raise the coercive ante (escalation ladder, mutual). Hegseth “heaviest bombardment” rhetoric and “eleven days” in voice, desalination and Gulf water dependency, Hormuz, Trump tweets — in raw `capture_note`; verify to wire before elevating. Iran has agency in when the war stops; the “Washington drives alone” default is the theoretical foil.
...
- Falsify desal % and strait-toll quant claims per operator note; keep as scenario until wired.

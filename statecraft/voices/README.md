...
**Agent dispatch:** For analyst/source-index routing, open [`statecraft/voices/voice-index.md`](voice-index.md) — canonical voices router front door (not other repo `INDEX.md` hubs). For repo-wide LLM routing, open [LLM-ROUTING.md](../../LLM-ROUTING.md).
...
Current migrated profiles: [Barnes](barnes/barnes-profile.md), [Mercouris](mercouris/mercouris-profile.md), [Mearsheimer](mearsheimer/mearsheimer-profile.md), [Pape](pape/pape-profile.md), [Crooke](crooke/crooke-profile.md), [Ritter](ritter/ritter-profile.md), [Parsi](parsi/parsi-profile.md), [Diesen](diesen/diesen-profile.md), [Weichert](weichert/weichert-profile.md) (seed). Host profiles: [Davis](../channels/daniel-davis/davis-profile.md), [Nima](../channels/dialogue-works/nima-profile.md). Profile-only lanes: [codex/profiles/README.md](../../codex/profiles/README.md).

...
- [mercouris-arc.md](../../../statecraft/voices/mercouris/mercouris-arc.md = native bounded arc shape
- [mercouris-arc-threads.md](../../../statecraft/voices/mercouris/mercouris-arc-threads.md = canonical recurring-strand atlas
- [davis-mercouris-speaker-arc.md](../../../statecraft/channels/daniel-davis/davis-mercouris-speaker-arc.md = force-feasibility and restraint-policy branch
...
- European legitimacy crisis and foreign-policy overextension
- elite denationalization and domestic political volatility
- Ukraine/Russia policy fixation and economic stagnation
- Europe as possible Eurasian backwater versus Europe as western Eurasian entry point

What makes this a real host-local arc is the fit between the two objects:

- Diesen frames the crisis through order transition, multipolarity, and Europe's place after unipolarity.
- Mercouris translates that frame into concrete British, German, French, and EU political legitimacy problems.
- The lane turns macro order-transition language into a diagnosis of domestic institutional brittleness.
...
No unresolved current Diesen x Mercouris candidates remain from this pass.

Older cross-host appearances found during the same check, such as 2024 Duran panels with Freeman, Hudson, Greenwald, Matlock, or Petro, are useful historical context but are not promoted into this arc until the operator asks for a cross-year Mercouris x Diesen backfill.
...
- open [mercouris-arc.md](../../../statecraft/voices/mercouris/mercouris-arc.md
- open [mercouris-arc-threads.md](../../../statecraft/voices/mercouris/mercouris-arc-threads.md
...
Use this speaker arc when a Diesen ingest or synthesis pass is doing one or more of the following:

- reading Europe through legitimacy crisis rather than only election arithmetic
- connecting Ukraine/Russia policy fixation to domestic stagnation and political anger
- comparing Britain's Churchillian foreign-policy myth with Germany's postwar Russia relationship
- testing whether Europe can still adapt to a post-American or post-Western order
- routing the same raw input into both the Diesen host shelf and the Mercouris speaker shelf
...
- the native [mercouris-arc.md](../../../statecraft/voices/mercouris/mercouris-arc.md, which carries the broader stream-native motion
- [mercouris-arc-threads.md](../../../statecraft/voices/mercouris/mercouris-arc-threads.md, which separates recurring Mercouris strands regardless of host
- [davis-mercouris-speaker-arc.md](../../../statecraft/channels/daniel-davis/davis-mercouris-speaker-arc.md, which is less about European legitimacy and more about execution, sustainability, and force reality

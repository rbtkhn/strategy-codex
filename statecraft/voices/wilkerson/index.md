...
Purpose: front door for the canonical Wilkerson statecraft shelf, surfacing the speaker-routing doctrine, the main host pair plus auxiliary branch, and the linked support surfaces that still remain in the legacy shelf during migration.
...
This index is a route map. Raw-text authority stays in `source-archive/statecraft/`; speaker identity and host-transformation logic now open from the statecraft-side shelf.

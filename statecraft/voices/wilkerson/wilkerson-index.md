...
Purpose: statecraft-side doorway to the full Wilkerson provenance bench.

The exhaustive resolved appearance map still lives here:

- [legacy Wilkerson source index](../../../statecraft/voices/wilkerson/wilkerson-source-index.md)

Use that surface when:

- complete provenance coverage matters more than compact speaker routing
- the relevant appearance is outside the main host pair
- you need the full dispersed cross-host bench rather than only the canonical transformations

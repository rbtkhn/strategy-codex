...
- new canonical local path: `statecraft/voices/jiang/ph-civ/`

This shelf owns the local opening path. Public repo identity remains `rbtkhn/ph-civ`.

## Boundary

Jiang is canonical here under `statecraft/voices/jiang/`. Use the Jiang shelf to decide which layer you mean, the embedded mirror for public corpus files, and [`source-archive/statecraft/`](../../../source-archive/statecraft) for raw source authority outside the mirror.

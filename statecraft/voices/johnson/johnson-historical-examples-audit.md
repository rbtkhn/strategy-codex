...
Johnson is now canonical as a statecraft speaker shelf, but his historical-example layer is still lighter than the five-speaker normalized set that already carried full audits into migration.

What is already clear:

- Johnson is repeatedly used for crisis-reading, coercive-failure, and widening regional consequence
- the shelf already supports dense month retrieval and recurring strand synthesis
- raw-input remains the evidence authority for claims and quotations

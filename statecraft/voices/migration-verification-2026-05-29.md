...
- Jiang mirror gitlink is live at `public/predictive-history`.
...
- `git ls-files --stage` shows the Jiang gitlink at `public/predictive-history` and `.gitmodules` points to the same path.

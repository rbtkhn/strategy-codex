...
This file is the first-pass map of host shelves that carry host-local speaker arcs. It is a navigation aid, not a replacement for the arcs themselves.

## Active Host Shelves

| Host shelf | Role | Open first |
|---|---|---|
| [`alkorshid/`](../alkorshid/) | Nima Alkhorshid voice shelf · cross-host guest · [Dialogue Works host](../../channels/dialogue-works/dialogue-works-channel-index.md) | [`alkorshid-profile.md`](../alkorshid/alkorshid-profile.md) |

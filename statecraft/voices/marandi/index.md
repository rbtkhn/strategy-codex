...
Purpose: compact front door for the canonical Marandi statecraft shelf.
...
Marandi is best read as a **cross-host person arc with a mature three-host core**.

- `Dialogue Works x Marandi` is the strongest legitimacy / red-line / live-pressure lane.
...
- the May 26, 2026 Marandi source belongs inside the mature pressure cluster, not outside the shelf.

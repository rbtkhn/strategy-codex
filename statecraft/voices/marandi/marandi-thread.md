...
Compatibility note: this file is a **legacy continuity compatibility surface** carried forward from the earlier strategy-thread system. The canonical Marandi structure now lives in [marandi-arc.md](/C:/dev/strategy-codex/statecraft/voices/marandi/marandi-arc.md), [marandi-routing.md](/C:/dev/strategy-codex/statecraft/voices/marandi/marandi-routing.md), [marandi-helix.md](/C:/dev/strategy-codex/statecraft/voices/marandi/marandi-helix.md), [marandi-2025-present-arc-threads.md](/C:/dev/strategy-codex/statecraft/voices/marandi/stream/marandi-2025-present-arc-threads.md), and the distinct host-local arcs under Davis, Diesen, and Dialogue Works. Do not treat this file as a competing canonical topical-thread atlas.

...
# Voices speaker profile template

Purpose: single **shape contract** for `statecraft/voices/<speaker>/<speaker>-profile.md` after migration. Placement law lives in [README.md § Speaker profile law](README.md#speaker-profile-law). Upstream minimal scaffold: [strategy-codex-template-profile.md](../../../codex/strategy-codex-template-profile.md).
...
A voices profile is the **identity-and-voice hub**:
...
Promotion and refresh defaults: [voices-profile-template.md](voices-profile-template.md#voice-fingerprint-compact).
...
- **Tier `B`** is the default for migrated voices profiles until a full mind pass promotes register evidence.

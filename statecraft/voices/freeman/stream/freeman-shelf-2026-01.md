# Freeman shelf - 2026-01

WORK only; not Record.

Status: continuity/setup month.

January is a bounded entry shelf, not a chronology owner. Use it to enter the Freeman object before the mature spring core thickens.

## January setup index (partial)
...
January Freeman should be read as **setup before spring Iran-war thickening**. Jan 20 Davis land is the **Greenland alliance-law** hook — pair with [Mercouris Jan shelf](../mercouris/stream/mercouris-shelf-2026-01.md) and [Helmer index](../helmer/helmer-source-index.md) for same-day three-register routing.

...
**Companion files:** [pape-transcript.md](pape-transcript.md) (7-day rolling verbatim, compatibility), [pape-thread.md](pape-thread.md) (distilled analytical thread, compatibility).

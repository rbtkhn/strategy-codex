...
Macgregor now has native 2026 monthly shelves, but they are **bounded synthesis shelves**, not chronology owners.
...
Macgregor is canonical here under `statecraft/voices/macgregor/`. Raw-text authority stays in [`source-archive/statecraft/`](../../../source-archive/statecraft). Bridge adapters still live under [`statecraft/bridges/`](../../bridges/README.md), and lanes still own substantive drafting.

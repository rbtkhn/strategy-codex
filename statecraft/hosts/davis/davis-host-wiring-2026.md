...
- Native body: [codex/speakers/davis/stream/](/C:/dev/strategy-codex/codex/speakers/davis/stream/)
- Stream README: [codex/speakers/davis/README.md](/C:/dev/strategy-codex/codex/speakers/davis/README.md)
...
| Freeman | Statecraft sobriety and diplomatic memory inside practical crisis assessment. | [arc](/C:/dev/strategy-codex/codex/speakers/davis/stream/davis-freeman-arc.md) | Open when military choices need career-diplomat restraint and historical statecraft context. |
...
| Johnson | Operational feasibility and coercive-failure intelligence countervoice. | [arc](/C:/dev/strategy-codex/codex/speakers/davis/stream/davis-johnson-speaker-arc.md) | Open when rhetoric needs to be checked against capability, intelligence, and adversary resilience. |
| Kent | Frontline and exit-logic pressure from a compact recurring lane. | [arc](/C:/dev/strategy-codex/codex/speakers/davis/stream/davis-kent-speaker-arc.md) | Open when the task needs a smaller Davis-side ground-truth or exit-logic check. |
| Macgregor | War-feasibility, imperial-overreach, and political-danger severity. | [arc](/C:/dev/strategy-codex/codex/speakers/davis/stream/davis-macgregor-speaker-arc.md) | Open for stark force-balance and overreach arguments inside Davis's practical register. |

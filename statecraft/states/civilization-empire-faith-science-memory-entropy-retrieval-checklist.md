# Civilization, Empire, Faith, Science, Memory, Entropy Retrieval Checklist
...
Use when a live object needs the **Civilizational Statecraft Framework** compressed into a retrieval pass before lane descent, Sacred Grammar, or transaction drafting.

Do not use when the object is still unverified live news — route through `state-deploy` first.

## Term → theory page

| Pass | Theory page (public SSOT) |
|------|---------------------------|
| civilization | [civilization.md](../../public/civ-state/theory/civilization.md) |
...
Compress into one structured sentence:

> This is a civilization / empire / faith / science / memory / entropy problem in which `X` governs, `Y` carries, and `Z` is most likely to distort the case if later drafting flattens it.

Answer:

1. Which governing term actually governs?  
2. Which adjacent term carries or contests it most directly?  
...
| Governing term | Return to |
|----------------|-----------|
| civilization | [civilization.md](../../public/civ-state/theory/civilization.md) → Sacred grammar · lane civilization · state-memory |

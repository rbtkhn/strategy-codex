...
- Spine law: Persian sovereignty opens imperially, survives conquest through Persianate continuity, is reconstituted confessionally through Safavid Shi'a state formation, and reaches the present through anti-humiliation and deterrent-bearing Iranian restoration rather than through one uninterrupted regime form
...
- Sovereignty chain: `Cyrus / Achaemenids -> Parthian / Sasanian Iran -> Persianate Islamic continuity -> Safavid Shi'a state -> Qajar / Pahlavi pressure-state -> Islamic Republic Iran -> Ali Khamenei`
...
- Legitimacy sequence: imperial sovereignty first, then sacred and legal Persian restoration, then Islamic absorption without civilizational disappearance, then Safavid confessional state reconstitution, then modern anti-intervention and anti-humiliation state recomposition
- Failure mode: dignity hardens into siege logic, martyrdom lock, or sovereignty without settlement openness
- Statecraft relevance: teaches how sacred grammar, plateau endurance, and wounded sovereignty become durable leverage under pressure

Read each era below through the same question set:
- what sovereignty form dominates
- what grammar legitimates it
- what rupture mutates the chain
- which linked objects best carry that phase now

## Ancient

- Sovereignty form: imperial founding and plateau-bearing Persian state continuity
- Civilizational grammar: Persian dignity, sovereignty, geography, pre-Islamic sacred depth, and restoration through imperial administration
- Rupture or mutation: conquest and imperial turnover do not erase the Persian sovereignty-bearing substrate because later Iranian empires repeatedly re-present themselves as restorers of an older Persian order rather than as wholly discontinuous powers
Best current carriers:
- [Iran state memory](../../../persia/civilization/objects/state-memory.md)
- [Iran geography](../../../persia/civilization/geo.md)
- [Iran war](../../../persia/civilization/war.md)
- [Iran peace](../../../persia/civilization/peace.md)

## Medieval

- Sovereignty form: transformed continuity under Islamic and Shi'a civilizational forms
- Civilizational grammar: Zoroastrian residue beneath Islamic / Shi'a legitimation and Persian literary-civilizational continuity
- Rupture or mutation: sacred grammar changes profoundly, but Persia survives as more than a mere conquered object because Persianate continuity carries the chain through conquest and Safavid Shi'a state formation later gives it a new sovereign engine
Best current carriers:
...
- Sovereignty form: wounded but successor-stable Persian / Iranian continuity under imperial pressure
- Civilizational grammar: anti-humiliation memory, survival, dignity, and continuity under intrusion
- Rupture or mutation: outside intervention and internal fracture intensify mistrust but do not dissolve the chain; instead they produce the modern memory that sovereignty without protection is not enough and that relief without dignity is politically unusable
Best current carriers:
- [Iran state memory](../../../persia/civilization/objects/state-memory.md)
- [Iran peace](../../../persia/civilization/peace.md)
- [Iran geography](../../../persia/civilization/geo.md)

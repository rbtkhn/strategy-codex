...
**Failure mode to avoid:** treating Russia as smooth institutional continuity, or as coercion without a regathering narrative that remains politically load-bearing.

**Read path:** [Civilization Russia](civilization-russia.md) → [Empire Russia](empire-russia.md) → optional [geo-strategy](geo-strategy-russia.md), [secret-history](secret-history-russia.md), [game-theory](game-theory-russia.md). Source shelf: [shelf reader](civ-state-russia-shelf-reader.md).

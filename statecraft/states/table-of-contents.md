...
- Deep grammar: [China sacred grammar](volumes/civ-state-china/sacred-grammar.md)
...
- Deep grammar: [Persia sacred grammar](volumes/civ-state-persia/sacred-grammar.md)
...
- Deep grammar: [Rome sacred grammar](volumes/civ-state-rome/sacred-grammar.md)
...
- Deep grammar: [Russia sacred grammar](volumes/civ-state-russia/sacred-grammar.md)
...
- Deep grammar: [America sacred grammar](volumes/civ-state-america/sacred-grammar.md)

Volume order is chronological by **sovereignty-chain emergence**, not by the earliest sacred or ethnocultural precursor.

Legacy `sovereign-continuity.md` files remain support notes inside each volume rather than canonical opening chapters.

## Internal Reading Order for Every Volume
...
Use this layer when the problem is retrieval, comparison, vocabulary, or upstream promotion rather than one civilization volume alone.

1. [Glossary](glossary.md)
2. [Volume Map](volumes/README.md)
3. [Theory shelf](../../public/civ-state/theory/README.md) — six governing terms + rhythm/time law
4. [Hybrid References](hybrid-references.md)
5. [Cross-case recurrence essay](../../public/civ-state/essays/cross-case-recurrence-and-sovereignty.md)
6. [Index](index.md)
8. [Source Retrieval Matrix](indexes/source-retrieval-matrix.md)
9. [PH-CIV to CIV-STATE Bridge](ph-civ-to-civ-state-bridge.md)
10. [PH-CIV Promotion Ledger](ph-civ-promotion-ledger.md)
11. [Review Queue](review-queue.md)
12. [CIV-STATE → Game Systems Mapping](civ-state-game-systems-mapping.md) — adjacent bridge for strategy-game substrate use; not part of the public book unless exported
13. [Game substrate](game-substrate/README.md) — machine companion layer (profiles, schemas, settlement clauses); workshop-only by default
...
6. the relevant volume `sacred-grammar.md` when legitimacy or truth-order governs — see [Sacred grammar (volume-local)](reader-guide.md#sacred-grammar-volume-local)
7. [Source Retrieval Matrix](indexes/source-retrieval-matrix.md) when the volume front door alone is too broad
...
Use [Index](index.md) when the problem is names, peoples, routes, chapter families, or retrieval recall.

...
This is the canonical Wilkerson statecraft speaker shelf.

Open here first when the question is not merely "what did Wilkerson say," but **which host lane, warning altitude, or continuity surface should carry the Wilkerson reading**.

## Shelf class

Wilkerson is a canonical `host-led mature-month exception shelf`.

That means:

- the speaker object is genuinely mature
- month support is real
- but chronology still belongs more cleanly to host arcs than to a native speaker-owned month ladder
- this `statecraft/civ-lens` shelf is now the canonical front door, while heavier cross-year and month-support surfaces still live in the legacy shelf during migration
...
Wilkerson is canonical here under `statecraft/civ-lens/wilkerson/`. Raw-text authority stays in `source-archive/statecraft/`, host-local chronology still belongs to host arcs, and heavier legacy support surfaces remain linked support until migrated.

...
This is the canonical `civ-lens-jiang` statecraft speaker shelf.
...
The embedded [`ph-civ/`](ph-civ/) directory is the **official local GitHub mirror** of the public Predictive History repo.

- same public remote identity
- same internal repo structure
- same mirror-check responsibilities
- new canonical local path: `statecraft/civ-lens/civ-lens-jiang/ph-civ/`

This shelf owns the local opening path. Public repo identity remains `rbtkhn/ph-civ`.

## Boundary

Jiang is canonical here under `statecraft/civ-lens/civ-lens-jiang/`. Use the Jiang shelf to decide which layer you mean, the embedded mirror for public corpus files, and [`source-archive/statecraft/`](/C:/dev/strategy-codex/source-archive/statecraft) for raw source authority outside the mirror.

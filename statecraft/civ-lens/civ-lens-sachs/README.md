...
This is the canonical `civ-lens-sachs` statecraft speaker shelf.
...
Sachs is canonical here under `statecraft/civ-lens/civ-lens-sachs/`. Raw-text authority stays in [`source-archive/statecraft/`](/C:/dev/strategy-codex/source-archive/statecraft), host-local chronology still lives primarily in host arcs and source captures, and this shelf is a routing and synthesis surface only.

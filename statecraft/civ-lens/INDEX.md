...
`statecraft/civ-lens/` contains analyst, speaker, and source-corpus **route maps** used by statecraft workflows.
...
After routing through a source index into [source-archive/statecraft/](../../source-archive/statecraft/), apply [docs/source-lattice-beyond-the-repo.md](../../docs/source-lattice-beyond-the-repo.md) (corpus tiers + reading layers). PH chapter objects additionally use [jiang/ph-civ/docs/source-lattice.md](jiang/ph-civ/docs/source-lattice.md).
...
Legacy [codex/speakers/](../../codex/speakers/) paths are compatibility residue during migration. Prefer civ-lens for live statecraft routing.

...
Purpose: front door for the compact Kent starter shelf inside `statecraft/civ-lens/`.
...
The current Kent starter shelf has four live surfaces:
...
Use this shelf as a truthful doorway into Kent's current statecraft utility. Do not treat it as a normalized month-ladder shelf until the corpus density justifies one.

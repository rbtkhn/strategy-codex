...
Treat this `statecraft/civ-lens/civ-lens-martyanov/` shelf as the canonical Martyanov front door. The legacy `codex/speakers/martyanov/` path is compatibility-only.

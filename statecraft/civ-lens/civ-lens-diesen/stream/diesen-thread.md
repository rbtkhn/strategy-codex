...
Compatibility note: this file is a **legacy host-continuity compatibility surface** carried forward from the earlier strategy-thread system. The canonical Diesen structure now lives in the host shelf front door at [diesen/README.md](/C:/dev/strategy-codex/statecraft/civ-lens/civ-lens-diesen/README.md), the host routing surface at [diesen/index.md](/C:/dev/strategy-codex/statecraft/civ-lens/civ-lens-diesen/index.md), and the distinct guest arcs under this host. Do not treat this file as a competing canonical topical-thread atlas.
...
- **Historical expert context (optional rebuild)** Ã¢â‚¬â€ `python3 scripts/strategy_historical_expert_context.py --expert-id diesen --start-segment YYYY-MM --end-segment YYYY-MM --apply` emits batch-analysis handoff under `artifacts/skill-work/work-strategy/historical-expert-context/`: a **range rollup** (`diesen-<start>-to-<end>.md`) plus **per-month** files (`diesen/<YYYY-MM>.md`). [`strategy_batch_analysis_with_history.py`](../../../../scripts/strategy_batch_analysis_with_history.py) loads **per-month** artifacts when every month in the requested window exists; otherwise it uses the rollup. See `historical-expert-context/README.md` in that folder.

- **`<!-- backfill:diesen:start -->` Ã¢â‚¬Â¦ `end` blocks** Ã¢â‚¬â€ reconstructed historical arc from out-of-repo URLs; not contemporaneous journal prose; keep scope/rules inside the block.
...
Finally, 2026-01 should remain safe for **operator rotation**: someone returning after weeks should be able to read this segment and recover **lane orientation** (role: Eurasia / multipolar discourse; non-Western institutional / rationality frames when distinct from MearsheimerÃ¢â‚¬â„¢s structural-realist register), **pairing map** (Ãƒâ€” mearsheimer, Ãƒâ€” macgregor, Ãƒâ€” pape, Ãƒâ€” sachs), and **next verification moves** without loading the entire quarter. That recoverability is why the minimum prose budget existsÃ¢â‚¬â€not to pad, but to force a minimum coherent account of what this month was for in the notebook.
...
- [strength: high] **Through-line:** **Marandi** on **overwhelming retaliation** to any U.S. strike Ã¢â‚¬â€ host **Diesen** Ã¢â‚¬â€ [YouTube I6XHVDtHRX4](https://www.youtube.com/watch?v=I6XHVDtHRX4) Ã¢â‚¬â€ indexes cite **~30 Jan 2026** Ã¢â‚¬â€ verify **title/date** in UI.
- [strength: medium] **Mechanism:** **Civil unrest** / **war preparation** thread Ã¢â‚¬â€ [Singju Post Ã¢â‚¬â€ Greater Eurasia + Marandi transcript](https://singjupost.com/greater-eurasia-podcast-w-seyed-m-marandi-on-irans-civil-unrest-transcript/) Ã¢â‚¬â€ **transcript-grade**; pair with **Mercouris** diplomatic tickers only via **batch-analysis** seam.
- [strength: medium] **Parallel lane:** **Macgregor** Ã¢â‚¬â€ **rising war risks** Ã¢â‚¬â€ [Singju Post transcript](https://singjupost.com/greater-eurasia-podcast-w-macgregor-on-rising-war-risks-transcript/) Ã¢â‚¬â€ third-country **distance** from U.S.Ã¢â‚¬â€œIsrael frame Ã¢â‚¬â€ **do not** merge with **Marandi** lines without labels.
- [strength: low] **Lattice:** Upstream of **April** **PH vi-14** / DiesenÃƒâ€”Sachs petrodollar vs Hormuz (page id `diesen-vi14-petrodollar-vs-sachs-hormuz`) abstract Ã¢â‚¬â€ Q1 is **voice + episode** discipline only.
## 2026-02
...
- [strength: high] **Through-line:** **UN Security Council** Ã¢â‚¬â€ **media manipulation** in the **Ukraine** war Ã¢â‚¬â€ [Brave New Europe](https://braveneweurope.com/diesen-at-the-un-security-council-media-manipulation-in-the-ukraine-war) Ã‚Â· [Podscan episode](https://www.podscan.fm/podcasts/diesen-greater-eurasia-podcast/episodes/media-manipulation-in-the-ukraine-war-diesen-at-the-un-security-council) Ã¢â‚¬â€ **~22 Feb 2026** class in third-party indexes.
- [strength: medium] **Mechanism:** **NATOÃ¢â‚¬â„¢s war of choice** Ã¢â‚¬â€ **Istanbul** sabotage thesis Ã¢â‚¬â€ [Podscan](https://www.podscan.fm/podcasts/diesen-greater-eurasia-podcast/episodes/diesen-natos-war-of-choice-the-sabotage-of-the-istanbul-negotiations) Ã¢â‚¬â€ **~24 Feb 2026** Ã¢â‚¬â€ **hypothesis-grade** until primary **negotiation** docs pinned.
- [strength: high] **Signal (Iran):** **Marandi** Ã¢â‚¬â€ **Ã¢â‚¬Å“War for SurvivalÃ¢â‚¬Â** Ã¢â‚¬â€ [Podscan](https://www.podscan.fm/podcasts/diesen-greater-eurasia-podcast/episodes/seyed-m-marandi-war-for-survival-irans-strategy-as-war-is-imminent) Ã¢â‚¬â€ **imminent-war** framing Ã¢â‚¬â€ **convergence** with **Mearsheimer** structural reads only with **dated** shared material.
## 2026-03
...
- [strength: high] **Through-line:** **IranÃ¢â‚¬â„¢s Military Strategy and U.S. Miscalculations** Ã¢â‚¬â€ [Brave New Europe](https://braveneweurope.com/seyed-m-marandi-diesen-irans-military-strategy-and-u-s-miscalculations) Ã¢â‚¬â€ companion to **YouTube** mirrors (re-verify **publish** date).
- [strength: high] **Mechanism:** **Iran Rejects Ceasefire Ã¢â‚¬â€ Demands New Status Quo** Ã¢â‚¬â€ [Brave New Europe](https://braveneweurope.com/seyed-m-marandi-diesen-iran-rejects-ceasefire-demands-new-status-quo) Ã¢â‚¬â€ **ceasefire** language vs **April** Lebanon / nuclear forks Ã¢â‚¬â€ **seam** not merge.
- [strength: medium] **Cross-thread:** **Mercouris** Ã¢â‚¬â€ **Iran war transforms Ukraine war** Ã¢â‚¬â€ [Podscan](https://www.podscan.fm/podcasts/diesen-greater-eurasia-podcast/episodes/mercouris-iran-war-transforms-ukraine-war) Ã¢â‚¬â€ **~21 Mar 2026** class Ã¢â‚¬â€ **orthogonal** to **tri-mind** passes unless operator opts in.
...
Finally, 2026-04 should remain safe for **operator rotation**: someone returning after weeks should be able to read this segment and recover **lane orientation** (role: Eurasia / multipolar discourse; non-Western institutional / rationality frames when distinct from MearsheimerÃ¢â‚¬â„¢s structural-realist register), **pairing map** (Ãƒâ€” mearsheimer, Ãƒâ€” macgregor, Ãƒâ€” pape, Ãƒâ€” sachs), and **next verification moves** without loading the entire quarter. That recoverability is why the minimum prose budget existsÃ¢â‚¬â€not to pad, but to force a minimum coherent account of what this month was for in the notebook.
...
- [strength: high] **Signal (cold):** Jiang Ãƒâ€” Glenn Diesen Ã¢â‚¬â€ Iran war as petrodollar / Treasury stress Ã¢â‚¬â€ [YouTube P_DHMUdOVdo](https://www.youtube.com/watch?v=P_DHMUdOVdo) Ã¢â‚¬â€ verify:work-jiang-vi-14 + lecture markdown per ingest line.
- [strength: medium] **Abstract fork:** `diesen-vi14-petrodollar-vs-sachs-hormuz` Ã¢â‚¬â€ Judgment-only; not merged voice with Ritter blockade mechanics.
- [strength: medium] **Lattice:** `ritter-blockade-hormuz-weave` Ã¢â‚¬â€ closure economics seam.
...
## 2026-04-27
- Inbox | cold: full text in [`transcript-diesen-crooke-iran-global-war-world-order-2026-04-27.md`](provenance/2026-04-27/transcript-diesen-crooke-iran-global-war-world-order-2026-04-27.md) (pointer; SSOT raw-input) | thread:diesen | crosses:crooke
...
- Inbox | cold: full text in [`transcript-macgregor-diesen-total-war-iran-2026-04-21.md`](provenance/2026-04-21/transcript-macgregor-diesen-total-war-iran-2026-04-21.md) (pointer; SSOT raw-input) | thread:diesen
## 2026-04-25
- YT | cold: **Glenn** **Diesen** **Ãƒâ€”** **Pepe** **Escobar** Ã¢â‚¬â€ *Connectivity Wars Ã¢â‚¬â€ The U.S. War on Multipolarity* Ã¢â‚¬â€ **aired** **2026-04-23** Ã¢â‚¬â€ **cleaned** **caption** **(inferred** **speakers):** **INSTC** **/ BRI** **/ corridor** **competition** **(IMEC** **dead,** **QatarÃ¢â‚¬â€œTurkey** **pipe** **dreams),** **Hormuz** **/ Iran** **war** **Ãƒâ€”** **northÃ¢â‚¬â€œsouth** **connectivity,** **Chabahar** **/** **Gwadar** **/ India** **/** **China;** **Mackinder** **/ sea** **vs** **land** **frame** **(commentary)** // hook: **`thread:diesen`** **(Escobar** **=** **guest,** **no** **`expert_id`)** **Ãƒâ€”** **Ã‚Â§1e** **/** **Ã‚Â§1g** **Eurasia** **connectivity** **Ã¢â‚¬â€** **full** [provenance/2026-04-23/transcript-diesen-escobar-connectivity-wars-multipolarity-2026-04-23.md](provenance/2026-04-23/transcript-diesen-escobar-connectivity-wars-multipolarity-2026-04-23.md) | TBD (pin `watch?v=`) | verify:operator-file+cleaned-caption+guest-not-in-roster+opinion-narrative-tier+not-Record | thread:diesen | EURASIA | IRAN | BRICS | grep:Diesen+Escobar+connectivity+multipolarity+2026-04-23
- YT | cold: **Glenn Diesen** (host Ã¢â‚¬â€ **same** **episode** **as** **Macgregor** **row** **above**) Ã¢â‚¬â€ **multipolar** **/** **Ã¢â‚¬Å“world** **order** **dismantledÃ¢â‚¬Â** **/** **intÃ¢â‚¬â„¢l** **law** **+** **global** **empathy** **for** **Iran;** **Asia** **economic** **shock;** **Europe** **Ãƒâ€”** **Russia** **/** **Ukraine** **/** **drone** **escalation** **questions;** **Trump** **Ã¢â‚¬Å“victoryÃ¢â‚¬Â** **/ school** **strike** **framing** **Ã¢â‚¬â€** **not** **merge** **Macgregor** **ORBAT** **without** **seams** // hook: **`thread:diesen`** **Eurasia** **host** **lane** **Ãƒâ€”** **`thread:macgregor`** **Ã¢â‚¬â€** **same** **raw** [provenance/2026-04-21/transcript-macgregor-diesen-total-war-iran-2026-04-21.md](provenance/2026-04-21/transcript-macgregor-diesen-total-war-iran-2026-04-21.md) | https://www.youtube.com/watch?v=1AZPNUaXJ-k | verify:same+raw+reingest-2026-04-25+host-not-guest+operator-transcript | thread:diesen | Eurasia | grep:Diesen+host+2026-04-21
## 2026-04-23
- Inbox | cold: full text in [`transcript-diesen-escobar-connectivity-wars-multipolarity-2026-04-23.md`](provenance/2026-04-23/transcript-diesen-escobar-connectivity-wars-multipolarity-2026-04-23.md) (pointer; SSOT raw-input) | thread:diesen
...
- [transcript-diesen-escobar-connectivity-wars-multipolarity-2026-04-23.md](provenance/2026-04-23/transcript-diesen-escobar-connectivity-wars-multipolarity-2026-04-23.md) _on-disk_
- [transcript-diesen-wilkerson-araghchi-putin-russia-iran-2026-04-28.md](provenance/2026-04-28/transcript-diesen-wilkerson-araghchi-putin-russia-iran-2026-04-28.md) _on-disk_
- [transcript-diesen-crooke-iran-global-war-world-order-2026-04-27.md](provenance/2026-04-27/transcript-diesen-crooke-iran-global-war-world-order-2026-04-27.md)
...
- [transcript-diesen-ritter-russia-threatens-strike-finland-baltic-2026-04-17.md](provenance/2026-04-17/transcript-diesen-ritter-russia-threatens-strike-finland-baltic-2026-04-17.md)

...
This support spine owns four notebook jobs:

- cross-year maturity explanation
- month-status explanation
- host-role comparison at speaker scope
- the rule for how native monthly synthesis shelves relate to host-owned chronology
...
- [macgregor-raw-input-index.md](macgregor-raw-input-index.md) = provenance bench
...
Macgregor is mature enough to deserve both a stronger speaker-owned spine and bounded native monthly synthesis shelves, but still not the same kind of chronology ownership as Ritter.
...
- but the useful chronology still belongs more naturally to host-local arcs than to speaker-native month narratives

So the right reading is:

`mature speaker object with host-led chronology and speaker-owned bounded month synthesis`

not:

`speaker shelf waiting for chronology takeover`
...
- late 2025 proves the double helix is not a 2026 accident
- the shelf gets materially thicker without changing type
...
- [transcript-macgregor-diesen-nato-ukraine-lost-2026-01-22.md](/C:/dev/strategy-codex/source-archive/statecraft/2026-01-22/transcript-macgregor-diesen-nato-ukraine-lost-2026-01-22.md)
- [transcript-napolitano-macgregor-trump-is-sleepwalking-into-another-war-2026-01-07.md](/C:/dev/strategy-codex/source-archive/statecraft/2026-01-07/transcript-napolitano-macgregor-trump-is-sleepwalking-into-another-war-2026-01-07.md)

Monthly shelf rule:

- January now deserves a bounded synthesis shelf because the speaker shelf benefits from segmented entry
- January still does not own chronology; the two captures already split cleanly across altitude and indictment functions
...
- [transcript-napolitano-macgregor-us-iran-war-could-spiral-out-of-control-2026-02-10.md](/C:/dev/strategy-codex/source-archive/statecraft/2026-02-10/transcript-napolitano-macgregor-us-iran-war-could-spiral-out-of-control-2026-02-10.md)
- [youtube-glenn-diesen-douglas-macgregor-us-iran-diplomacy-fail-full-scale-war-coming-soon-2026-02-26.md](/C:/dev/strategy-codex/source-archive/statecraft/2026-02-26/youtube-glenn-diesen-douglas-macgregor-us-iran-diplomacy-fail-full-scale-war-coming-soon-2026-02-26.md)

Monthly shelf rule:

- February still reads as precursor density for March and April
- the monthly shelf is a segmented access point, not a chronology rewrite
...
- the month is mature because all three host jobs are visible
- the monthly shelf summarizes that maturity without pretending to replace the host-local arcs
...
- [transcript-macgregor-diesen-total-war-iran-2026-04-21.md](/C:/dev/strategy-codex/source-archive/statecraft/2026-04-21/transcript-macgregor-diesen-total-war-iran-2026-04-21.md)
- [transcript-napolitano-macgregor-pentagon-terrible-war-planning-2026-04-23.md](/C:/dev/strategy-codex/source-archive/statecraft/2026-04-23/transcript-napolitano-macgregor-pentagon-terrible-war-planning-2026-04-23.md)
- [youtube-davis-macgregor-trump-dangerous-2026-04-29.md](/C:/dev/strategy-codex/source-archive/statecraft/2026-04-29/youtube-davis-macgregor-trump-dangerous-2026-04-29.md)

Why April matters:

- it is the clearest full-spectrum month for Macgregor
- the altitude lane, the auxiliary indictment lane, and the practical danger lane all appear in one short span

Why the monthly shelf is bounded:

- April density is mixed with shorthand day files and one unresolved-canon Napolitano episode
- the best reading is still `host arc + raw-input`, with the monthly shelf acting as the speaker-side synthesis/index

### 2026-05

Status: support-only month
...
Macgregor does not own chronology in the same way because:

- the strongest retrieval jobs are already host-differentiated
- monthly synthesis shelves would become duplication if they tried to retell host chronology in full
- the shelf's missing maturity was not chronology ownership, but speaker-owned explanation of how mature months relate to the host arcs

## Boundary

- do not turn this file into a duplicate chronology ledger
- do not let it compete with the helix
- do not read the existence of native monthly shelves as proof that host chronology has moved here
- use this file to understand Macgregor's maturity; use monthly shelves for bounded synthesis; use host arcs and raw-input to do the actual reading

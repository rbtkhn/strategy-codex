...
|---|---|---|---|
| Pape | forecast engine | [pape-helix.md](pape/pape-helix.md) | clocks, thresholds, falsifiers, shortage chains, and coercive system leverage |
| Ritter | force-constraint engine | [ritter-helix.md](ritter/ritter-helix.md) | operational warning, military feasibility, escalation danger, and force-control limits |
| Parsi | diplomacy engine | [parsi-helix.md](parsi/parsi-helix.md) | bargaining, off-ramps, implementation, sanctions relief, guarantees, and regional architecture |
| Crooke | structural-misreading engine | [crooke-helix.md](crooke/crooke-helix.md) | elite misreading, ideological trap, order rupture, and metapolitical mechanism |

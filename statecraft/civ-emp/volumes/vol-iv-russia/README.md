...
Russia is a live lane-backed CIV-EMP volume. Use it when the problem is strategic depth, recognition, sovereignty under encirclement pressure, imperial inheritance, or disruption without overbind.
...
The inheritance from Kievan Rus is contested in modern historiography, but CIV-EMP is tracking the Russian sovereignty claim and survival narrative: how continuity is asserted, condensed, and carried forward after fracture, not how every dispute is finally resolved.

...
Purpose: front door for the canonical Johnson statecraft shelf, surfacing the speaker-routing doctrine, the main host arcs, the bounded monthly ladder, and the dense-core strand atlas.

## Open First

- [Speaker arc](johnson-arc.md)
- [Speaker routing note](johnson-routing.md)
- [Raw-input index](johnson-raw-input-index.md)
...
- [April-May dense-core atlas](stream/johnson-april-may-2026-arc-threads.md)
...
- [Raw-input index](johnson-raw-input-index.md) for provenance and appearance coverage
...
- [April-May dense-core atlas](stream/johnson-april-may-2026-arc-threads.md) for recurring strand retrieval inside the mature core
...
This index is a route map. Raw-text authority stays in `raw-input`; speaker identity and host-transformation logic stay in the Johnson statecraft shelf and host-local arc files.

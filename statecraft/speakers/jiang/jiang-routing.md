...
The Jiang shelf is the canonical statecraft-side front door, but the embedded `ph-civ/` repo remains the authoritative local mirror object. Use the shelf for speaker law and routing; use the mirror for corpus-local files.

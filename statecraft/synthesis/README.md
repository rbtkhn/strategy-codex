...
Canonical path for **archive-grounded synthesis** (day / month cadence). Adjacent operational artifacts live under [`notes/`](../notes/README.md) subfolders.

## Promotion ladder

`source-archive/statecraft/` → `statecraft/synthesis/day/` → `statecraft/notes/` → `statecraft/*/transactions/`
...
Legacy redirect: [daily stub](../daily/README.md).

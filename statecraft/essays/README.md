...
Open [shared prose index](../../docs/prose-index.md) first when the class decision is still open. This README assumes the answer is already essay-class and only explains the local statecraft version of that shelf.
...
- [from-accumulation-to-governed-interpretive-machine.md](../../essays/from-accumulation-to-governed-interpretive-machine.md) - teachable explanation of what the repo is becoming (**canonical**; compatibility stub under `statecraft/essays/`)
- [interpretive-machine.md](../../essays/interpretive-machine.md) - cross-channel thesis on interpretive learning (**canonical**; cluster at [essays/interpretive-machine/](../../essays/interpretive-machine/README.md))
...
- [leo-barnes-jiang-on-ai.md](../../essays/leo-barnes-jiang-on-ai.md) - tri-voice AI essay; [pope-leo-on-ai.md](../../essays/pope-leo-on-ai.md) redirect stub
...
- [from-accumulation-to-governed-interpretive-machine.md](../../essays/from-accumulation-to-governed-interpretive-machine.md) - canonical at repo root; local stub only
- [leo-barnes-jiang-on-ai.md](../../essays/leo-barnes-jiang-on-ai.md) - canonical tri-voice essay; [pope-leo-on-ai.md](../../essays/pope-leo-on-ai.md) redirect stub
...
- Return to [shared prose index](../../docs/prose-index.md) when the real question is prose class rather than shelf location.
- Return to [citation and evidence pattern](../../docs/citation-evidence-pattern.md) for the preferred literature-backed prose idiom.

...
| landed | youtube / operator-pasted transcript | Alexander Mercouris / Alexander Mercouris | Oreshnik strikes / Zaporozhzhye offensive / Europe-Ukraine funding | `source-alexander-mercouris-russia-plans-more-oreshnik-strikes-speeds-up-zaporozhzhye-offensive-europe-ukraine-funds-run-short-2026-05-25.md` | Canonical `thread: mercouris` raw-input capture from user-pasted transcript. |
...
| landed | youtube / cleaned transcript | Dialogue Works / Nima Alkhorshid | Larry Johnson on Hormuz / U.S.-Iran throw down | `source-dialogue-works-johnson-us-iran-throw-down-over-the-strait-of-hormuz-ticking-time-bomb-2026-05-25.md` | Nima host-stream object routed to `thread: nima`. |
| landed | youtube / cleaned transcript | Dialogue Works / Nima Alkhorshid | Col. Jacques Baud on Trump's last card / Israel | `source-dialogue-works-baud-trumps-last-card-just-shattered-israel-2026-05-25.md` | Nima host-stream object routed to `thread: nima`. |

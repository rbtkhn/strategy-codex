...
| landed | youtube / cleaned transcript | Dialogue Works / Nima Alkorshid | Col. Jacques Baud on Trump's last card / Israel | `source-dialogue-works-baud-trumps-last-card-just-shattered-israel-2026-05-25.md` | Nima host-stream object routed to `thread: nima`. |

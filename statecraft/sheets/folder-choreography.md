...
## Cross-Lane Choreography

Run the same crisis object through all four lanes without flattening them:

| lane | first question |
| --- | --- |
| America | How do we bound coercive centers without proving their veto power? |
| Russia | How do we exploit disruption without becoming trapped by another actor's escalation calendar? |
| China | How do we preserve leverage without energy or supply-chain disorder? |
| Iran | How do we convert vulnerability into legitimate system leverage without losing control? |

The goal is one settlement spine that can survive four different readings, not one consensus paragraph.

...
13. [Codex speaker residue triage](codex-speaker-residue-triage-2026-05.md) - Classify remaining `continuity/speakers/` folders without `index.md` into promote-soon, compatibility-pointer, or archive residue buckets so migration stops proceeding by symmetry.

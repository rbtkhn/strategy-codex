...
13. [Codex speaker residue triage](codex-speaker-residue-triage-2026-05.md) - Classify remaining `codex/speakers/` folders without `index.md` into promote-soon, compatibility-pointer, or archive residue buckets so migration stops proceeding by symmetry.
14. [Crisis test casebook](crisis-test-casebook.md) - Preserve what each crisis test taught about contested objects, game types, filters, and settlement spines.
...
21. [Civilization, empire, faith, science, memory, desire](../civ-state/civilization-empire-faith-science-memory-desire.md) - Run the six-part governing-layer doctrine before drafting when inheritance, instrument, legitimacy, procedure, continuity, or appetite are competing for control of the read.
...
28. [CIV-STATE source retrieval matrix](../civ-state/indexes/source-retrieval-matrix.md) - Use CIV-STATE source, lane, lens, and counterweight retrieval before major state-memory, god, lit, art, geo, war, peace, or empire-instrument backfills.
29. [Civilization lens backfill audit](civilization-lens-backfill-audit.md) - Score existing `art`, `lit`, `geo`, `war`, and `peace` surfaces for source-backed CIV-STATE strength before upgrading them.
...
Open [civilization, empire, faith, science, memory, desire](../civ-state/civilization-empire-faith-science-memory-desire.md) when a crisis, transaction, clause, or live-event read needs a higher-order governing-layer diagnosis before the draft is trusted.

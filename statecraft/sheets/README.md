...
21. [Civilization, empire, faith, science, memory, desire](../states/civilization-empire-faith-science-memory-desire.md) - Run the six-part governing-layer doctrine before drafting when inheritance, instrument, legitimacy, procedure, continuity, or appetite are competing for control of the read.
...
28. [CIV-STATE source retrieval matrix](../states/indexes/source-retrieval-matrix.md) - Use CIV-STATE source, lane, lens, and counterweight retrieval before major state-memory, god, lit, art, geo, war, peace, or empire-instrument backfills.
...
Open [civilization, empire, faith, science, memory, desire](../states/civilization-empire-faith-science-memory-desire.md) when a crisis, transaction, clause, or live-event read needs a higher-order governing-layer diagnosis before the draft is trusted.

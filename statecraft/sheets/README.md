...
12. [Host backbone - Napolitano and Davis orthogonality](host-backbone-napolitano-davis-orthogonality-2026-05.md) - Preserve the two clearest recurring host transformations: legal/process pressure versus feasibility/settlement pressure, and stop guest lanes from collapsing together across those hosts.
13. [Crisis test casebook](crisis-test-casebook.md) - Preserve what each crisis test taught about contested objects, game types, filters, and settlement spines.
14. [Transaction router](transaction-router.md) - Match a verified live-event or crisis-object read to the 12-object transaction plateau before drafting or proposing a new object.
15. [Verified live-event to instrument](verified-live-event-to-instrument.md) - Teach the shortest honest route from a named recent event to crisis object, lane ownership, output form, and instrument wedge, and use the False Elegance Ladder when the read sounds coherent too early.
16. [Great-power energy absorber threshold](great-power-energy-absorber-threshold.md) - Decide when an energy-alignment signal becomes a new transaction candidate rather than a near fit.
17. [Pape coercive-center index](pape-coercive-center-index.md) - Track great-power ranking by crisis leverage rather than size alone.
18. [Mearsheimer structural-realist scoreboard](mearsheimer-structural-realist-scoreboard.md) - Track structural power, balancing pressure, overextension risk, institutional carrier, and restraint.
19. [Civilization, empire, faith, science, memory, desire](../civ-emp/civilization-empire-faith-science-memory-desire.md) - Run the six-part governing-layer doctrine before drafting when inheritance, instrument, legitimacy, procedure, continuity, or appetite are competing for control of the read.
20. [Present-day arc extension matrix](present-day-arc-extension-matrix.md) - Extend deep America, Russia, China, and Iran arcs into cybernetic carriers for live-event, transaction, and recursive-candidate reads.
21. [Mutation statecraft](mutation-statecraft.md) - Detect when a familiar object changes function under pressure: alliance to lattice, trade to dependency, deterrence to escalation platform, recognition to humiliation trap, or republic to emergency empire.
22. [Russia depth arc](russia-depth-arc.md) - Test frontier-depth, symbolic-depth, imperial-depth, space-depth, system-depth, and dependency-depth when a Russia read invokes exposure, recognition, encirclement, or equilibrium.
23. [China order arc](china-order-arc.md) - Test mandate-order, standardization-order, hydraulic-order, fragmentation-memory, development-order, party-state-order, and compute-order when a China read invokes order, unity, routes, implementation, or disorder.
24. [Iran dignity-sovereignty arc](iran-dignity-sovereignty-arc.md) - Test plateau-sovereignty, righteous-order, Persianate-continuity, Shi'a-resistance, resource-sovereignty, martyrdom-endurance, and sanctions-sovereignty when an Iran read invokes dignity, deterrence, relief, verification, or Hormuz.
25. [America empire-republic arc](america-empire-republic-arc.md) - Test imperial-provincial inheritance, revolutionary-republic, constitutional-union, continental-expansion, maritime-commercial order, emergency-empire, and platform-sovereignty when an America read invokes lawful reach, sanctions, alliances, technology, extraction, suppression, or successor legitimacy.
26. [CIV-EMP source retrieval matrix](../civ-emp/indexes/source-retrieval-matrix.md) - Use CIV-EMP source, lane, lens, and counterweight retrieval before major state-memory, god, lit, art, geo, war, peace, or empire-instrument backfills.
27. [Civilization lens backfill audit](civilization-lens-backfill-audit.md) - Score existing `art`, `lit`, `geo`, `war`, and `peace` surfaces for source-backed CIV-EMP strength before upgrading them.
28. [State braid model](state-braid-model.md) - Keep several linked arcs together long enough to draft one authority-bearing, restraint-bearing, settlement-bearing object.
29. [Abraham helix](abraham-helix.md) - Track the long-run recurrence generated by Judaism, Christianity, and Islam as a shared but contested civilizational field.
30. **National lanes** - Open [America](../america/), [Russia](../russia/), [China](../china/), or [Persia](../persia/) when the comparison should become a country-specific treaty, memo, negotiation brief, or crisis instrument.

## Prompt Forms

### Richelieu Test

- State the durable interest in one sentence.
- Name the institution that carries the policy.
- Name the faction, ideology, or patron pressure that can distort it.
- Name the administrative or fiscal burden.
- Name the legitimacy risk.

### Bismarck Test

- State what is enough.
- State what must not be demanded.
- Name the actor to isolate.
- Name the actor to reassure or keep neutral.
- Name the exit, review, or restraint clause.

### Combined Equilibrium Test

- If the draft succeeds, what balance exists six months later?
- Which institution keeps that balance from becoming mere rhetoric?
- Which party can comply without humiliation?
- Which party can defect, and how would that be seen?
- What clause prevents advantage from becoming overreach?
...
Open [Abraham helix](abraham-helix.md) when a present crisis is being shaped by the long-run recurrent field created by Judaism, Christianity, and Islam rather than by force, territory, and bargaining alone.

### Speaker Insight To Policy Memo

Open [Speaker insight to policy memo](speaker-insight-to-policy-memo.md) when a raw-input capture or speaker arc contains one useful statecraft insight, but the output needs to remain a policy artifact rather than a speaker summary.
...
Open [present-day arc extension matrix](present-day-arc-extension-matrix.md) when a live read needs to name the cybernetic carrier of an older civilization arc before routing to a transaction object, a recursive candidate, or a six-part doctrine read.

### Mutation Statecraft

Open [mutation statecraft](mutation-statecraft.md) when a familiar object keeps its name but changes function under pressure: alliance becomes containment lattice, trade becomes dependency, deterrence becomes escalation platform, infrastructure becomes sovereignty claim, recognition becomes humiliation trap, or republic becomes emergency empire.
...
Open [China order arc](china-order-arc.md) when a China-lane read invokes mandate, order, unity, development continuity, maritime ambiguity, party-state implementation, compute sovereignty, or the rule: preserve order without visible tutelage; preserve face without hiding material constraint; convert capacity into quiet implementation before capacity becomes coercive spectacle.

### Iran Dignity-Sovereignty Arc

Open [Iran dignity-sovereignty arc](iran-dignity-sovereignty-arc.md) when an Iran-lane read invokes dignity, sovereignty, deterrence, sanctions relief, nuclear latency, Hormuz, non-regime-change, verification, martyrdom, or the rule: preserve dignity without trapping sovereignty in permanent resistance; convert endurance into bargaining power before endurance becomes isolation.

### America Empire-Republic Arc

Open [America empire-republic arc](america-empire-republic-arc.md) when an America-lane read invokes empire / republic tension, constitutional authority, executive emergency power, sanctions-finance reach, resource extraction, ideological suppression, alliance burden, maritime order, platform power, technology-industrial capacity, successor legitimacy, or the rule: make empire answer to republic, or republic becomes empire's mask; convert power into consent before power becomes control; keep technology as carrier, not sovereign.
...
When one perspective needs to become a draft, use the matching national lane rather than expanding the comparison sheet: [America](../america/), [Russia](../russia/), [China](../china/), or [Persia](../persia/).
...
Open [verified live-event to instrument](verified-live-event-to-instrument.md) when a named recent event needs the shortest honest teaching path from unstable facts to crisis object, lane ownership, output form, and instrument wedge.
It also carries the **False Elegance Ladder** for stress-testing lane ownership, transaction threshold, framework diagnosis, speaker translation, and clause-level overcoherence.
...
Each sheet should produce one compact WORK artifact: a treaty clause, memo paragraph, negotiation instruction, sanctions mechanism, review clause, off-ramp, or warning against overreach.

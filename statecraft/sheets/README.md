...
17. [Hexagon arc-lens stress test](hexagon-arc-lens-stress-test.md) - Run `god`, `lit`, `art`, `geo`, `war`, and `peace` as a six-lens diagnostic before drafting or patching an instrument.
18. [Present-day arc extension matrix](present-day-arc-extension-matrix.md) - Extend deep America, Russia, China, and Iran arcs into cybernetic carriers for `hex`, current-event, transaction, and recursive-candidate reads.
...
28. **National lanes** - Open [America](../america/), [Russia](../russia/), [China](../china/), or [Iran](../iran/) when the comparison should become a country-specific treaty, memo, negotiation brief, or crisis instrument.

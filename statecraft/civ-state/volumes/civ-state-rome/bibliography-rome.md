...
This is the working volume bibliography for the Rome CIV-STATE book. Its center of gravity is primary sources first, then bounded secondary and doctrinal support.

Use it to retrieve Rome as a transformed continuity case:
...
Greek inheritance and upstream civilizational formation:
...
- Vatican I and Vatican II texts where Roman universality persists under narrowed territorial conditions
- Papal social encyclicals where Roman residue continues as institutional and moral world-order speech
- Italian state-formation materials where Roman territorial memory survives in a modern national shell
- Concordat, diplomatic, and church-state texts where residue carriage becomes explicit under modern sovereignty

Industrial retrieval priority:
- narrowed but durable residue carriage
- church continuity after territorial exhaustion
- modern institutional survival of Roman universality

### Cybernetic

- Modern papal, ecclesial, and Roman-residue texts where the current carrier remains legible in the present world
- Present Vatican diplomatic and public-order texts where universal-sacral residue still speaks to world order
- Modern writings and speeches where Rome appears as comparative warning, strong-man memory, institutional afterlife, or successor-order reference
...
- Seed MEM plus MEM CONNECTIONS clusters for Rome law, universality, transformed carrier continuity, church residue, and successor-order memory
- `CIV-CORE-*`, `CIV-STATE-*`, and `CIV-DOCTRINE-*` overview files as bounds and counterweight checks

...
Precursor to [daily synthesis](./METHOD.md) — not a substitute. Generate with:
...
- [source-example-slug](../../source-archive/statecraft/YYYY-MM-DD/source-example-slug-YYYY-MM-DD.md) — operator promotes into `statecraft/daily/YYYY-MM-DD.md`

...
- [2026-05-29](./2026-05-29.md) for an Iran-heavy day where quote density, lane judgment, and five-volume deepening all matter
- [2026-05-30](./2026-05-30.md) for a mixed coercion, threshold, and architecture day where cross-speaker compression is already strong
- [2026-05](./2026-05.md) for month-scale object compression with explicit `Functional Convergence`

...
- [singularity workshop sheet](../singularity/workshop/sheets/interface-operating-layer-2028.md) — operating sheet (mirrored legacy promotion)
- [agent-control-plane.md](./agent-control-plane.md)
- [singularity front door](../singularity/README.md)
- Compatibility stub: [singularity/essays/interface-operating-layer-2028.md](../singularity/essays/interface-operating-layer-2028.md)

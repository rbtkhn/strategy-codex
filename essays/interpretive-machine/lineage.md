...
The nearest professional-practice ancestor is Donald Schon.

Key work:

- Donald A. Schon, *The Reflective Practitioner: How Professionals Think in Action* (1983)

Why this matters:

- Schon distinguishes `reflection-in-action` from `reflection-on-action`
...
- Return to [Interpretive Machine Corporate Applications](./corporate-applications.md) for product and workforce-development applications.
- Return to [Interpretive Machine Workflow Manifestations](./workflow-manifestations.md) for concrete manifestations inside the current workflow.

...
- receipts under `artifacts/printing-press/scrape-creators/`
...
- automatic updates to `self.md`, `self-archive.md`, `recursion-gate.md`, `session-log.md`, or `bot/prompt.py`
...
- `artifacts/printing-press/scrape-creators/*.json`

...
**Cloned from companion-self** `_template/self-library.md` (2026-02-26). Grace-mar-specific entries (reference works, videos) appended. File renamed from library.md to self-library.md for consistency with self-* taxonomy.
...
```yaml
total_entries: 151
clone_source: "companion-self _template/self-library.md (2026-02-26)"

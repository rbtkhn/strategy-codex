...
Default: packet exists **only in chat**. If the operator asks to save: e.g. `continuity/cadence/harvest-packets/YYYY-MM-DD-harvest.md` (operator-owned; not Record).

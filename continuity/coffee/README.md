# Coffee (`continuity/coffee`)

**Purpose:** Operator cadence, activation, re-entry, signing-off (**`coffee`** Step 1 + **A–D** hub), and ritual architecture for strategy-codex. Executable contract: [.cursor/skills/coffee/SKILL.md](../../.cursor/skills/coffee/SKILL.md). Live menu: [menu-reference.md](menu-reference.md).

**Standalone `conductor` is deprecated** — legacy docs only: [../_deprecated/conductor/README.md](../_deprecated/conductor/README.md). New sessions use **`coffee`** + hub letter.

**Not** Record truth. **Not** MEMORY. **Not** a merge path.

## Doorway

| Doc | Role |
|-----|------|
| [menu-reference.md](menu-reference.md) | **SSOT** — hub **A–D**, steward sub-tracks, cadence modifiers |
| [COFFEE-DREAM-PAIR.md](COFFEE-DREAM-PAIR.md) | Coffee ↔ dream pairing |
| [operator-session-review-checklist.md](operator-session-review-checklist.md) | Session-review mitigations |
| [coffee-history.md](coffee-history.md) | Territory history log |

**Cadence log:** [../cadence/cadence-events.md](../cadence/cadence-events.md) · **Dream:** [../dream/README.md](../dream/README.md) · **Menus:** [../menu-conventions.md](../menu-conventions.md)
...
- **Lane breadcrumbs:** `continuity/coffee/coffee-history.md`

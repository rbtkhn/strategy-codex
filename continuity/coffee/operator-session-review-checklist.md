...
| **Dream dry-run telemetry** | [docs/memory-self-audit.md](../../archive/memory-self-audit.md) Â§ Telemetry note + `pytest tests/test_auto_dream_memory_telemetry.py`. | `blank_lines_collapsed > 0` with `changed: False` understood as OK on fixture. |
...
- [coffee-history.md](coffee-history.md) â€” lane breadcrumbs.

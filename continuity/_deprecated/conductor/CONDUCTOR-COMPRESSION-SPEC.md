...
**Grace-mar note:** `user_id=grace-mar` conductor rows in cadence-events.md are **read-only**; compression applies to **strategy-codex** operator path only.
...
- `continuity/_deprecated/conductor/CONDUCTOR-COMPRESSION-SPEC.md` (this file)
...
- `continuity/coffee/menu-reference.md` — intake closeout compression pointer

...
- **page index** and **strategy-notebook** docs remain the source of truth for pages and intent.
...
If PyYAML is missing, the generator **warns** and skips `page-index` / `page-relations`–driven nodes and edges; baseline nodes and directory discovery still run.

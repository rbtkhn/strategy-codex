...
- *(Esoteric vs empirical tiers; serial continuity with Vietnam Redux / End Game.)*
...
- Paste essay body into `substack/essays/the-acceleration.md`, then fill claims and thesis.

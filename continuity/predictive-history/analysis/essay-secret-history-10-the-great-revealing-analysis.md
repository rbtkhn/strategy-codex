---
analysis_id: essay-secret-history-10-the-great-revealing
...
---
# Analysis — Predictive History · Volume VII — Essays: Secret History #10: The Great Revealing

- **substack_slug:** `secret-history-10-the-great-revealing`
- **canonical_url:** https://predictivehistory.substack.com/p/secret-history-10-the-great-revealing
- **publication_date:** 2025-10-17
- **essay (curated text):** [substack/essays/secret-history-10-the-great-revealing.md](../substack/essays/secret-history-10-the-great-revealing.md)
- **crosswalk:** [substack/README.md](../substack/README.md) (twentieth-from-last in file order; **last** is **Vision, Mission, Goals**)
...
- Essay body ingested in `substack/essays/secret-history-10-the-great-revealing.md` — fill claims and thesis when ready.
- Confirm canonical Substack `/p/…` slug if post title differs on-site.

...
- **Source of truth:** All lecture series, interviews, essays, registries, and tooling remain under **`continuity/predictive-history/`** in this repository regardless of which volume is **released** next.
...
- Instance pointer: [continuity/predictive-history/README-operator.md](../README-operator.md)

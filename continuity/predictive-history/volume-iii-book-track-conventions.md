...
Operator WORK — Predictive History. Canonical prose spec: [`continuity/predictive-history/book/VOLUME-III-SECRET-HISTORY.md`](./book/VOLUME-III-SECRET-HISTORY.md).

...
Then: short orientation for the Jiang book lane â€” continuity/predictive-history/README-operator.md; lectures continuity/predictive-history/lectures/geo-strategy*.md; analysis continuity/predictive-history/analysis/; prediction-tracking/registry/predictions.jsonl; divergence-tracking/registry/divergences.jsonl; WORKFLOW-transcripts.md.
...
## Optional: run yourself first

```bash
cd /Users/robertkuhne/Documents/grace-mar && python3 scripts/harness_warmup.py -u grace-mar --compact && python3 scripts/operator_daily_warmup.py -u grace-mar
```

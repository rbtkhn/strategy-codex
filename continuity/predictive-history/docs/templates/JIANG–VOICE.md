...
Governed by:
• Operator policy for `continuity/predictive-history/`
...
3. Bump **JIANG–VOICE** minor version; log in `continuity/predictive-history/work-jiang-history.md` or successor log.

────────────────────────────────────────────────────────────
VII. CROSS-REFERENCE
────────────────────────────────────────────────────────────
• Bridge (Grace-Mar repo): `continuity/predictive-history/jiang-voice.md`

...
> **Append-only** log for the **work-jiang** territory (`continuity/predictive-history/`, extractors, lane CI). **Not** Record truth; **not** companion [memory](../../memory.md). **Rotatable.**
...
- **JIANGâ€“VOICE (v0.1):** Teaching emulation contract for Predictive History â€” `continuity/predictive-history/docs/templates/JIANGâ€“VOICE.md`, bridge `jiang-voice.md`, Cursor rule `.cursor/rules/jiang-voice.mdc`. Human-curated; transcript audits to expand Â§ IV markers.

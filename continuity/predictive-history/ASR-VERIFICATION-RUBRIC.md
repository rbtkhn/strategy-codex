...
- **Location:** `continuity/predictive-history/verbatim-transcripts/<same-basename-as-lecture>.md` (bodies **gitignored** except [verbatim-transcripts/README.md](verbatim-transcripts/README.md)).
...
```yaml
video_id: "<11-char id>"
source_lecture: continuity/predictive-history/lectures/<slug>.md
...
- **Location:** `continuity/predictive-history/lectures/<series>-NN-<kebab-slug>.md`
...
5. **Normalize curated transcripts** (one file at a time):
   ...
   ```bash
   for f in continuity/predictive-history/lectures/geo-strategy-*.md; do

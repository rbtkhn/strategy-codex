...
**Lane:** operator research â€” [work-jiang](./README-operator.md) / `continuity/predictive-history/`. **Not** Record until merged through **RECURSION-GATE**.
...
python3 scripts/jiang-compress.py -u grace-mar --input continuity/predictive-history/STATUS.md
...
| Output | Location |
|--------|----------|
| Compression JSON | `continuity/predictive-history/compressions/<slug>-YYYYMMDD.json` |
| Schema | `continuity/predictive-history/schemas/jiang-compression-v1.schema.json` |
| Daily intention note (optional) | `reflection-proposals/DAILY-INTENTION-YYYY-MM-DD.md` (append) |

**Sprint bundles (future):** `continuity/predictive-history/sprints/` â€” see README there.

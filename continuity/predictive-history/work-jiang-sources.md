...
**Authorized sources** for the **Predictive History** / Jiang book lane: primary public surfaces where lectures and updates ship. **Not** Voice knowledge until merged through the gate; curated corpus lives under [continuity/predictive-history/README.md](./README.md).

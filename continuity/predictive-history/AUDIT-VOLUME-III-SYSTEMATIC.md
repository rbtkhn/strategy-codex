...
- [`AUDIT-VOLUME-II-SYSTEMATIC.md`](AUDIT-VOLUME-II-SYSTEMATIC.md) — template audit; [`continuity/predictive-history/volume-ii-book-track-conventions.md`](./volume-ii-book-track-conventions.md) — pilot checklist to generalize.  

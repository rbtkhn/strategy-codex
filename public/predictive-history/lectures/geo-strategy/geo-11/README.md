...
This chapter folder is a public study doorway for `geo-11`.
...
- YouTube: https://www.youtube.com/watch?v=Go1bMQKnJBQ

## Files

- [Transcript](geo-11-transcript.md)
- [Commentary canvas](geo-11-commentary.md)
- [Orientation payload](geo-11-orientation.yaml)

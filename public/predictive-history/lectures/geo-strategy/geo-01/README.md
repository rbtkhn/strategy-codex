...
This chapter folder is a public study doorway for `geo-01`.
...
- YouTube: https://www.youtube.com/watch?v=xEEpOxqdU5E

## Files

- [Transcript](geo-01-transcript.md)
- [Commentary canvas](geo-01-commentary.md)
- [Orientation payload](geo-01-orientation.yaml)

...
source_chapter_path: lectures/geo-strategy/geo-14/geo-14-transcript.md
source_corpus_path: corpus/geo-strategy/geo-14.md
...
Geo-Strategy #14: WWIII Begins, Let's Game Theory sits in the first strategic application layer of Predictive History, where geography and institutions turn historical patterns into live geopolitical constraint. The working thesis is that the lecture should be read as applied historical pressure: a way to see which inherited forms become active in crisis.

## Neutral Lecture Summary

Analysis memo: N4cs-8mrP_s-geo-strategy-14-analysis.

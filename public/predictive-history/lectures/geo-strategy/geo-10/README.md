...
This chapter folder is a public study doorway for `geo-10`.
...
- YouTube: https://www.youtube.com/watch?v=B_al2wgk49Y

## Files

- [Transcript](geo-10-transcript.md)
- [Commentary canvas](geo-10-commentary.md)
- [Orientation payload](geo-10-orientation.yaml)

...
This chapter folder is a public study doorway for `geo-13`.
...
- YouTube: https://www.youtube.com/watch?v=8XdL-7tAqnU

## Files

- [Transcript](geo-13-transcript.md)
- [Commentary canvas](geo-13-commentary.md)
- [Orientation payload](geo-13-orientation.yaml)

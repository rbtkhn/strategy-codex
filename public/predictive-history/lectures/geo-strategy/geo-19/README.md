...
This chapter folder is a public study doorway for `geo-19`.
...
- YouTube: https://www.youtube.com/watch?v=YQ-xg1nIbMs

## Files

- [Transcript](geo-19-transcript.md)
- [Commentary canvas](geo-19-commentary.md)
- [Orientation payload](geo-19-orientation.yaml)

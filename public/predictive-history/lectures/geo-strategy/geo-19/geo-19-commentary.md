---
source_id: geo-19
title: "Geo-Strategy #19: When Eschatologies Converge"
source_series: "Geo-Strategy"
publication_date: 2025-08-01
source_chapter_path: lectures/geo-strategy/geo-19/geo-19-transcript.md
source_corpus_path: corpus/geo-strategy/geo-19.md
...
Geo-Strategy #19: When Eschatologies Converge sits in the first strategic application layer of Predictive History, where geography and institutions turn historical patterns into live geopolitical constraint. The working thesis is that the lecture should be read as applied historical pressure: a way to see which inherited forms become active in crisis.

## Neutral Lecture Summary

This lecture is in review and should be read through its source transcript before publication-grade claims are made.

## Actors, Systems, And Stakes

- **Primary actors:** states, leaders, institutions, publics, and strategic coalitions
- **System pressure:** geography, institutions, resources, and strategic constraint

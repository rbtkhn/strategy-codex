...
This chapter folder is a public study doorway for `geo-12`.
...
- YouTube: https://www.youtube.com/watch?v=s_k6esWheqA

## Files

- [Transcript](geo-12-transcript.md)
- [Commentary canvas](geo-12-commentary.md)
- [Orientation payload](geo-12-orientation.yaml)

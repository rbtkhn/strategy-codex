...
This chapter folder is a public study doorway for `geo-15`.
...
- YouTube: https://www.youtube.com/watch?v=bc9adtiIN_k

## Files

- [Transcript](geo-15-transcript.md)
- [Commentary canvas](geo-15-commentary.md)
- [Orientation payload](geo-15-orientation.yaml)

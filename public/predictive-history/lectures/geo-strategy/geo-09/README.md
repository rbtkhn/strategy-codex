...
This chapter folder is a public study doorway for `geo-09`.
...
- YouTube: https://www.youtube.com/watch?v=AEPSUC-UQ5k

## Files

- [Transcript](geo-09-transcript.md)
- [Commentary canvas](geo-09-commentary.md)
- [Orientation payload](geo-09-orientation.yaml)

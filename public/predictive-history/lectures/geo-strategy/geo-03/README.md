...
This chapter folder is a public study doorway for `geo-03`.
...
- YouTube: https://www.youtube.com/watch?v=_blj8zKdKgA

## Files

- [Transcript](geo-03-transcript.md)
- [Commentary canvas](geo-03-commentary.md)
- [Orientation payload](geo-03-orientation.yaml)

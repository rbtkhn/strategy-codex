...
This chapter folder is a public study doorway for `geo-07`.
...
- YouTube: https://www.youtube.com/watch?v=LsRGvKxfLts

## Files

- [Transcript](geo-07-transcript.md)
- [Commentary canvas](geo-07-commentary.md)
- [Orientation payload](geo-07-orientation.yaml)

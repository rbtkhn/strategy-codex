...
This chapter folder is a public study doorway for `geo-20`.
...
- YouTube: https://www.youtube.com/watch?v=E83dpuyvpiM

## Files

- [Transcript](geo-20-transcript.md)
- [Commentary canvas](geo-20-commentary.md)
- [Orientation payload](geo-20-orientation.yaml)
- [Public card](../../../data/cards/geo-20.md)

## Review Status

`source_reviewed`. Do not treat provisional transcript text, named claims, quotations, or current-event predictions as final until review is complete.

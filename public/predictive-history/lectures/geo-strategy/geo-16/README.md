...
This chapter folder is a public study doorway for `geo-16`.
...
- YouTube: https://www.youtube.com/watch?v=Kw-TiN6dEcM

## Files

- [Transcript](geo-16-transcript.md)
- [Commentary canvas](geo-16-commentary.md)
- [Orientation payload](geo-16-orientation.yaml)

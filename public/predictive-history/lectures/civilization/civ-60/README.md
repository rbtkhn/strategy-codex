...
This chapter folder is a public study doorway for `civ-60`.
...
6. Widened interpretation — [Part X § civ-59](../../../docs/routes/volume-i-parts/part-10-rise-of-the-nation-state-commentary.md#civ-59) ingress; [civilization-to-apocalypse](../../docs/routes/civilization-to-apocalypse.md) Volume II egress; [plato-to-hegel](../../../data/corridors/plato-to-hegel.md) + [homer-to-tolstoy](../../../data/corridors/homer-to-tolstoy.md) course close.
...
`in_review`. Part X **close** @ American empire decline + Volume I exit. Pin-cite **cleared** (2026-06-10) — 6 transcript `#anchor` rails.
...
This folder represents public lecture material and companion study apparatus. It is not an endorsement layer and not a substitute for source review. Finance, central-bank, and live geopolitical claims require heavy counter-readings — see Part X bibliography.

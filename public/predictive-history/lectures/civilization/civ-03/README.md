...
This chapter folder is a public study doorway for `civ-03`.
...
- [gb-04 packet](../../great-books/gb-04/README.md)
- [civ-04 forward](../civ-04/README.md)
- [Public card](../../../data/cards/civ-03.md)

## Review Status

`in_review`. Religious imagination arc live. Pin-cite **cleared** (2026-06-10) — 6 transcript `#anchor` rails.

...
source_chapter_path: lectures/secret-history/sh-26/sh-26-transcript.md
source_corpus_path: corpus/secret-history/sh-26.md
...
Secret History #26: Faith of Evil belongs to Secret History inside Apocalypse, where hidden memory, ideology, imagination, and deep narrative inheritance shape strategic action. The working thesis is that the lecture should be read as applied historical pressure: a way to see which inherited forms become active in crisis.

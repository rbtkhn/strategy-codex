...
This chapter folder is a public study doorway for `sh-01`.
...
- YouTube: https://www.youtube.com/watch?v=lt8XLz78ZvY

## Files

- [Transcript](sh-01-transcript.md)
- [Commentary canvas](sh-01-commentary.md)
- [Orientation payload](sh-01-orientation.yaml)

...
source_chapter_path: lectures/secret-history/sh-06/sh-06-transcript.md
source_corpus_path: corpus/secret-history/sh-06.md
...
Secret History #6: The Psychology of Evil (Graphic and Disturbing, Viewer Discretion Advised) belongs to Secret History inside Apocalypse, where hidden memory, ideology, imagination, and deep narrative inheritance shape strategic action. The working thesis is that the lecture should be read as applied historical pressure: a way to see which inherited forms become active in crisis.

...
source_chapter_path: lectures/secret-history/sh-11/sh-11-transcript.md
...
Secret History #11: Dawn of the Human Imagination belongs to Secret History inside Apocalypse, where hidden memory, ideology, imagination, and deep narrative inheritance shape strategic action. It also supports the Civilization literary and imagination spine, so it should be read as a bridge between discovery and application. The working thesis is that the lecture should be read as applied historical pressure: a way to see which inherited forms become active in crisis.

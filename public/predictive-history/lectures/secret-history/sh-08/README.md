...
This chapter folder is a public study doorway for `sh-08`.
...
- YouTube: https://www.youtube.com/watch?v=hk_yhi3-prw

## Files

- [Transcript](sh-08-transcript.md)
- [Commentary canvas](sh-08-commentary.md)
- [Orientation payload](sh-08-orientation.yaml)

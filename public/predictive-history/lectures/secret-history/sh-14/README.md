...
This chapter folder is a public study doorway for `sh-14`.
...
- YouTube: https://www.youtube.com/watch?v=JpTI2gFYWrU

## Files

- [Transcript](sh-14-transcript.md)
- [Commentary canvas](sh-14-commentary.md)
- [Orientation payload](sh-14-orientation.yaml)

...
This chapter folder is a public study doorway for `sh-15`.
...
- YouTube: https://www.youtube.com/watch?v=rkt0HQOogHE

## Files

- [Transcript](sh-15-transcript.md)
- [Commentary canvas](sh-15-commentary.md)
- [Orientation payload](sh-15-orientation.yaml)

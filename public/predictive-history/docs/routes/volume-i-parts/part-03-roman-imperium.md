...
**Why this order:** Rome (`civ-14`–`17`) appears **before** the ancient-worlds floor in interwoven order — imperial machinery and Virgil before Egypt, Mesopotamia, and parallel grammars in Part IV.

## Law-discovery question

How does imperial machinery acquire a literary soul?

## Chapter anchors

| Chapter | Lecture |
|---------|---------|
| `civ-14` | Hannibal Barca, Lucius Brutus, and the Triumph of Rome |
| `civ-15` | The Myth-Making Genius of Julius Caesar |
| `civ-16` | Julius Caesar's Will and Octavian's Birth of Empire |
| `civ-17` | Homer, Virgil, and the War for the Soul of Rome |

## Companion weave

- `gb-08` @ `civ-17` (interwoven) — [gb-08](../great-books-evidence/gb-08/README.md)
...
- **Next:** [Part IV — The Ancient Foundations](part-04-ancient-foundations.md)

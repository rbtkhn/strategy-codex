...
source_chapter_path: essays/essay-2025-09-20-predictive-history-reading-list.md
source_corpus_path: corpus/essays/essay-2025-09-20-predictive-history-reading-list.md
...
`essay-2025-09-20-predictive-history-reading-list` is a public essay packet on the ph-civ essays surface. The working thesis is that the essay should be read as an interpretive argument within the Predictive History civilizational frame, not as settled proof or operational guidance.

---
source_id: essay-2026-02-21-countdown-to-iran
title: Countdown to Iran
source_series: "Predictive History Essays"
source_chapter_path: essays/essay-2026-02-21-countdown-to-iran.md
source_corpus_path: corpus/essays/essay-2026-02-21-countdown-to-iran.md
...
`essay-2026-02-21-countdown-to-iran` is a public essay packet on the ph-civ essays surface. The working thesis is that the essay should be read as an interpretive argument within the Predictive History civilizational frame, not as settled proof or operational guidance.

...
source_chapter_path: essays/essay-2025-09-22-what-can-be-done.md
source_corpus_path: corpus/essays/essay-2025-09-22-what-can-be-done.md
...
`essay-2025-09-22-what-can-be-done` is a public essay packet on the ph-civ essays surface. The working thesis is that the essay should be read as an interpretive argument within the Predictive History civilizational frame, not as settled proof or operational guidance.

...
source_chapter_path: essays/essay-2026-01-03-blowback-venezuela.md
source_corpus_path: corpus/essays/essay-2026-01-03-blowback-venezuela.md
...
`essay-2026-01-03-blowback-venezuela` is a public essay packet on the ph-civ essays surface. The working thesis is that the essay should be read as an interpretive argument within the Predictive History civilizational frame, not as settled proof or operational guidance.

...
source_chapter_path: essays/essay-2025-08-06-vision-mission-goals.md
source_corpus_path: corpus/essays/essay-2025-08-06-vision-mission-goals.md
...
`essay-2025-08-06-vision-mission-goals` is a public essay packet on the ph-civ essays surface. The working thesis is that the essay should be read as an interpretive argument within the Predictive History civilizational frame, not as settled proof or operational guidance.

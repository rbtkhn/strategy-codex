...
source_chapter_path: book/volume-iii/gt-20/gt-20-transcript.md
source_corpus_path: corpus/game-theory/gt-20.md
...
Game Theory #20: Mid-Term Examination belongs to the Game Theory spine of Apocalypse, where actors, incentives, signaling, and escalation make the laws of history operational. The working thesis is that the lecture should be read as applied historical pressure: a way to see which inherited forms become active in crisis.
...
- **Primary actors:** states, leaders, institutions, publics, and strategic coalitions
- **System pressure:** actors, incentives, signaling, escalation, and miscalculation

...
source_chapter_path: book/volume-iii/gt-19/gt-19-transcript.md
source_corpus_path: corpus/game-theory/gt-19.md
...
Game Theory #19: The Hollywood-Pentagon Complex belongs to the Game Theory spine of Apocalypse, where actors, incentives, signaling, and escalation make the laws of history operational. The working thesis is that the lecture should be read as applied historical pressure: a way to see which inherited forms become active in crisis.

## Neutral Lecture Summary

Frames a possible point of no return in the US–Iran war: threats to civil infrastructure, reciprocal GCC strikes, fertilizer and famine risk, and energy-price channels.

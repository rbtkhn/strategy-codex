...
This chapter folder is a public study doorway for `sh-02`.
...
- YouTube: https://www.youtube.com/watch?v=K-_l9jBGo74

## Files

- [Transcript](sh-02-transcript.md)
- [Commentary canvas](sh-02-commentary.md)
- [Orientation payload](sh-02-orientation.yaml)

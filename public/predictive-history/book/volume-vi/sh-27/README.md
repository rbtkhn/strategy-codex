...
This chapter folder is a public study doorway for `sh-27`.
...
- YouTube: https://www.youtube.com/watch?v=ZPrecJHUOUs

## Files

- [Transcript](sh-27-transcript.md)
- [Commentary canvas](sh-27-commentary.md)
- [Orientation payload](sh-27-orientation.yaml)

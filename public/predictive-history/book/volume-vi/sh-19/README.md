...
This chapter folder is a public study doorway for `sh-19`.
...
- YouTube: https://www.youtube.com/watch?v=3t0MeVBD24I

## Files

- [Transcript](sh-19-transcript.md)
- [Commentary canvas](sh-19-commentary.md)
- [Orientation payload](sh-19-orientation.yaml)

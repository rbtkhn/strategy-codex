...
This chapter folder is a public study doorway for `sh-06`.
...
- YouTube: https://www.youtube.com/watch?v=6PdfD44DkqA

## Files

- [Transcript](sh-06-transcript.md)
- [Commentary canvas](sh-06-commentary.md)
- [Orientation payload](sh-06-orientation.yaml)

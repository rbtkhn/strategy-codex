...
This chapter folder is a public study doorway for `sh-25`.
...
- YouTube: https://www.youtube.com/watch?v=B5FtHagng8c

## Files

- [Transcript](sh-25-transcript.md)
- [Commentary canvas](sh-25-commentary.md)
- [Orientation payload](sh-25-orientation.yaml)

...
This chapter folder is a public study doorway for gt-18. This folder is provisional: transcript fidelity and claims review are still visible work.
...
- YouTube: https://www.youtube.com/watch?v=xrmERlHUqBk

## Canonical Source Capture

- [Public source capture](../../../sources/predictive-history/game-theory/gt-18.md)

## Files

- [Transcript](gt-18-transcript.md)
- [Commentary canvas](gt-18-commentary.md)
- [Orientation payload](gt-18-orientation.yaml)

...
This chapter folder is a public study doorway for `gt-04`. This folder is provisional: transcript fidelity and claims review are still visible work.
...
- [Transcript](gt-04-transcript.md)
- [Commentary canvas](gt-04-commentary.md)
- [Orientation payload](gt-04-orientation.yaml)

...
This chapter folder is a public study doorway for `gt-06`. This folder is provisional: transcript fidelity and claims review are still visible work.
...
- YouTube: https://www.youtube.com/watch?v=CbamEcNuDXo

## Canonical Source Capture

- [Public source capture](../../../sources/predictive-history/game-theory/gt-06.md)

## Files

- [Transcript](gt-06-transcript.md)
- [Commentary canvas](gt-06-commentary.md)
- [Orientation payload](gt-06-orientation.yaml)
- [Public card](../../../data/cards/gt-06.md)

## Review Status

`provisional`. Do not treat provisional transcript text, named claims, quotations, or theory-heavy generalizations as final until review is complete.

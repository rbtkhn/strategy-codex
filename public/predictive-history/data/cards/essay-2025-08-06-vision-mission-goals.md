...
`essay-2025-08-06-vision-mission-goals` sits in the public essays namespace (`part: civilization`, legacy two-volume metadata). It preserves the Substack essay as a public study packet with bounded commentary.
...
Return through `essays/essay-2025-08-06-vision-mission-goals.md` for exact essay wording and `commentaries/essay-2025-08-06-vision-mission-goals-commentary.md` for bounded analysis.

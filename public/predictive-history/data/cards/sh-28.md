...
Secret History #28: Pax Judaica belongs to Secret History inside World War, where hidden memory, ideology, imagination, and deep narrative inheritance shape strategic action.
...
Return through lectures/secret-history/sh-28/sh-28-transcript.md for exact lecture wording, lectures/secret-history/sh-28/sh-28-commentary.md for bounded analysis, and corpus/secret-history/sh-28.md for source metadata.

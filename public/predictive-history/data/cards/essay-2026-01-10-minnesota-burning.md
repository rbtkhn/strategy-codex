...
`essay-2026-01-10-minnesota-burning` sits in the public essays namespace (`part: civilization`, legacy two-volume metadata). It preserves the Substack essay as a public study packet with bounded commentary.
...
Return through `essays/essay-2026-01-10-minnesota-burning.md` for exact essay wording and `commentaries/essay-2026-01-10-minnesota-burning-commentary.md` for bounded analysis.

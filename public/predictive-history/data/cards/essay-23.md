...
`essay-23` sits on the ph-civ essays surface (`part: civilization`). It preserves the Substack essay as a public study packet with bounded commentary.
...
Return through `essays/essay-23/essay-23.md` for exact essay wording and `essays/essay-23/essay-23-commentary.md` for bounded analysis.

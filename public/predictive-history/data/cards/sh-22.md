...
Return through book/volume-vi/sh-22/sh-22-transcript.md for exact lecture wording, book/volume-vi/sh-22/sh-22-commentary.md for bounded analysis, and corpus/secret-history/sh-22.md for source metadata.

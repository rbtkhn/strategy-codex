...
Return through book/volume-vi/sh-19/sh-19-transcript.md for exact lecture wording, book/volume-vi/sh-19/sh-19-commentary.md for bounded analysis, and corpus/secret-history/sh-19.md for source metadata.

...
`essay-2026-05-30-peter-thiels-republic` sits in the public essays namespace (`part: civilization`, legacy two-volume metadata). It preserves the Substack essay as a public study packet with bounded commentary.
...
Return through `essays/essay-2026-05-30-peter-thiels-republic.md` for exact essay wording and `commentaries/essay-2026-05-30-peter-thiels-republic-commentary.md` for bounded analysis.

...
Return through book/volume-vi/sh-09/sh-09-transcript.md for exact lecture wording, book/volume-vi/sh-09/sh-09-commentary.md for bounded analysis, and corpus/secret-history/sh-09.md for source metadata.

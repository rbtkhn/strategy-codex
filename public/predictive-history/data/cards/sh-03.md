...
Secret History #3: Death by Gerontocracy belongs to Secret History inside World War, where hidden memory, ideology, imagination, and deep narrative inheritance shape strategic action.
...
Return through lectures/secret-history/sh-03/sh-03-transcript.md for exact lecture wording, lectures/secret-history/sh-03/sh-03-commentary.md for bounded analysis, and corpus/secret-history/sh-03.md for source metadata.

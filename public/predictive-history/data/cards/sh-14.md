...
Secret History #14: Legacy of the Steppes belongs to Secret History inside World War, where hidden memory, ideology, imagination, and deep narrative inheritance shape strategic action.
...
Return through lectures/secret-history/sh-14/sh-14-transcript.md for exact lecture wording, lectures/secret-history/sh-14/sh-14-commentary.md for bounded analysis, and corpus/secret-history/sh-14.md for source metadata.

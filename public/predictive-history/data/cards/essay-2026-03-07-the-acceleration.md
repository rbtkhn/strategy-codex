...
`essay-2026-03-07-the-acceleration` sits in the public essays namespace (`part: civilization`, legacy two-volume metadata). It preserves the Substack essay as a public study packet with bounded commentary.

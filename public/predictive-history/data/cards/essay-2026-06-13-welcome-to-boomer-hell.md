...
`essay-2026-06-13-welcome-to-boomer-hell` sits in the public essays namespace (`part: civilization`, legacy two-volume metadata). It preserves the Substack essay as a public study packet with bounded commentary.
...
Return through `essays/essay-2026-06-13-welcome-to-boomer-hell.md` for exact essay wording and `commentaries/essay-2026-06-13-welcome-to-boomer-hell-commentary.md` for bounded analysis.

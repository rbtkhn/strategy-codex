...
Secret History #27: Empire of Evil belongs to Secret History inside World War, where hidden memory, ideology, imagination, and deep narrative inheritance shape strategic action.
...
Return through lectures/secret-history/sh-27/sh-27-transcript.md for exact lecture wording, lectures/secret-history/sh-27/sh-27-commentary.md for bounded analysis, and corpus/secret-history/sh-27.md for source metadata.

...
source_chapter_path: essays/essay-21/essay-21-transcript.md
source_corpus_path: corpus/essays/essay-21.md
...
`essay-21` is a public essay packet on the ph-civ essays surface. The working thesis is that the essay should be read as an interpretive argument within the Predictive History civilizational frame, not as settled proof or operational guidance.

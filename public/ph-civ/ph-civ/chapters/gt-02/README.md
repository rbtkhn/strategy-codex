...
This chapter folder is a public study doorway for `gt-02`. This folder is provisional: transcript fidelity and claims review are still visible work.
...
- YouTube: https://www.youtube.com/watch?v=kS-muAuq62E

## Canonical Source Capture

- [Public source capture](../../../sources/predictive-history/game-theory/gt-02.md)

## Files

- [Transcript](gt-02-transcript.md)
- [Commentary canvas](gt-02-commentary.md)
- [Orientation payload](gt-02-orientation.yaml)

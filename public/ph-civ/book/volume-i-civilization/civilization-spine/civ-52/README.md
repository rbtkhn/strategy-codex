...
This folder is the staged canonical home for `civ-52` inside the two-volume public book architecture.
...
- [Legacy source packet](../../../volume-ii/civ-52/README.md)
- [Public card](../../../../data/cards/civ-52.md)

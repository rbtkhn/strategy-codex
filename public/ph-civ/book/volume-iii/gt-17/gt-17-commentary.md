...
source_chapter_path: book/volume-iii/gt-17/gt-17-transcript.md
source_corpus_path: corpus/game-theory/gt-17.md
...
Game Theory #17: The Great Reset belongs to the Game Theory spine of Apocalypse, where actors, incentives, signaling, and escalation make the laws of history operational. The working thesis is that the lecture should be read as applied historical pressure: a way to see which inherited forms become active in crisis.

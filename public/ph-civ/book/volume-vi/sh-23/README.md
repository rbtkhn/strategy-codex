...
This chapter folder is a public study doorway for `sh-23`.
...
- YouTube: https://www.youtube.com/watch?v=6XGAc_OqCbU

## Files

- [Transcript](sh-23-transcript.md)
- [Commentary canvas](sh-23-commentary.md)
- [Orientation payload](sh-23-orientation.yaml)

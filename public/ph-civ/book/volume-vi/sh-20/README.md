...
This chapter folder is a public study doorway for `sh-20`.
...
- YouTube: https://www.youtube.com/watch?v=z0AwFin83lo

## Files

- [Transcript](sh-20-transcript.md)
- [Commentary canvas](sh-20-commentary.md)
- [Orientation payload](sh-20-orientation.yaml)

...
This chapter folder is a public study doorway for `sh-11`.
...
- YouTube: https://www.youtube.com/watch?v=LvHsg5qtDs8

## Files

- [Transcript](sh-11-transcript.md)
- [Commentary canvas](sh-11-commentary.md)
- [Orientation payload](sh-11-orientation.yaml)

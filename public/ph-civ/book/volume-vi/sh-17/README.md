...
This chapter folder is a public study doorway for `sh-17`.
...
- YouTube: https://www.youtube.com/watch?v=PlMNq44tBG0

## Files

- [Transcript](sh-17-transcript.md)
- [Commentary canvas](sh-17-commentary.md)
- [Orientation payload](sh-17-orientation.yaml)

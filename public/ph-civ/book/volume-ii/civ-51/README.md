...
This chapter folder is a public study doorway for `civ-51`.
...
`in_review`. Part IX open @ Shakespeare language-of-empire. Pin-cite **cleared** (2026-06-10) — 6 transcript `#anchor` rails.

...
This chapter folder is a public study doorway for `civ-38`.
...
4. Part apparatus — [Part VII commentary § civ-38](../../volume-i-civilization/parts/part-07-world-after-rome-commentary.md#civ-38) and [Part VII bibliography](../../volume-i-civilization/parts/part-07-world-after-rome-bibliography.md) for cross-chapter synthesis and external sources.
5. Forward bridge — after this packet, read [civ-39](../civ-39/README.md) (Mongol shatter); follows [civ-37](../civ-37/README.md) Abbasid pivot.
6. Public card — orientation payload after the chapter and Part floors are open.
7. Widened interpretation — China as comparative order test; pairs Part VI `civ-31` oceanic frame before corridor close @ `civ-41`.

## Files

- [Transcript](civ-38-transcript.md)
- [Commentary canvas (thin)](civ-38-commentary.md)
- [Part VII commentary § civ-38](../../volume-i-civilization/parts/part-07-world-after-rome-commentary.md#civ-38)
- [Part VII bibliography](../../volume-i-civilization/parts/part-07-world-after-rome-bibliography.md)
- [Forward — civ-39](../civ-39/README.md)
- [Public card](../../../data/cards/civ-38.md)

## Review Status

`in_review`. China twilight @ Part VII world-order pause. Pin-cite **cleared** (2026-06-09) — 6 transcript `#anchor` rails.

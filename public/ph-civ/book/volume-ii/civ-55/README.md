...
This chapter folder is a public study doorway for `civ-55`.
...
4. Part apparatus — [Part X commentary § civ-55](../../volume-i-civilization/parts/part-10-rise-of-the-nation-state-commentary.md#civ-55) and [Part X bibliography](../../volume-i-civilization/parts/part-10-rise-of-the-nation-state-bibliography.md) for cross-chapter synthesis and external sources.
5. Public card — orientation payload after the chapter and Part floors are open.
6. Widened interpretation — [Part X § civ-54](../../volume-i-civilization/parts/part-10-rise-of-the-nation-state-commentary.md#civ-54) ingress; [plato-to-hegel](../../../data/corridors/plato-to-hegel.md) step 4; forward [civ-56](../civ-56/README.md).

## Files

- [Transcript](civ-55-transcript.md)
- [Commentary canvas (thin)](civ-55-commentary.md)
- [Part X commentary § civ-55](../../volume-i-civilization/parts/part-10-rise-of-the-nation-state-commentary.md#civ-55)
- [Part X bibliography](../../volume-i-civilization/parts/part-10-rise-of-the-nation-state-bibliography.md)
- [Public card](../../../data/cards/civ-55.md)

## Review Status

`in_review`. Part X Kant/Hegel @ plato-to-hegel step 4. Pin-cite **cleared** (2026-06-10) — 6 transcript `#anchor` rails.

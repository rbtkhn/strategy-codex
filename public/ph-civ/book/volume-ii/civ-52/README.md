...
This chapter folder is a public study doorway for `civ-52`.
...
4. Part apparatus — [Part IX commentary § civ-52](../../volume-i-civilization/parts/part-09-age-of-conscience-commentary.md#civ-52) and [Part IX bibliography](../../volume-i-civilization/parts/part-09-age-of-conscience-bibliography.md) for cross-chapter synthesis and external sources.
5. Public card — orientation payload after the chapter and Part floors are open.
6. Widened interpretation — Part IX middle chapter; follows [civ-51](../civ-51/README.md); forward [civ-53](../civ-53/README.md) Dostoevsky close.

## Files

- [Transcript](civ-52-transcript.md)
- [Commentary canvas (thin)](civ-52-commentary.md)
- [Part IX commentary § civ-52](../../volume-i-civilization/parts/part-09-age-of-conscience-commentary.md#civ-52)
...
`in_review`. Part IX @ empire of democracy. Pin-cite **cleared** (2026-06-10) — 6 transcript `#anchor` rails.

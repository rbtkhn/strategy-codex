...
This chapter folder is a public study doorway for `gt-14`. This folder is provisional: transcript fidelity and claims review are still visible work.
...
- [Public source capture](../../../sources/predictive-history/game-theory/gt-14.md)

## Files

- [Transcript](gt-14-transcript.md)
- [Commentary canvas](gt-14-commentary.md)
- [Orientation payload](gt-14-orientation.yaml)

...
This chapter folder is a public study doorway for `gt-10`. This folder is provisional: transcript fidelity and claims review are still visible work.
...
- YouTube: https://www.youtube.com/watch?v=t5oisJiorsU

## Canonical Source Capture

- [Public source capture](../../../sources/predictive-history/game-theory/gt-10.md)

## Files

- [Transcript](gt-10-transcript.md)
- [Commentary canvas](gt-10-commentary.md)
- [Orientation payload](gt-10-orientation.yaml)

...
source_chapter_path: essays/sub-02/sub-02-transcript.md
source_corpus_path: corpus/essays/sub-02.md
...
`sub-02` is a public essay packet on the ph-civ essays surface. The working thesis is that the essay should be read as an interpretive argument within the Predictive History civilizational frame, not as settled proof or operational guidance.

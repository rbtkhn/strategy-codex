...
This chapter folder is a public study doorway for `sub-24`.
...
- [Transcript](sub-24-transcript.md)
- [Commentary canvas](sub-24-commentary.md)
- [Public card](../../data/cards/sub-24.md)

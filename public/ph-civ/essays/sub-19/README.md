...
This chapter folder is a public study doorway for `sub-19`.
...
- [Transcript](sub-19-transcript.md)
- [Commentary canvas](sub-19-commentary.md)
- [Public card](../../data/cards/sub-19.md)

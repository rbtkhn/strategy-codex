...
This chapter folder is a public study doorway for `sub-06`.
...
- [Transcript](sub-06-transcript.md)
- [Commentary canvas](sub-06-commentary.md)
- [Public card](../../data/cards/sub-06.md)

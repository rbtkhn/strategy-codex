...
This chapter folder is a public study doorway for `sub-23`.
...
- [Transcript](sub-23-transcript.md)
- [Commentary canvas](sub-23-commentary.md)
- [Public card](../../data/cards/sub-23.md)

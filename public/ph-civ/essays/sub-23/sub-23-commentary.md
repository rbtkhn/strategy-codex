...
source_chapter_path: essays/sub-23/sub-23-transcript.md
source_corpus_path: corpus/essays/sub-23.md
...
`sub-23` is a public essay packet on the ph-civ essays surface. The working thesis is that the essay should be read as an interpretive argument within the Predictive History civilizational frame, not as settled proof or operational guidance.

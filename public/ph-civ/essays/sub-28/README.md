...
This chapter folder is a public study doorway for `sub-28`.
...
- [Transcript](sub-28-transcript.md)
- [Commentary canvas](sub-28-commentary.md)
- [Public card](../../data/cards/sub-28.md)

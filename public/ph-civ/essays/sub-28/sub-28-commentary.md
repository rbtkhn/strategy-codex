...
source_chapter_path: essays/sub-28/sub-28-transcript.md
source_corpus_path: corpus/essays/sub-28.md
...
`sub-28` is a public essay packet on the ph-civ essays surface. The working thesis is that the essay should be read as an interpretive argument within the Predictive History civilizational frame, not as settled proof or operational guidance.

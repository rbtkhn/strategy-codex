...
source_chapter_path: essays/sub-31/sub-31-transcript.md
source_corpus_path: corpus/essays/sub-31.md
...
`sub-31` is a public essay packet on the ph-civ essays surface. The working thesis is that the essay should be read as an interpretive argument within the Predictive History civilizational frame, not as settled proof or operational guidance.

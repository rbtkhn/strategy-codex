...
source_chapter_path: essays/sub-26/sub-26-transcript.md
source_corpus_path: corpus/essays/sub-26.md
...
`sub-26` is a public essay packet on the ph-civ essays surface. The working thesis is that the essay should be read as an interpretive argument within the Predictive History civilizational frame, not as settled proof or operational guidance.

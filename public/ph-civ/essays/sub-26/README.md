...
This chapter folder is a public study doorway for `sub-26`.
...
- [Transcript](sub-26-transcript.md)
- [Commentary canvas](sub-26-commentary.md)
- [Public card](../../data/cards/sub-26.md)

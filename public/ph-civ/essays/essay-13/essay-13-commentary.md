...
source_chapter_path: essays/essay-13/essay-13-transcript.md
source_corpus_path: corpus/essays/essay-13.md
...
`essay-13` is a public essay packet on the ph-civ essays surface. The working thesis is that the essay should be read as an interpretive argument within the Predictive History civilizational frame, not as settled proof or operational guidance.

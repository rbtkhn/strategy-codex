...
This chapter folder is a public study doorway for `sub-14`.
...
- [Transcript](sub-14-transcript.md)
- [Commentary canvas](sub-14-commentary.md)
- [Public card](../../data/cards/sub-14.md)

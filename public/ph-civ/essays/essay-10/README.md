...
This chapter folder is a public study doorway for `essay-10`.
...
- Substack: https://predictivehistory.substack.com/p/secret-history-7-the-voyage-home

## Files

- [Transcript](essay-10-transcript.md)
- [Commentary canvas](essay-10-commentary.md)
- [Public card](../../data/cards/essay-10.md)

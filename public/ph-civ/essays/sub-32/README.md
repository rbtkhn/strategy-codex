...
This chapter folder is a public study doorway for `sub-32`.
...
- [Transcript](sub-32-transcript.md)
- [Commentary canvas](sub-32-commentary.md)
- [Public card](../../data/cards/sub-32.md)

...
This chapter folder is a public study doorway for `sub-01`.
...
- Substack: https://predictivehistory.substack.com/p/vision-mission-goals

## Files

- [Transcript](sub-01-transcript.md)
- [Commentary canvas](sub-01-commentary.md)
- [Public card](../../data/cards/sub-01.md)

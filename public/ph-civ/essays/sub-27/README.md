...
This chapter folder is a public study doorway for `sub-27`.
...
- [Transcript](sub-27-transcript.md)
- [Commentary canvas](sub-27-commentary.md)
- [Public card](../../data/cards/sub-27.md)

...
This chapter folder is a public study doorway for `sub-30`.
...
- Substack: https://predictivehistory.substack.com/p/the-acceleration

## Files

- [Transcript](sub-30-transcript.md)
- [Commentary canvas](sub-30-commentary.md)
- [Public card](../../data/cards/sub-30.md)

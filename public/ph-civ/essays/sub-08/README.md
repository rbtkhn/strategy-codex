...
This chapter folder is a public study doorway for `sub-08`.
...
- [Transcript](sub-08-transcript.md)
- [Commentary canvas](sub-08-commentary.md)
- [Public card](../../data/cards/sub-08.md)

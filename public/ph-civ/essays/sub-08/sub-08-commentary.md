...
source_chapter_path: essays/sub-08/sub-08-transcript.md
source_corpus_path: corpus/essays/sub-08.md
...
`sub-08` is a public essay packet on the ph-civ essays surface. The working thesis is that the essay should be read as an interpretive argument within the Predictive History civilizational frame, not as settled proof or operational guidance.

...
This chapter folder is a public study doorway for `sub-18`.
...
- [Transcript](sub-18-transcript.md)
- [Commentary canvas](sub-18-commentary.md)
- [Public card](../../data/cards/sub-18.md)

...
This chapter folder is a public study doorway for `sub-16`.
...
- [Transcript](sub-16-transcript.md)
- [Commentary canvas](sub-16-commentary.md)
- [Public card](../../data/cards/sub-16.md)

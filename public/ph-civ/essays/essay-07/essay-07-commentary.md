...
source_chapter_path: essays/essay-07/essay-07-transcript.md
source_corpus_path: corpus/essays/essay-07.md
...
`essay-07` is a public essay packet on the ph-civ essays surface. The working thesis is that the essay should be read as an interpretive argument within the Predictive History civilizational frame, not as settled proof or operational guidance.

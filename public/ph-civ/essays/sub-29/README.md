...
This chapter folder is a public study doorway for `sub-29`.
...
- [Transcript](sub-29-transcript.md)
- [Commentary canvas](sub-29-commentary.md)
- [Public card](../../data/cards/sub-29.md)

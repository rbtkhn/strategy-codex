...
`sub-16` sits on the ph-civ essays surface (`part: civilization`). It preserves the Substack essay as a public study packet with bounded commentary.
...
Return through `essays/sub-16/sub-16-transcript.md` for exact essay wording and `essays/sub-16/sub-16-commentary.md` for bounded analysis.

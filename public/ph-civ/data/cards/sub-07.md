...
`sub-07` sits on the ph-civ essays surface (`part: civilization`). It preserves the Substack essay as a public study packet with bounded commentary.
...
Return through `essays/sub-07/sub-07-transcript.md` for exact essay wording and `essays/sub-07/sub-07-commentary.md` for bounded analysis.

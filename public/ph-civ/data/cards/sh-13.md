...
Return through book/volume-vi/sh-13/sh-13-transcript.md for exact lecture wording, book/volume-vi/sh-13/sh-13-commentary.md for bounded analysis, and corpus/secret-history/sh-13.md for source metadata.

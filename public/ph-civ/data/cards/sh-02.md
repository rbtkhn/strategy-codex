...
Return through book/volume-vi/sh-02/sh-02-transcript.md for exact lecture wording, book/volume-vi/sh-02/sh-02-commentary.md for bounded analysis, and corpus/secret-history/sh-02.md for source metadata.

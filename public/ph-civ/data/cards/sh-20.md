...
Return through book/volume-vi/sh-20/sh-20-transcript.md for exact lecture wording, book/volume-vi/sh-20/sh-20-commentary.md for bounded analysis, and corpus/secret-history/sh-20.md for source metadata.

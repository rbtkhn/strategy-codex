...
`sub-05` sits on the ph-civ essays surface (`part: civilization`). It preserves the Substack essay as a public study packet with bounded commentary.
...
Return through `essays/sub-05/sub-05-transcript.md` for exact essay wording and `essays/sub-05/sub-05-commentary.md` for bounded analysis.

...
`sub-01` sits on the ph-civ essays surface (`part: civilization`). It preserves the Substack essay as a public study packet with bounded commentary.
...
Return through `essays/sub-01/sub-01-transcript.md` for exact essay wording and `essays/sub-01/sub-01-commentary.md` for bounded analysis.

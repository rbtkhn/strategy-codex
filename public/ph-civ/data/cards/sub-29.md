...
`sub-29` sits on the ph-civ essays surface (`part: civilization`). It preserves the Substack essay as a public study packet with bounded commentary.
...
Return through `essays/sub-29/sub-29-transcript.md` for exact essay wording and `essays/sub-29/sub-29-commentary.md` for bounded analysis.

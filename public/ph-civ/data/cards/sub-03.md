...
`sub-03` sits on the ph-civ essays surface (`part: civilization`). It preserves the Substack essay as a public study packet with bounded commentary.
...
Return through `essays/sub-03/sub-03-transcript.md` for exact essay wording and `essays/sub-03/sub-03-commentary.md` for bounded analysis.

...
Return through book/volume-vi/sh-28/sh-28-transcript.md for exact lecture wording, book/volume-vi/sh-28/sh-28-commentary.md for bounded analysis, and corpus/secret-history/sh-28.md for source metadata.

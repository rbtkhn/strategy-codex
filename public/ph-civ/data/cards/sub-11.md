...
`sub-11` sits on the ph-civ essays surface (`part: civilization`). It preserves the Substack essay as a public study packet with bounded commentary.
...
Return through `essays/sub-11/sub-11-transcript.md` for exact essay wording and `essays/sub-11/sub-11-commentary.md` for bounded analysis.

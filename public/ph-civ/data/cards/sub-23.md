...
`sub-23` sits on the ph-civ essays surface (`part: civilization`). It preserves the Substack essay as a public study packet with bounded commentary.
...
Return through `essays/sub-23/sub-23-transcript.md` for exact essay wording and `essays/sub-23/sub-23-commentary.md` for bounded analysis.

...
`sub-30` sits on the ph-civ essays surface (`part: civilization`). It preserves the Substack essay as a public study packet with bounded commentary.
...
Return through `essays/sub-30/sub-30-transcript.md` for exact essay wording and `essays/sub-30/sub-30-commentary.md` for bounded analysis.

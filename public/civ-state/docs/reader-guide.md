...
`What kind of order is this, what legitimates it, what carries it now, and what happens when outward instrument outruns inherited form?`

Read it with four habits:

- look for order before moral theater
- look for legitimacy before raw force
...
- governing-layer entry through the [theory shelf](../theory/README.md) — [Civilization](../theory/civilization.md) · [Empire](../theory/empire.md) · [Entropy](../theory/entropy.md) · [Faith](../theory/faith.md) · [Science](../theory/science.md) · [Memory](../theory/memory.md) (includes [civilizational rhythm](../theory/memory.md#civilizational-rhythm) and [era law](../theory/memory.md#era-law))

Choose civilization-first when the real question is:

- which civilization-state owns this inheritance
- where the sovereignty chain opens
- what present carrier bears it
...
When chronology or shelf choice matters within that mode, read [Memory — era law](../theory/memory.md#era-law) before opening era files inside a volume.
...
| III — Rome | [theory/rome-faith.md](../volumes/rome/theory/rome-faith.md) · [rome-civilization.md](../volumes/rome/theory/rome-civilization.md) · [rome-memory.md](../volumes/rome/theory/rome-memory.md) — [theory cross-cutting table](../theory/README.md#cross-cutting-objects) |
...
The books are not written in evidence spine voice.

`evidence spine` enters earlier, at the evidence and structure layer. Its strongest visible role should appear in [Glossary](glossary.md), [Hybrid References](hybrid-references.md), and [Index](index.md), not in the main narrative dignity surfaces.

That same rule now governs `secondary-sources`: `evidence spine` should shape selection and construction behind the scenes, but should not appear as a named visible layer inside each era file.

The generation law is:

`seed MEM -> MEM CONNECTIONS cluster -> overview bounds -> counterweight -> translation`
...
- empty grandeur with weak evidence
- raw evidence piles that never become book-native judgment

## How To Use This Work While Drafting

This book is upstream of lane drafting.

Use it to:

- identify the right civilization-state case
- name the continuity-bearing order
- identify the present carrier
- locate the likely overreach or restoration problem
- identify the right volume-local bibliography before widening into lane or transaction drafting
- find the right deep-grammar or retrieval object

Then return downstream to:

- lane civilization / empire / state surfaces
- [Memory — civilizational rhythm](../theory/memory.md#civilizational-rhythm) when phase placement governs
- transactions
...
**Citation doctrine:** Body prose carries authorial historical narration plus **woven verbatim primary and pre-modern quotation** (~20% of Rome civic-chain body). Ancient historians, poets, speeches, laws, and official documents belong in the body at argumentative turns; modern scholarship (Syme, Goldsworthy, Everitt, Durant, etc.) belongs in `## Notes`. Gibbon and Mommsen may appear **sparingly only inside quotation marks** as pre-modern reception voices—not as named authorities in authorial prose. Central quotes in body; source locators, translation notes, and modern framing in Notes.

**Literary-academic prose:** Essay bodies should read as finished historical writing—concrete institutions, actors, and events before abstraction; complete sentences rather than colon chains or planning shorthand; section headings that sound like essay titles, not internal labels. Earn large claims through narration **and** embedded ancient witnesses. Editor scaffolding vocabulary lives in `.meta.yaml`, not reader prose. Rome civic-chain essays (genesis–augustus) target roughly **2,400–2,600 words** in the body before `## Notes`, including **~450–550 words of quoted primary/pre-modern text** woven at decisive turns (~2,000 words authorial prose).
...
1. reading empire as though it were the whole civilization
2. reading continuity as though rupture never mattered
3. reading archive as though it were already judgment
4. reading judgment as though it no longer needed source basis
5. reading one civilization-state too smoothly because no counterweight was installed

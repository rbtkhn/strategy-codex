...
Volume-local theory lenses are **orchestrated from the whole-work theory shelf** (v0.1.25+). All six `rome-{term}.md` files and theory overflow live under [theory/](README.md).
...
3. Open the matching file in [theory/](README.md#six-term-lenses)

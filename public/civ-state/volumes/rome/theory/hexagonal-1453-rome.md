# Hexagonal 1453 — East bridge terminus (Rome)
...
| Field | Value |
|-------|-------|
| **Node** | **1453 — East bridge ends** (Constantinople terminus) |
| **Era** | Medieval |
| **One-line stake** | The Eastern Roman bridge-carrier terminates; Latin branches, Papacy, and HRE/France lines carry residue while Greek-medium state continuity ruptures. |
...
**1453** is the cleanest hexagonal node because **entropy** must own the rupture while **empire** loses a whole bridge column without pretending a western emperor “succeeds” the East. **Memory** places the node once on `#chain-spine` and exports the dual-year span so French and Turk shocks stay comparable without collapsed history.

**Civilization** reads the same year as **accelerated partial inheritance** on the peninsula — Renaissance retrieval is residue grammar, not restoration of the bridge-carrier. **Faith** and **science** do not compete for rupture-primary; they carry **co-primary sacred** tension and **procedural migration** (codex, gunpowder, reception) as cross-reads anchored on term segments.

The membrane lesson: one calendar year, six honest answers — inheritance without the instrument, instrument without the shock, shock without duplicating rosters.

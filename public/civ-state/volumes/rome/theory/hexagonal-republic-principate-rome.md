# Hexagonal Republic → principate (Rome)
...
**Archetype:** **E — Transformation hinge** *(wave 2 — chain continues; form mutates)* — complements A–D; not a universal rupture.

## Friction node

| Field | Value |
|-------|-------|
| **Node** | **Republic → principate** (Caesar → Augustan hinge) |
| **Era** | Ancient |
| **One-line stake** | The political chain **continues** while sovereign form mutates from republican magistracy to autocratic imperium — inheritance persists; instrument institutionalizes. |

## Six-lens read

| Lens | Governing question | This node — owns | Defers to | Term anchor |
|------|-------------------|------------------|-----------|-------------|
| **Memory** | Where on the spine? | **Chain hinge** — Republic **opener** → Caesar → Augustan principate; Romulus/Aeneas **substrate only** | Full `#chain-spine` table | [chain-spine](rome-memory.md#chain-spine) · [sovereignty chain — memory](rome-memory.md#sovereignty-chain-memory-lens) |
| **Civilization** | What inheritance is at stake? | **Opener grammar** — civic law, citizenship, magistracy; *virtus* republican ethic; Livy moral inheritance; Greek/Latin **co-primary** from Republic onward | Greek/Latin roster SSOT | [sovereignty chain — civilization](rome-civilization.md#sovereignty-chain-civilization-lens) · [dual language — civilization](rome-civilization.md#dual-language-heritage-civilization-lens) · [military history — civilization](rome-civilization.md#military-history-civilization-lens) |
...
- Do **not** duplicate Caesar/Augustus roster rows, Greek/Latin rosters, or full chain-spine table.
...
**Republic → principate** is the volume’s **transformation hinge**: the chain **does not break**, but the **instrument** changes register. **Civilization** holds what is inherited — civic law, citizenship grammar, republican ethic, co-primary Greek/Latin media. **Empire** names who **institutionalizes** the new form — Caesar and Augustus as hinges, principate as durable machinery.

**Memory** places the node once on `#chain-spine` so mythic substrate (Romulus, Aeneas) does not steal the political opener. **Faith** and **science** stay cross-reads: sacred order and procedural law are **adjacent**, not the primary fracture surface at this beat. **Entropy** correctly reads **empty** — confusing transformation with rupture would mis-route **476** and collapse the Civ↔Empire↔Entropy delineation table.

The hexagonal lesson: continuity can **mutate form** without a shock row — the membrane asks *who owns inheritance* (civ) vs *who owns the instrument* (empire) while the chain keeps moving.

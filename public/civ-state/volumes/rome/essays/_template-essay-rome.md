...
**Essay-rome** — standalone narrative / geographic / hinge demonstrator on the **Civilizational Statecraft** essay lattice. Routing SSOT: [Connectivity Rome — Essay-rome registry](connectivity-rome.md#essay-rome-registry). Machine law: [essay types — do not conflate](connectivity-rome.md#essay-types-do-not-conflate).

**Theory stack:** constitutional essays → [term depth](../README.md#term-depth-volume-root) (`../rome-{term}.md`) → [hex-frame](README.md#hex-frame-hexagonal-demonstrators) → **essay-rome** (this file).

**Not:** constitutional continuity alone ([Civilization Rome](civilization-rome.md) · [Empire Rome](empire-rome.md)) · term-file roster SSOT · hex-frame six-pass blocks (link only when `hex_link` applies).

## Reading Posture

{Orient the reader: what this essay owns in one or two sentences. Standalone — complete without reading peer essays first.}

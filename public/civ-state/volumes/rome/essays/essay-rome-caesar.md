...
The system was still **contested**, not pre-dead, before 49 BC—**Pharsalus reveals** where loyalty and tempo already pointed; it did not **create** the migration of sovereignty, but made it **visible** in a form no decree could reverse.[^19] At Pharsalus, **personal command** outweighed senatorial authorization—the legions answered the general, not the *res publica*.[^8]
...
Sulla marched on Rome to **restore senatorial supremacy** through terror; Caesar marches to preserve his own *dignitas* and will discover that restored legality can no longer contain him. The Rubicon is not invention ex nihilo but **nullification**—collegial process cannot adjudicate between two armies. The choice was between **masters**, not liberty against a single usurper; the republic was too exhausted to hold its own freedom.[^4]

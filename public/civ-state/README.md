...
Maintained in the workspace staging mirror (`public/civ-state/`) and published to this repository via explicit publish script. Canonical public edits land here directly — not via a separate upstream draft tree.

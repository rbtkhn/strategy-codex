RUN — EXERCISE B: SYNTHESIS 0003 (KHOSROW II TRI-FRAME)
Civilizational Memory Codex · Binding-Readiness Test

**Date:** 2026-02-17  
**Target:** CIV–SCHOLAR–PERSIA SYNTHESIS 0003 — TRI-FRAME TENSION: KHOSROW II  
**Goal:** Test whether 0003 adds operational value beyond DOCTRINE 01 or should remain tension-only  
**Reference:** PLAN–SCHOLAR–PERSIA–BINDING–EXERCISES–2026–02–17 § III Exercise B

────────────────────────────────────────────────────────────
B.1 REDUNDANCY CHECK
────────────────────────────────────────────────────────────

**Question:** DOCTRINE 01 already encodes Khosrow II as confirming case (overextension → defection → exhaustion). Does 0003's *tri-frame tension* (Keegan / Mearsheimer / Barnes / Mercouris) add a **constraint** or only **pedagogy**?

**Comparison:**

| DOCTRINE 01 | SYNTHESIS 0003 |
|-------------|----------------|
...
────────────────────────────────────────────────────────────
B.2 CONSTRAINT FORMULATION
────────────────────────────────────────────────────────────

**If bound as doctrine, candidate sentence:**

"When analyzing Persian overextension or cases that instantiate the overextension pattern (e.g. Khosrow II, or analogous reach-without-hold), all four analytical frames (liability, structure, legitimacy, belief/mask) must be considered; no single-frame closure."

**Operational meaning:** In LEARN or STATE, any assessment of an overextension case must surface at least the four perspectives (Barnes: who paid, who defected; Mearsheimer: incentive structure, closure capacity; Mercouris: legitimacy exhaustion, absorption failure; Keegan: belief/mask collapse, demands exceed tolerance). Single-frame conclusions (e.g. "purely structural" or "purely liability") are non-compliant.

**Caveat:** This overlaps with the existing non-synthesis rule and with three-perspective (Mercouris/Mearsheimer/Barnes) practice. The *fourth* frame (Keegan / belief-mask) is the main addition. Binding would make the four-frame requirement explicit for overextension cases.

────────────────────────────────────────────────────────────
B.3 COUNTER-CASE
────────────────────────────────────────────────────────────

**Question:** Is there a Persian overextension case where *one* frame clearly fails (e.g. liability absent, or structure sufficient alone)?
...
**RETAIN UNBINDING** (default recommendation).
...
**If the user wants to enforce four-frame analysis for overextension explicitly:** BIND as DOCTRINE 03 (short formulation): "When analyzing Persian overextension or analogous reach-without-hold cases, all four analytical frames (liability, structure, legitimacy, belief/mask) must be considered; no single-frame closure." Add operational meaning and one hard constraint (e.g. "Doctrine is invalid or must be reviewed if overextension analysis is conducted with a single frame only and no justification for frame limitation."). Then 0003 would be updated to ACCEPTED_AS_DOCTRINE → DOCTRINE 03.

────────────────────────────────────────────────────────────
END OF RUN — EXERCISE B — 2026-02-17
────────────────────────────────────────────────────────────

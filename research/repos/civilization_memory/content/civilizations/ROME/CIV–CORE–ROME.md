...
Governance failure occurs when procedures are perceived as coercive
...
────────────────────────────────────────────────────────────
Rome is interoperable with other civilizations but cannot enforce
convergence without legitimacy loss.
...
If irreversibility thresholds are crossed, restoration narratives are
invalid.

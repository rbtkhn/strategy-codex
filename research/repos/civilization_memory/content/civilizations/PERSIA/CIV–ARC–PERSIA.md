...
ARC-T-ANCIENT — Foundational period; direct witnesses (pre-500 AD).
  Persian classical period through late antique Sasanian sources.
  Greek historiography of Persia; Avestan/Zoroastrian texts; inscriptions.
ARC-T-MEDIEVAL — Medieval transmission (500–1500 AD).
  Islamic-era chronicles of pre-Islamic Persia; Shahnameh; transmission witnesses.
...
────────────────────────────────────────────────────────────
Per CIV–ARC–TEMPLATE v3.0 § V-A. Persia TSP MEMs (e.g., MEM–PERSIA–ZOROASTER on transmission to Jewish/Christian/Islamic eschatology; MEM–ROME–RUSSIA on Byzantine–Persian transmission) may cite sources from ARC–ROME, ARC–ISLAM, ARC–ANGLIA, etc., with explicit ARC declaration.

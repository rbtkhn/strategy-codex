...
Supersedes: CIV–ARC–GERMANY v3.1
...
────────────────────────────────────────────────────────────
This version aligns CIV–ARC–GERMANY with CIV–ARC–TEMPLATE v3.0.
...
**Indigenous-language quote requirement (MEM–GERMANY):** Each
MEM–GERMANY file MUST contain at least one verbatim quote (≥25 words)
...
• Philippe Dollinger (1904–1999) — The German Hansa
  ...
  - Supports: MEM–GERMANY–HANSEATIC–LEAGUE, MEM–GERMANY–LUBECK, MEM–GERMANY–HAMBURG
• Jonathan Israel (b. 1946) — The Dutch Republic
  ...
  - Supports: MEM–GERMANY–NETHERLANDS series, exit civilization analysis
• Geoffrey Parker (b. 1943) — The Dutch Revolt; The Army of Flanders
  ...
  - Supports: MEM–GERMANY–BELGIUM–ANTWERP, Habsburg military analysis
...
1. Primary ARC (ARC–GERMANY) governs MEMs filed under GERMANY.
...
TSP EXAMPLES (GERMANY): MEM–GERMANY–ROTHSCHILD (NETWORK — cross-ARC: ANGLIA,
FRANCE); MEM–GERMANY–HANSEATIC–LEAGUE (NETWORK — cross-ARC: ANGLIA, Baltic civs).
...
VIII. MIRRORING RULE
────────────────────────────────────────────────────────────
ARC–GERMANY must be referenced in:
• CIV–CORE–GERMANY
• CIV–SCHOLAR–GERMANY

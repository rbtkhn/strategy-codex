...
Civilization State formalizes **civ-state** as a discrete civilization dynamics system: civilizations as state machines evolving under rule-based constraints. It complements [Predictive History](../../../predictive-history/README.md) (real-world inference) and integrates with [Narrative Systems](../../README.md) (interpretation layer).

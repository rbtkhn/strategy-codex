...
| Artifact | Path |
|----------|------|
| JSON graph | `artifacts/skill-work/work-strategy/interview-graph/cognition-streams-graph.json` |
| Markdown companion | `artifacts/skill-work/work-strategy/interview-graph/cognition-streams-graph.md` |

...
| `artifacts/benchmarks/composition/` | Kleiber composition benchmark protocol | **Work-layer** Strategy-codex composition benchmark outputs and scoring notes; run only from Kleiber Conductor action menu option C; [bucket README](benchmarks/composition/README.md), [protocol](../docs/skill-work/work-dev/kleiber-composition-benchmark.md). |

...
| `Judge Andrew Napolitano; Larry Johnson -> Larry Johnson` | 1 |
| `Lt. Col. Daniel Davis -> Daniel Davis` | 1 |
...
| `2025 War Strategies` | 1 |
| `Aaron Maté` | 1 |
| `Alex Christoforou, Alexander Mercouris` | 1 |
| `Anatol Lieven` | 1 |
| `Austin v. Hegseth` | 1 |
| `BREAKING` | 1 |
| `Biden` | 1 |
| `Biden Pushes More $$$ to Ukraine to 'Pressure Putin'` | 1 |
| `CLOSE` | 1 |
...
- `Seyed M. Marandi`: `Seyed M. Marandi` (33), `Seyed M. Marandi & Larry C. Johnson` (1)
- `Andrei Martyanov`: `Andrei Martyanov` (28), `Andrei Martyanov & Alex Krainer` (1), `Andrei Martyanov & Scott Ritter` (1), `Pepe Escobar & Andrei Martyanov` (1), `Scott Ritter & Andrei Martyanov` (1)
- `Jacques Baud`: `Col. Jacques Baud` (19), `Jacques Baud` (7)
...
- `Ray McGovern`: `Ray McGovern` (17), `Scott Ritter; Ray McGovern` (1)
...
- `Mohammad Marandi`: `Mohammad Marandi` (7), `Chas Freeman & Mohammad Marandi` (2), `Israel's Worst Nightmare Coming | Prof. Mohammad Marandi & Scott Ritter` (1)
- `Daniel Davis`: `Daniel Davis` (6), `Lt Col Daniel Davis` (2)
- `Robert Pape`: `Robert Pape` (5), `Professor Robert Pape` (2)
- `Anthony Aguilar`: `Lt. Col. Anthony Aguilar` (5), `Anthony Aguilar` (1)
- `Doug Macgregor`: `Col Doug Macgregor` (4), `Doug Macgregor` (2)
- `Ted Postol`: `Prof. Ted Postol` (2), `Ted Postol` (2)

...
2. **Generated/runtime and Record-adjacent residue**
   - Surfaces: `runtime-bundle/**`, `users/grace-mar/runtime-bundle/**`, `last-dream.json`, `merge-receipts.jsonl`, `pipeline-events.jsonl`, `artifacts/memory/**`, root Record-adjacent files.

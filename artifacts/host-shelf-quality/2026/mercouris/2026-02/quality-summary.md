...
- routeable artifact count: `0` (+0)
- total word mass: `16237` (+0)
- transcript-valid percent: `100.0%` (+0.0pp)
- residual-noise artifacts: `1`
- unresolved speaker count: `2`
- git: `on-disk/verified/not-committed/not-pushed`
- closeout: Structure: +0 routeable | Purity: +0 transcript-valid / 100.0% (+0.0pp) | Unresolved: 2 | Git: on-disk/verified/not-committed/not-pushed

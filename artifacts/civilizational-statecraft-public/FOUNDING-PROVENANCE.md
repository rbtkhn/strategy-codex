...
3. **Reshape v0.2 (this release):** Replaced helix-first navigation with the book-first export from `statecraft/states/` — two-volume whole work, five civilization-state volumes, source-lattice per volume, comparative and sacred-grammar apparatus.

...
def test_pass_carry_harness_fixture(tmp_path: Path) -> None:
    ...
    cmd = [
        ...
        "--task",
        "docs/archive/skill-work-legacy/work-strategy/fixtures/carry-harness/sample-task.md",
        "--source",
        "docs/archive/skill-work-legacy/work-strategy/fixtures/carry-harness/sample-source.md",
        "--artifact",
        "docs/archive/skill-work-legacy/work-strategy/fixtures/carry-harness/sample-artifact.md",
        "--gate-snippet",
        "docs/archive/skill-work-legacy/work-strategy/fixtures/carry-harness/sample-gate-snippet.md",
        "--out",
        str(out),
        "--repo-root",
        str(REPO_ROOT),
...
def test_missing_artifact_fail(tmp_path: Path) -> None:
    ...
    cmd = [
        ...
        str(_scripts_ws() / "validate_strategy_packet.py"),
        "--artifact",
        "docs/archive/skill-work-legacy/work-strategy/fixtures/carry-harness/does-not-exist-artifact.md",
        "--out",
        str(out),
        "--repo-root",
        str(REPO_ROOT),
...
def test_missing_source_needs_review(tmp_path: Path) -> None:
    ...
    cmd = [
        ...
        str(_scripts_ws() / "validate_strategy_packet.py"),
        "--source",
        "docs/archive/skill-work-legacy/work-strategy/fixtures/carry-harness/no-such-source.md",
        "--artifact",
        "docs/archive/skill-work-legacy/work-strategy/fixtures/carry-harness/sample-artifact.md",
        "--out",
        str(out),
...
def test_thin_artifact_needs_review(tmp_path: Path) -> None:
    ...
    cmd = [
        ...
        str(_scripts_ws() / "validate_strategy_packet.py"),
        "--artifact",
        "docs/archive/skill-work-legacy/work-strategy/fixtures/validators/sample-artifact-thin.md",
        "--out",
        str(out),
        "--repo-root",
        str(REPO_ROOT),
...
def test_unresolved_markers_needs_review(tmp_path: Path) -> None:
    ...
    cmd = [
        ...
        str(_scripts_ws() / "validate_strategy_packet.py"),
        "--artifact",
        "docs/archive/skill-work-legacy/work-strategy/fixtures/validators/sample-artifact-unresolved.md",
        "--out",
        str(out),
        "--repo-root",
        str(REPO_ROOT),
...
def test_validate_packet_forbidden_output(tmp_path: Path) -> None:
    ...
    rep = vsp.validate_packet(
        ...
        task_arg=None,
        sources=[],
        artifacts=["docs/archive/skill-work-legacy/work-strategy/fixtures/carry-harness/sample-artifact.md"],

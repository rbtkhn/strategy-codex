...
FIXTURES = [
    ...
    ("docs/skill-work/work-strategy/fixtures/task-shapes/sample-notebook-synthesis.md", "notebook_synthesis"),
    ("docs/skill-work/work-strategy/fixtures/task-shapes/sample-decision-point.md", "decision_point"),
    ("docs/skill-work/work-strategy/fixtures/task-shapes/sample-gate-candidate-prep.md", "gate_candidate_prep"),
...
def test_frontmatter_overrides_keyword_noise(tmp_path: Path) -> None:
    ...
    cmd = [
        ...
        str(_scripts_ws() / "classify_task_shape.py"),
        "--task",
        "docs/skill-work/work-strategy/fixtures/task-shapes/sample-frontmatter-override.md",
        "--out",
        str(out),
        "--repo-root",
        str(REPO_ROOT),
...
def test_ambiguous_low_confidence(tmp_path: Path) -> None:
    ...
    cmd = [
        ...
        str(_scripts_ws() / "classify_task_shape.py"),
        "--task",
        "docs/skill-work/work-strategy/fixtures/task-shapes/sample-ambiguous.md",
        "--out",
        str(out),
        "--repo-root",
        str(REPO_ROOT),
...
def test_forbidden_out_users(tmp_path: Path) -> None:
    ...
    cmd = [
        ...
        str(_scripts_ws() / "classify_task_shape.py"),
        "--task",
        "docs/skill-work/work-strategy/fixtures/task-shapes/sample-decision-point.md",
        "--out",
        str(bad_out),
        "--repo-root",
        str(REPO_ROOT),

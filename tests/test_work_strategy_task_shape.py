...
FIXTURES = [
    ("docs/archive/skill-work-legacy/work-strategy/fixtures/task-shapes/sample-watch-update.md", "watch_update"),
    ("docs/archive/skill-work-legacy/work-strategy/fixtures/task-shapes/sample-notebook-synthesis.md", "notebook_synthesis"),
    ("docs/archive/skill-work-legacy/work-strategy/fixtures/task-shapes/sample-decision-point.md", "decision_point"),
    ("docs/archive/skill-work-legacy/work-strategy/fixtures/task-shapes/sample-gate-candidate-prep.md", "gate_candidate_prep"),
    ("docs/archive/skill-work-legacy/work-strategy/fixtures/task-shapes/sample-contradiction-review.md", "contradiction_review"),
    ("docs/archive/skill-work-legacy/work-strategy/fixtures/task-shapes/sample-source-expansion.md", "source_expansion"),
]
...
def test_frontmatter_overrides_keyword_noise(tmp_path: Path) -> None:
    ...
    cmd = [
        ...
        str(_scripts_ws() / "classify_task_shape.py"),
        "--task",
        "docs/archive/skill-work-legacy/work-strategy/fixtures/task-shapes/sample-frontmatter-override.md",
        "--out",
        str(out),
        "--repo-root",
        str(REPO_ROOT),
...
def test_ambiguous_low_confidence(tmp_path: Path) -> None:
    ...
    cmd = [
        ...
        str(_scripts_ws() / "classify_task_shape.py"),
        "--task",
        "docs/archive/skill-work-legacy/work-strategy/fixtures/task-shapes/sample-ambiguous.md",
        "--out",
        str(out),
        "--repo-root",
        str(REPO_ROOT),
...
def test_forbidden_out_users(tmp_path: Path) -> None:
    ...
    cmd = [
        ...
        str(_scripts_ws() / "classify_task_shape.py"),
        "--task",
        "docs/archive/skill-work-legacy/work-strategy/fixtures/task-shapes/sample-decision-point.md",
        "--out",
        str(bad_out),
        "--repo-root",
        str(REPO_ROOT),
...
def test_carry_harness_classify_embeds_receipt(tmp_path: Path) -> None:
    ...
    cmd = [
        ...
        "docs/archive/skill-work-legacy/work-strategy/fixtures/task-shapes/sample-decision-point.md",
        "--artifact",
        "docs/archive/skill-work-legacy/work-strategy/fixtures/carry-harness/sample-artifact.md",
        "--out",
        str(receipt_path),
        "--repo-root",
        str(REPO_ROOT),

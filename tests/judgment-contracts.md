...
| Rehome Path Hygiene | `tests/test_rehome_path_hygiene_contract.py` | `tests/fixtures/rehome_path_hygiene_contract.json` | Canonical rehome paths stay canonical. | Live tracked files are pointing back to old `codex/2026/academy`, `codex/2026/speakers`, `codex/2026/raw-input`, or `codex/2025` paths, or `.gitmodules` drifted. | Rehome, path, submodule, or raw-input tooling changes. |

...
- [export_code_context.py](C:/dev/strategy-codex/platform/integrations/codegraph/export_code_context.py)
- [generate_architecture_bundle.py](C:/dev/strategy-codex/platform/integrations/codegraph/generate_architecture_bundle.py)
- prior same-day export artifacts already present in `runtime/artifacts/codegraph/`
...
- [service-architecture.md](C:/dev/strategy-codex/runtime/artifacts/codegraph/service-architecture.md)
...
- the top-ranked result set also pulled in unrelated-but-lexically-near nodes like `service_worker` from `platform/apps/miniapp_server.py`
...
| `wall_minutes` | `1` |
| `tool_calls` | `2` |
| `output_path` | `runtime/artifacts/codegraph/service-architecture.md` |
...
- [service-architecture.json](C:/dev/strategy-codex/runtime/artifacts/codegraph/service-architecture.json)
...
| `wall_minutes` | `1` |
| `tool_calls` | `1` |
| `output_path` | `runtime/artifacts/codegraph/service-architecture.json` |
| `answer_quality` | `weak` |
...
- [benchmark-codegraph-service-architecture.bundle.json](C:/dev/strategy-codex/runtime/artifacts/presentations/benchmark-codegraph-service-architecture.bundle.json)
...
| `wall_minutes` | `1` |
| `tool_calls` | `3` |
| `output_path` | `runtime/artifacts/presentations/benchmark-codegraph-service-architecture.bundle.json` |

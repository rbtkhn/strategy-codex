...
From `runtime/artifacts/work-lanes-dashboard.json` (run `build_work_lanes_dashboard.py` first). 
...
```json
{
  ...
  "lanes": {
    ...
    "work_dev_dashboard_legacy": {
      ...
      "autonomy_tier_platform/profile": "low_risk_staging_suggestions"
    }
  }
}
```
...
- **Receipt file:** `runtime/prepared-context/last-budget-builds.json`
...
_`runtime/artifacts/context/` is gitignored by default â€” regenerate with `scripts/compress_active_lane.py`. Listing skipped here._

...
- Do not edit Record surfaces: `self.md`, `self-archive.md`, `recursion-gate.md`, `session-log.md`, or `archive/grace-mar-instance/bot/prompt.py`.
...
rg -n "YYYY-MM-DD" .codex-tmp/youtube-alex-mercouris-index runtime/artifacts/cognition-streams -g "*.md" -g "*.json" -g "*.jsonl"
```

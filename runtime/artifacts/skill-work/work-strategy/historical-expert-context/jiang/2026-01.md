# Historical expert context — `jiang` — `2026-01`
...
```text
historical-expert-context | jiang | stance=[strength: low] **Upstream anchor:** Predictive History YouTube (sole profile Seed). | provenance=high:0,medium:0,low:1
```

# Historical expert context — `jiang` — `2026-02`
...
```text
historical-expert-context | jiang | stance=[strength: low] **Corpus pointer (WORK):** Operator-scoped lecture tree — not a dated Feb appearance claim. | provenance=high:0,medium:0,low:1
```

# Historical expert context — `barnes` — `2026-03`
...
```text
historical-expert-context | barnes | stance=[strength: low] **Repeat anchor:** About page — not a March appearance claim. | provenance=high:0,medium:0,low:1
```

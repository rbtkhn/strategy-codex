# Historical expert context — `barnes` — `2026-01`
...
```text
historical-expert-context | barnes | stance=[strength: low] **Identity anchor:** Barnes Law LLP + X (Seed). | provenance=high:0,medium:0,low:1
```

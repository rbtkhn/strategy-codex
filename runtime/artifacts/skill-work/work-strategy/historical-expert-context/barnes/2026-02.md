# Historical expert context — `barnes` — `2026-02`
...
```text
historical-expert-context | barnes | stance=[strength: low] **Long-form example:** Podbean interview (profile — verify URL before cite). | provenance=high:0,medium:0,low:1
```

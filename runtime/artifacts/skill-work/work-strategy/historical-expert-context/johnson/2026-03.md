# Historical expert context — `johnson` — `2026-03`
...
```text
historical-expert-context | johnson | stance=[strength: low] **Repeat anchor:** Substack hub — no implied posting calendar. | provenance=high:0,medium:0,low:1
```

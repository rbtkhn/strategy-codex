# Historical expert context — `pape` — `2026-01`
...
```text
historical-expert-context | pape | stance=[strength: low] **Identity anchor:** Chicago Project on Security & Threats + Escalation Trap Substack + X (Seed). | provenance=high:0,medium:0,low:1
```

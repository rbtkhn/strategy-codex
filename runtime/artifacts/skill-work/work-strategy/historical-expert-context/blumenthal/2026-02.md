# Historical expert context — `blumenthal` — `2026-02`
...
```text
historical-expert-context | blumenthal | stance=[strength: low] **Support hub:** Patreon — not a dated February post list. | provenance=high:0,medium:0,low:1
```

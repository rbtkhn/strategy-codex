# Historical expert context — `blumenthal` — `2026-01`
...
```text
historical-expert-context | blumenthal | stance=[strength: low] **Identity anchor:** Grayzone author index + X + Patreon (Seed). | provenance=high:0,medium:0,low:1
```

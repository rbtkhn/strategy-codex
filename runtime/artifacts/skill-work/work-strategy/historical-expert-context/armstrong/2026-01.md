# Historical expert context — `armstrong` — `2026-01`
...
```text
historical-expert-context | armstrong | stance=[strength: low] **Identity anchor:** Armstrong Economics + X + YouTube (Seed). | provenance=high:0,medium:0,low:1
```

# Historical expert context — `armstrong` — `2026-02`
...
```text
historical-expert-context | armstrong | stance=[strength: low] **Repeat:** Site hub — not a February appearance list. | provenance=high:0,medium:0,low:1
```

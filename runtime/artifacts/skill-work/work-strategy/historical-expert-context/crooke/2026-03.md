# Historical expert context — `crooke` — `2026-03`
...
```text
historical-expert-context | crooke | stance=[strength: low] **Repeat anchor:** Same Seed hubs — no implied posting calendar. | provenance=high:0,medium:0,low:1
```

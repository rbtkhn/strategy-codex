# Historical expert context — `berletic`
...
```text
historical-expert-context | berletic | stance=[strength: low] **Note:** Pair with **`ritter`** / **`jermy`** when headline kinetic claims need factory–stockpile counterweight — [`batch-analysis`](strategy-commentator-threads.md) discipline. | shifts=[strength: low] **Repeat anchor:** Same Seed hubs as January — scope discipline unchanged. | provenance=high:0,medium:0,low:5
```

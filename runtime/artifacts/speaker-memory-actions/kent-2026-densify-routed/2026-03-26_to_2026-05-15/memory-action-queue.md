...
- `high` `update-existing-arc` `codex/years/2026/diesen/diesen-kent-speaker-arc.md` (1 appearance(s); grades: transcript-grade)
  - reason: Appearance routes to an existing host-local speaker arc.
  - operator: Review the raw-input and update the existing speaker arc if it changes the ranked arc set, open-first choice, or boundary.
- `high` `update-existing-arc` `codex/years/2026/nawfal/nawfal-kent-speaker-arc.md` (1 appearance(s); grades: transcript-bearing)
  - reason: Appearance routes to an existing host-local speaker arc.
  - operator: Review the raw-input and update the existing speaker arc if it changes the ranked arc set, open-first choice, or boundary.

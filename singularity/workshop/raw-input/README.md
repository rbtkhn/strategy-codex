...
Use `source-archive/singularity/innermost-loop/` for full workshop source captures, and use repo-root `singularity/` for synthesis, longitudinal views, and academy-facing sheets.

...
| **[Cici](https://github.com/Xavier-x01/Cici)** (external) | Cici’s **OB1 instance** repo on GitHub (config/docs; **commit spine** for [cici_journal_ob1_digest.py](../../../scripts/cici_journal_ob1_digest.py)). Canonical pointer replaces `open-brain-xavier` — see [work-cici-history.md](work-cici-history.md) `### 2026-04-10`. |
...
| [DAY-1-NO-TERMINAL.md](DAY-1-NO-TERMINAL.md) | Beginner-first first session flow |
| [COMPANION-XAVIER-DELETION-READINESS.md](COMPANION-XAVIER-DELETION-READINESS.md) | Historical: clean-room validation when instance was monorepo-hosted |
...
| [work-dev-mirror/SYNC-CONTRACT.md](work-dev-mirror/SYNC-CONTRACT.md) | Sync rules from grace-mar `work-dev` into mirror |
| [work-dev-mirror/SYNC-LOG.md](work-dev-mirror/SYNC-LOG.md) | Daily sync-check ledger |
| [work-politics-mirror/README.md](work-politics-mirror/README.md) | Mirror of `work-politics` sync workflow |
| [work-politics-mirror/SYNC-CONTRACT.md](work-politics-mirror/SYNC-CONTRACT.md) | Sync rules from grace-mar `work-politics` |

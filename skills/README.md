...
| Path | Role |
|------|------|
| `skills/<skill-name>/SKILL.md` | Portable core: frontmatter + methodology (minimal instance paths) |
...
1. Copy `skills/<skill>/SKILL.md` (and optional `examples/` if present).

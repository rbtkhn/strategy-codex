...
Use this skill to harden the CIV-STATE front door and the volume README layer.

This is an **operator-doctrine** skill. Its job is to make CIV-STATE volumes clearer, truer, and more retrievable. It should standardize civilization-state framing, sovereignty-chain logic, opener doctrine, and retrieval consequences without flattening real historical asymmetry.

## Use this skill when

- the operator wants to create or tighten a CIV-STATE volume README
- the CIV-STATE front door needs clearer civilization-state doctrine

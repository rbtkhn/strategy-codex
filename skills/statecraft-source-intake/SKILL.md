...
- **Display spelling:** YAML `host:` / `guest:` and post-section speaker labels use **Nima Alkhorshid** (surname with **h**); machine slug stays **`alkorshid`**. Full law: [dialogue-works-disambiguation § Display spelling](../../../statecraft/channels/dialogue-works/dialogue-works-disambiguation.md).

...
PILOT = REPO_ROOT / "statecraft/voices/jiang/ph-civ/scripts/_pilot_asr_normalize_civ01_civ07.py"
OUT = (
    REPO_ROOT
...
def main() -> None:
    ...
    payload = {
        ...
        "source_script": "statecraft/voices/jiang/ph-civ/scripts/_pilot_asr_normalize_civ01_civ07.py",

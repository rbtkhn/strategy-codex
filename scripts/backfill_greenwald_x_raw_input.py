#!/usr/bin/env python3
"""Backfill Glenn Greenwald X posts into strategy-notebook raw-input/.

Thin wrapper around ``backfill_x_profile_raw_input.py`` with Greenwald defaults.
"""
...
DEFAULT_PROFILE_URL = "https://x.com/ggreenwald"
DEFAULT_THREAD = "greenwald"

#!/usr/bin/env python3
"""Backfill Robert Barnes X posts into strategy-notebook raw-input/.

Thin wrapper around ``backfill_x_profile_raw_input.py`` for the Barnes lane.
...
DEFAULT_PROFILE_URL = "https://x.com/barnes_law"

...
def run_quick() -> int:
    checks = [
        ...
        (
            ...
            "epistemic generative state (advisory)",
        ),
        (["python3", "scripts/build_epistemic_calibration_loss.py"], "build epistemic calibration loss"),
        (
            ["python3", "scripts/check_epistemic_calibration_loss.py", "--advisory"],
            "epistemic calibration loss (advisory)",
        ),
        (["python3", "scripts/build_epistemic_dataset.py"], "build epistemic dataset"),
        (
            ["python3", "scripts/check_epistemic_dataset.py", "--advisory"],
            "epistemic dataset (advisory)",
        ),
        (["python3", "scripts/build_baseline_forecasts.py"], "build baseline forecasts"),
        (

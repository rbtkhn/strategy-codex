...
def build_artifacts(
    *,
    ...
    return build_epistemic_payload(
...
def main() -> int:
    ...
    ap.add_argument("--check", action="store_true", help="drift check vs generator")
    ...
    if args.write or not args.check:
        write_artifacts(bundle, artifact_dir=args.artifact_dir, include_multivoice=include_mv)
        print(

#!/usr/bin/env python3
"""Generate runtime/artifacts/loop-registry.json from singularity loop YAML."""
...
DEFAULT_OUTPUT = REPO_ROOT / "runtime" / "artifacts" / "loop-registry.json"

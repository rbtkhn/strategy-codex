#!/usr/bin/env python3
"""Backfill Sonar21 articles into strategy-notebook raw-input/.

Thin wrapper around ``backfill_author_page_raw_input.py`` for the Johnson lane.
...
DEFAULT_AUTHOR_URL = "https://sonar21.com/"
DEFAULT_DOMAIN = "sonar21.com"

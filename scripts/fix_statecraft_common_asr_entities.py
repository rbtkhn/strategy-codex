...
REPLACEMENT_SPECS: tuple[ReplacementSpec, ...] = (
    ...
    ReplacementSpec(re.compile(r"\bAndrei\s+Martiano\b", re.IGNORECASE), "Andrei Martyanov", "martyanov_andrei_martiano"),
    ReplacementSpec(re.compile(r"\bAndre\s+Martiano\b", re.IGNORECASE), "Andre Martyanov", "martyanov_andre_martiano"),
    ReplacementSpec(re.compile(r"\bAndrei\s+Martanov\b", re.IGNORECASE), "Andrei Martyanov", "martyanov_andrei_martanov"),
    ReplacementSpec(re.compile(r"\bAndre\s+Martanov\b", re.IGNORECASE), "Andre Martyanov", "martyanov_andre_martanov"),
    ReplacementSpec(re.compile(r"\bAndre\s+Martianos\b", re.IGNORECASE), "Andre Martyanov", "martyanov_andre_martianos"),
    ReplacementSpec(re.compile(r"\bmartynaov\b", re.IGNORECASE), "Martyanov", "martyanov_martynaov"),
    ReplacementSpec(re.compile(r"\bMartinov\b"), "Martyanov", "martyanov_martinov"),
    ReplacementSpec(re.compile(r"\bMartanov\b"), "Martyanov", "martyanov_martanov"),
    ReplacementSpec(

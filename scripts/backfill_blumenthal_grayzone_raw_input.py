#!/usr/bin/env python3
"""Backfill Max Blumenthal Grayzone articles into raw-input/.

Thin wrapper around ``backfill_author_page_raw_input.py`` with Grayzone defaults.
...
DEFAULT_AUTHOR_URL = "https://thegrayzone.com/author/max-blumenthal/"
DEFAULT_DOMAIN = "thegrayzone.com"
DEFAULT_PUBLICATION = "thegrayzone.com"
DEFAULT_THREAD = "blumenthal"

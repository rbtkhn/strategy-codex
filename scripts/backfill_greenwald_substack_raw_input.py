#!/usr/bin/env python3
"""Backfill Glenn Greenwald Substack into strategy-notebook raw-input/.

Thin wrapper around ``backfill_substack_raw_input.py`` with Greenwald defaults.
...
DEFAULT_HOSTNAME = "greenwald.substack.com"

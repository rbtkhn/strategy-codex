#!/usr/bin/env python3
"""Backfill Douglas Macgregor X posts into strategy-notebook raw-input/.

Thin wrapper around ``backfill_x_profile_raw_input.py`` for the Macgregor lane.
...
DEFAULT_PROFILE_URL = "https://x.com/DougAMacgregor"

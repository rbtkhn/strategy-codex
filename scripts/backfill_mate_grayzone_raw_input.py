#!/usr/bin/env python3
"""Backfill Aaron Maté Grayzone articles into strategy-notebook raw-input/.

Thin wrapper around ``backfill_author_page_raw_input.py`` with Maté defaults.
...
DEFAULT_AUTHOR_URL = "https://thegrayzone.com/author/aaron-mate/"

#!/usr/bin/env python3
"""Backfill Jacques Baud Postil articles into strategy-notebook raw-input/.

Thin wrapper around ``backfill_author_page_raw_input.py`` with Baud defaults.
...
DEFAULT_AUTHOR_URL = "https://www.thepostil.com/author/jacques-baud/"
DEFAULT_DOMAIN = "thepostil.com"
DEFAULT_PUBLICATION = "thepostil.com"
DEFAULT_THREAD = "baud"

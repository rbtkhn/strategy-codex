...
def enrich_row_falsifiers(row: dict[str, Any], *, event_id: str, path: str) -> tuple[dict[str, Any], dict[str, Any] | None]:
    ...
    from registry_pipeline.contracts import infer_prediction_type as _infer_pt
...
def build_inference_report(
    ...
    return {
        "_meta": {
            "generated": True,
            "source": "scripts/registry_pipeline/probabilistic_falsifier_engine.py",
...
def main() -> int:
    ...
    from registry_pipeline.registry_writer import REGISTRY_PATH, load_registry

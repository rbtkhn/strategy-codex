...
from registry_pipeline.contracts import find_duplicate_fingerprints  # noqa: E402
from registry_pipeline.registry_writer import REGISTRY_PATH, append_changelog, load_registry  # noqa: E402
...
def main() -> int:
    ...
    if args.apply:
        ...
        from registry_pipeline.registry_writer import RegistryGateError, compile_registry

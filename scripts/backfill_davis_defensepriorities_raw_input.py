#!/usr/bin/env python3
"""Backfill Daniel Davis Defense Priorities articles into raw-input/.

Thin wrapper around ``backfill_author_page_raw_input.py`` with Davis defaults.
...
DEFAULT_AUTHOR_URL = "https://www.defensepriorities.org/people/daniel-davis/"
DEFAULT_DOMAIN = "defensepriorities.org"
DEFAULT_PUBLICATION = "defensepriorities.org"
DEFAULT_THREAD = "davis"

#!/usr/bin/env python3
"""Backfill Simplicius Substack into strategy-notebook raw-input/.

Thin wrapper around ``backfill_substack_raw_input.py`` with Simplicius defaults.
...
DEFAULT_HOSTNAME = "simplicius76.substack.com"

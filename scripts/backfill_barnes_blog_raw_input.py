#!/usr/bin/env python3
"""Backfill Barnes Law blog posts into strategy-notebook raw-input/.

Thin wrapper around ``backfill_author_page_raw_input.py`` for the Barnes lane.
Treat the blog as a discovery index, not a completeness mandate.
"""
...
DEFAULT_AUTHOR_URL = "https://www.barneslawllp.com/blog"
DEFAULT_DOMAIN = "barneslawllp.com"
DEFAULT_PATH_SHAPE = "any-article"
DEFAULT_PUBLICATION = "barneslawllp.com"
DEFAULT_THREAD = "barnes"

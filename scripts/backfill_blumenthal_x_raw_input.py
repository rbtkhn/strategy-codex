#!/usr/bin/env python3
"""Backfill Max Blumenthal X posts into strategy-notebook raw-input/.

Thin wrapper around ``backfill_x_profile_raw_input.py`` with Blumenthal defaults.
"""
...
DEFAULT_PROFILE_URL = "https://x.com/MaxBlumenthal"

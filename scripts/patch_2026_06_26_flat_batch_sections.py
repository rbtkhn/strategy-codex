...
CAPTURES: dict[str, dict] = {
    ...
    "source-daniel-davis-seyed-marandi-hormuz-tolls-fees-2026-06-26.md": {
        ...
        "anchors": [
            ...
            'And the Iranian said, "No, there there are going to be fees on day 61."',
            "Secretary Rubio saying uh a couple of comments here.",
            "like a thousand people are slaughtered in Warsaw",
            "didn't get a lot of press here in in the west at all",

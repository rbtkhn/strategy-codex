#!/usr/bin/env python3
"""Backfill Globalaffairs Diesen articles into strategy-notebook raw-input/.

Thin wrapper around ``backfill_author_page_raw_input.py`` for the Diesen lane.
...
DEFAULT_AUTHOR_URL = "https://eng.globalaffairs.ru/authors/diesen/"
DEFAULT_DOMAIN = "globalaffairs.ru"
DEFAULT_PATH_SHAPE = "any-article"
DEFAULT_PUBLICATION = "globalaffairs.ru"

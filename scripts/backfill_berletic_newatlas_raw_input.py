#!/usr/bin/env python3
"""Backfill The New Atlas articles into strategy-notebook raw-input/.

Thin wrapper around ``backfill_author_page_raw_input.py`` for the Berletic lane.
Treat the homepage as a discovery index, not a completeness mandate.
"""
...
DEFAULT_AUTHOR_URL = "https://www.thenewatlas.org/"
DEFAULT_DOMAIN = "thenewatlas.org"
DEFAULT_PATH_SHAPE = "any-article"
DEFAULT_PUBLICATION = "thenewatlas.org"
DEFAULT_THREAD = "berletic"

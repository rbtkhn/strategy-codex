#!/usr/bin/env python3
"""Backfill Daniel Davis X posts into strategy-notebook raw-input/.

Thin wrapper around ``backfill_x_profile_raw_input.py`` with Davis defaults.
"""
...
DEFAULT_PROFILE_URL = "https://x.com/DanielLDavis1"

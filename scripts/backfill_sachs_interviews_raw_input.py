#!/usr/bin/env python3
"""Backfill Jeffrey Sachs interview pages into strategy-notebook raw-input/.

Thin wrapper around ``backfill_author_page_raw_input.py`` for Sachs' public
interviews / media surface on jeffsachs.org.
"""
...
DEFAULT_AUTHOR_URL = "https://www.jeffsachs.org/interviewsandmedia"

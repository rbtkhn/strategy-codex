...
Optional pacing (WORK doctrine, not Record): for Pomodoro-style focus intervals inside the ~2-hour design ceiling, see [pomodoro-and-timeboxing.md](../../docs/archive/skill-work-legacy/work-dev/pomodoro-and-timeboxing.md).
...
- This file is distinct from any operator-facing `work-dev` folder used for repo development or integration work (for example `docs/archive/skill-work-legacy/work-dev/` in instance repos).

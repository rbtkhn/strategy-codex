...
- Do **not** merge into `self.md`, `self-evidence.md`, or `archive/grace-mar-instance/bot/prompt.py` without companion approval and `process_approved_candidates.py` (see AGENTS.md).
...
- [archive/grace-mar-instance/bootstrap/grace-mar-bootstrap.md](grace-mar-bootstrap.md) â€” full-repo / work-dev default session

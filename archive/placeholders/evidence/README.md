...
See [State model — Repo layout (grace-mar)](../docs/state-model.md#repo-layout-grace-mar) and [OB1 bridge mapping — Conceptual map](../docs/platform/integrations/ob1/mapping.md#conceptual-map-ob1-cici-grace-mar).

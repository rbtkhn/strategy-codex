...
2. Add or update a pilot dossier under `platform/integrations/printing-press/<cli>/`.
3. Create a portable skill draft under `skills/_drafts/<skill>/SKILL.md`.
4. Promote to `skills/manifest.yaml` only after a separate operator decision.

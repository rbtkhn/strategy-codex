...
```text
skills/_drafts/<printing-press-skill>/SKILL.md
platform/integrations/printing-press/<cli>/README.md
```

Do not add the skill to `skills/manifest.yaml` until the CLI has a successful local smoke test and an operator explicitly chooses promotion.

...
def build_bundle(report: dict[str, Any], packet: dict[str, Any] | None, report_path: Path) -> dict[str, Any]:
    ...
    bundle = {
        ...
        "source_items": [
            ...
            {
                "id": "assumptions-archive/placeholders/evidence",
                "title": "Assumptions vs archive/placeholders/evidence",
        ...
        "presentation_hints": {
            "section_order": ["scenario-summary", "scenario-tree", "assumptions-archive/placeholders/evidence"],

...
python -m integrations.scenario_lab.visualize_simulation \
  --input runtime/artifacts/simulations/compute-sovereignty/report.json \
  --output runtime/artifacts/simulations/compute-sovereignty/visualization.md \
  --bundle-output runtime/artifacts/presentations/scenario-lab-compute-sovereignty.bundle.json
```

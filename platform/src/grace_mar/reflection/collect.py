...
def collect_bundle(
    *,
    ...
    profile = repo_root / "platform/users" / user_id
    ...
    # Negative learning
    neg_path = profile / "archive/queues/reflection-proposals" / "negative-examples.md"
    if neg_path.exists():
        ...
        bundle.slices.append(
            TextSlice(
                f"{user_id}/archive/queues/reflection-proposals/negative-examples.md",
                1,
                len(ls),
                raw,

...
Run from repo root: streamlit run platform/apps/metrics-dashboard.py
Deploy on Render as a web service (streamlit run --server.port 8501 platform/apps/metrics-dashboard.py).
"""

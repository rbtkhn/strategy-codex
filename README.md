...
**Strategy-codex continuity layer:** [`continuity/`](continuity/README.md) — durable chronology, accumulation, and notebook continuity layer formerly at `continuity/`. Legacy redirect: [`continuity/README.md`](continuity/README.md). The old `docs/archive/skill-work-legacy/work-strategy/strategy-notebook/` path is deprecated compatibility only.

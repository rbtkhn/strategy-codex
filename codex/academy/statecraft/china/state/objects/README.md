...
- [Wang Yi](wang-yi.md) - foreign-ministry / national-security continuity carrier for China's diplomatic architecture, anti-disorder posture, Iran / Russia channel, Taiwan warning language, and regional security formulas.

## Use

Open an object when a China-lane draft depends on official or institution-weighted language rather than a general speaker interpretation. The object should answer:

1. What Chinese state interest is being carried?
2. Which institution or office can implement it?

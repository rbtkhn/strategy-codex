...
Each state lane is a book and a machine:

- **Book:** a complete, compelling, evidence-backed story of a civilization under power.
- **Machine:** a governed recursive loop by which new statecraft work improves the lane that will interpret the next case.
...
- **Empire instrument:** outward control mechanism, chokepoint, alliance form, finance lever, coercive center, or dependency structure.
...
A mature state lane should satisfy both sides:

- **Book test:** A serious reader can understand why the state wants what it wants, fears what it fears, and accepts or rejects settlement language.
- **Machine test:** A new crisis can produce structured candidate updates that improve the lane without collapsing into unguided sprawl.

The mature lane is therefore a civilizational volume that learns through statecraft.

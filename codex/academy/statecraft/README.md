...
- **Bismarck** tests whether an instrument keeps aims limited, alliance geometry legible, adversaries isolatable, and post-advantage restraint possible.
...
These existing WORK drafts are candidate examples for the workshop. They remain at their current paths in v1:

- [Hormuz Strait Transit Agreement v0](../../hormuz-strait-transit-agreement-v0.md)
- [Hormuz Reciprocal Transit De-escalation Framework v2.1](../../hormuz-reciprocal-transit-deescalation-framework-v2-1.md)

## Boundary

Use this folder for statecraft drafting and policy-design work, not for generic speaker biography or raw event capture. If a statecraft item begins as a speaker appearance, keep the raw-input and speaker routing in their normal locations and link here only when it becomes material for a treaty, policy paper, memo, or negotiation package.

...
```
codex/predictive-history/<task_id>
```

Examples: `codex/predictive-history/draft-ch07`, `codex/predictive-history/asr-sh08`, `codex/predictive-history/predictions-ch03`.

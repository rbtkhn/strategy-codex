...
- **JIANGâ€“VOICE (v0.1):** Teaching emulation contract for Predictive History â€” `codex/predictive-history/docs/templates/JIANGâ€“VOICE.md`, bridge `jiang-voice.md`, Cursor rule `.cursor/rules/jiang-voice.mdc`. Human-curated; transcript audits to expand Â§ IV markers.

...
**Lane:** operator research (`codex/predictive-history/`). Not Record / RECURSION-GATE unless operator routes there.
...
3. `python3 scripts/work_jiang/normalize_lecture_transcript_asr.py codex/predictive-history/lectures/great-books-NN-….md` (dry-run, then `--write`).

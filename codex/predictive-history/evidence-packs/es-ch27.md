...
Book chapter for essay 27 — Volume VII Part I; divergence end-box per CHAPTER-DIVERGENCE-BOX.md (Volume VII default).
...
*Generated by `scripts/work_jiang/build_evidence_pack.py --chapter es-ch27` — operator lane.*

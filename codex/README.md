...
- **Compatibility name:** **strategy-notebook** remains a legacy path and filename contract in some tooling and generated artifacts; it is not the active architectural owner.
...
- **Raw input (full text, rolling window):** [source-archive/statecraft/README.md](../source-archive/statecraft/README.md) ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â unabridged transcripts and bundled inputs; **manual** prune only (`python3 scripts/prune_strategy_raw_input.py`; while [`.pruning-suspended`](raw-input/.pruning-suspended) exists, use `--apply --override` to delete) ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â policy table in [STRATEGY-NOTEBOOK-ARCHITECTURE.md ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â§ Split ingest model](STRATEGY-NOTEBOOK-ARCHITECTURE.md#split-ingest-model)
...
- **Cursor:** Say **`strategy`** to run the strategy pass ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â [`.cursor/skills/skill-strategy/SKILL.md`](../docs/skill-work/work-strategy/SKILL-STRATEGY-DEPRECATED.md)

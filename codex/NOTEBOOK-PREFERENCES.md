...
**Skill contract:** Together with the architecture doc and [daily-strategy-inbox.md](daily-strategy-inbox.md), this file is **part of** [`skill-strategy`](../docs/skill-work/work-strategy/SKILL-STRATEGY-DEPRECATED.md) — operator defaults the skill **must** apply on a **`strategy`** pass; not optional flavor beside the skill.
...
- **Default on-disk capture** for strategy ingests remains **[daily-strategy-inbox.md](daily-strategy-inbox.md)** per [skill-strategy SKILL.md](../docs/skill-work/work-strategy/SKILL-STRATEGY-DEPRECATED.md).
...
| 2026-04-14 | **Operator command `weave`:** Canonical name for inbox → `days.md` merge; legacy `fold` retired; **`weave`** is the canonical command ([STRATEGY-NOTEBOOK-ARCHITECTURE.md](STRATEGY-NOTEBOOK-ARCHITECTURE.md) § *Weave (terminology)*; [skill-strategy SKILL.md](../docs/skill-work/work-strategy/SKILL-STRATEGY-DEPRECATED.md) **Weave** mode). |
| 2026-04-15 | **External model briefs (LLM digests):** Summary table row + § stub — **§1f** overlay + **`strategy + verify`** falsifiable-table gate before weave; mirrored in [`skill-strategy` SKILL.md](../docs/skill-work/work-strategy/SKILL-STRATEGY-DEPRECATED.md) (description + pre-write checklist + Session hygiene). |

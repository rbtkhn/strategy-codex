...
# Russia's Dark Sage (operator capture)

**Headline (operator):** Russia's Dark Sage  
**Byline:** Scott Ritter · **Published (voice):** Jan 03, 2026

---

Russia's Dark Sage

Normalized US-Russian relations had been promoted as a lofty, yet attainable, objective, But Sergei Karaganov is right—the US is an untrustworthy negotiating partner.
...
The basic tenets enshrined in the Witkoff-Dmitriev dialogue are sound—that both nations could benefit from a relationship built on the notion of mutual respect and trust.
...
**Capture:** Russia's Dark Sage (Substack) · Format: Substack-style essay. Historical and legal passages reflect Ritter’s read; verify dates, quotes, and casualty figures against primary or scholarly sources if promoted.
...
- **Full verbatim (capture):** [provenance/2026-01-03/substack-ritter-russia-dark-sage-karaganov-2026-01-03.md](../../../../years/2026/provenance/2026-01-03/substack-ritter-russia-dark-sage-karaganov-2026-01-03.md)
- **Inbox / triage:** [daily-strategy-inbox.md](../../daily-strategy-inbox.md) (search `thread:ritter`, 2026-01-03)
- **`thread:ritter`** · **verify:** primary capture on disk + voice date + inbox row (SS | / JF | / YT | as applicable)
- **Canonical primary:** https://scottritter.substack.com/p/russias-dark-sage

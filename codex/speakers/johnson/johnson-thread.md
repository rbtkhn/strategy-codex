...
Compatibility note: this file is a legacy continuity surface from the older expert-thread machinery. In the current Johnson shelf, the canonical orthogonality-bearing structure is [johnson-helix.md](johnson-helix.md) plus the distinct host-local arcs it compares, not this file.
...
- YT | cold: **Daniel Davis** Ãƒâ€” **Larry Johnson** Ã¢â‚¬â€ *HORMUZ OPENING, CEASEFIRE ENDING: Conflicting Messages* Ã¢â‚¬â€ dual-register Trump TS vs IRI Lebanon/Hormuz conditions; Bessent sanctions; military Ã¢â‚¬Å“WTFÃ¢â‚¬Â; three-option endgame; Johnson strong C-plane on Trump // hook: stack 04-17 Ã‚Â§1h + Ritter Diesen Iran segment Ã¢â‚¬â€ seams not one Judgment | https://www.youtube.com/watch?v=TBD-davis-johnson-hormuz-2026-04-17 | verify:operator-transcript+pin-canonical-URL+aired:2026-04-17+Truth-Social-primary | thread:johnson | grep:Hormuz+Johnson+Davis+blockade+Bessent

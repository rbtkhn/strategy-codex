# Johnson surface orthogonality review - 2026-05
...
- this review checks whether the Johnson shelf is partitioned well enough between canonical host strands, auxiliary reinforcement, and comparison material
- overlap is suspected because all four host arcs can produce anti-war or anti-coercion conclusions, while the Jiang note can be mistaken for part of Johnson continuity rather than a relational routing object
- this review does not settle whether Johnson is correct; it only tests whether the current shelf structure preserves distinct retrieval jobs
...
`Diesen x Johnson` owns the altitude lane: Gulf vulnerability, regional realignment, strategic overreach, and wider order consequence.
...
- all four host arcs can produce `the U.S. position is deteriorating`, but they reach that conclusion through different grammars: order consequence, feasibility collapse, live crisis motion, or process absurdity

`same conclusion, different host pressure`

- Davis and Napolitano are the nearest adjacency: both can sound skeptical about blockade or escalation, but Davis asks whether coercion can work materially, while Napolitano asks whether the process is irrational, boxed-in, or constitutionally absurd
...
- generic claims like `the U.S. cannot win this war` can blur Diesen, Davis, and Alkorshid unless the operator asks whether the need is altitude, feasibility, or live crisis tempo
- generic claims like `this policy is insane` can blur Davis and Napolitano unless the operator asks whether the need is material impracticality or process absurdity
...
- a direct audit of whether Johnson's shelf is overgrown or falsely multiplied
- a routing answer for Davis versus Napolitano when both seem skeptical of U.S. escalation
- a reminder that comparison notes and maturity notes should not silently turn into extra continuity surfaces

...
Do not treat `johnson-thread.md` as competing with the helix or the host-local arc structure. The orthogonality-bearing structure lives in the helix plus the distinct host transformations it compares.

...
Compatibility note: this file is legacy continuity residue. It is safe for carryover context, but unsafe as a first-open citation surface when the canonical Freeman stack now lives under [statecraft/civ-lens/freeman/](/C:/dev/strategy-codex/statecraft/civ-lens/freeman/README.md) and already routes through the person arc, routing note, bounded month ladder, helix, support spine, and raw-input bench.

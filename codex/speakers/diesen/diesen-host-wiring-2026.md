...
- Native body: [codex/speakers/diesen/stream/](/C:/dev/strategy-codex/codex/speakers/diesen/stream/)
- Stream README: [codex/speakers/diesen/README.md](/C:/dev/strategy-codex/codex/speakers/diesen/README.md)
...
| Karaganov | Russian elite strategic and civilizational doctrine. | [arc](/C:/dev/strategy-codex/codex/speakers/diesen/stream/diesen-karaganov-speaker-arc.md) | Open for Russian doctrinal worldview and elite strategic signaling. |
| Kent | Iran, Israeli influence, Syria/ISIS memory, and U.S. imperial decline. | [arc](/C:/dev/strategy-codex/codex/speakers/diesen/stream/diesen-kent-speaker-arc.md) | Open when a smaller Kent lane needs broader order-transition framing. |
| Krainer | Macro-financial, imperial-breakdown, and world-order-transition analysis. | [arc](/C:/dev/strategy-codex/codex/speakers/diesen/stream/diesen-krainer-speaker-arc.md) | Open for markets, finance, sanctions, and imperial macro stress. |
| Macgregor | Stark force-balance and imperial-distance judgment. | [arc](/C:/dev/strategy-codex/codex/speakers/diesen/stream/diesen-macgregor-speaker-arc.md) | Open for hard strategic consequence rather than detailed operational feasibility. |
| Marandi | Strategic-order, escalation-horizon, and blockade-logic from Tehran's register. | [arc](/C:/dev/strategy-codex/codex/speakers/diesen/stream/diesen-marandi-speaker-arc.md) | Open for Iran as an order-shaping actor, not only a battlefield target. |
...
| Wilkerson | Imperial-decline and strategic-consequence severity. | [arc](/C:/dev/strategy-codex/codex/speakers/diesen/stream/diesen-wilkerson-speaker-arc.md) | Open for U.S. imperial exhaustion, strategic consequence, and military-political decline. |

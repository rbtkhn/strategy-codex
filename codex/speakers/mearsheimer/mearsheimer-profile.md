...
Headings-only pointers into the mapped corpus in [`strategy-expert-mearsheimer-mind.md`](strategy-expert-mearsheimer-mind.md) for **in-voice** passes; **not** a substitute for **primary-ingest** Judgment when a claim must be anchored to his voice on a specific day.
...
1. https://x.com/mearsheimerj
2. https://johnmearsheimer.uchicago.edu/
3. https://www.mearsheimer.com/

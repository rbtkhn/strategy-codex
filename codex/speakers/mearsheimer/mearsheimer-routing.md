...
When the task is not already stream-specific, route Mearsheimer in this order:

1. open the strongest core host lane if the question is clearly `Diesen` or `Davis` shaped
2. open `Napolitano x Mearsheimer` only when the question is specifically defeat-accounting, boxed-in sequence control, or compact anti-war reinforcement
3. open the [source index](mearsheimer-source-index.md) when the relevant appearance lives outside the stable host core or when authored / non-core bench material is the real entry

This is the main reason Mearsheimer remains a codex-side exception shelf rather than a statecraft-native month ladder.
...
| Hedges, Redacted, authored Substack, or shorthand / resolved day captures outside the stable lanes | [mearsheimer-source-index.md](/C:/dev/strategy-codex/codex/speakers/mearsheimer/mearsheimer-source-index.md) | These belong to the `non-core appearance bench`, not to quiet helix expansion or an invented month shelf. |
...
- **Best Napolitano opening file:** [source-judging-freedom-mearsheimer-how-trump-lost-his-war-2026-04-28.md](/C:/dev/strategy-codex/codex/years/2026/provenance/2026-04-28/source-judging-freedom-mearsheimer-how-trump-lost-his-war-2026-04-28.md)
...
- **Current non-core appearance bench:** [mearsheimer-source-index.md](/C:/dev/strategy-codex/codex/speakers/mearsheimer/mearsheimer-source-index.md)
...
- Use the source index when an appearance matters to the shelf but does not belong to the stable double-helix core.

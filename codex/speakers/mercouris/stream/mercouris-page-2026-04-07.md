# Mercouris refined page — 2026-04-07
<!-- word_count: 684 -->

WORK only; not Record.

**Expert:** `mercouris` · **Aired:** 2026-04-07 · **Artifact:** refined page (standalone file under `experts/mercouris/`). Not a `strategy-page` HTML fence in `thread.md` unless you duplicate the same judgment there during EOD compose.
...
Escalation loop: expected heavier U.S. strikes and **Iranian reciprocity**; early reports of infrastructure hits including **Tehran airport** (dual-use caveat) and **Saudi** Gulf terminal (timing uncertain in voice). **Trump** remark on not caring if some acts might be **war crimes**; military **command culture** vs political **lawfare** risk if pendulum swings; Democratic **Hegseth impeachment** trial balloon. **FT** on Iranian **resilience**, **mobile** surface launchers vs silos, drone production “essentially unlimited”; **Telegraph** **Tom Sharpe**: forcing Hormuz by allied navies **impossible** if the U.S. Navy won’t close the coast—**Tripoli** drone approach story **caveated** but fits the caution thesis.

**Underground “missile cities”** and limited **penetrator** inventory; machine tools surviving blasts. Confidential interlocutor: **F-15 navigator** op was a real **personnel recovery** scaled for **heavy air defense**—pushes back on uranium-snatch theory; **UnHerd** cited on **aircraft losses** vs **Vietnam** peak. **Mearsheimer** (same-week Duran): Trump needs a **“victory”**; **LBJ** parallel; least-bad path may require **great-power** mediation. Mercouris pitches **Vance** over **Witkoff/Kushner**, **Rubio–Lavrov**, president must **authorize** diplomacy; **IEA** head quoted on worst **energy shock** ever.
...
- **Saudi terminal / Tehran airport:** Battle damage, timing, official statements.
- **Tripoli** drone claim: **IRI** vs **DoD** readout.
- **Reuters** satellite piece: chain of sourcing; **MoD** confirmations on channel.
- **Graham** dollar remarks: exact clip/transcript.
- **IEA** director quote: date and forum.
- **EU** cross-border levy: confirm policy text.
- **Putin–Erdogan:** **Kremlin** readout vs **Turkish**; follow-on naval activity.
- **Oreshnik** rumor: MoD/telegram vs open source.

---

### Appendix

- **Full verbatim (capture):** [provenance/2026-04-07/duran-mercouris-hormuz-deadline-satellites-oreshnik-2026-04-07.md](../../../../years/2026/provenance/2026-04-07/duran-mercouris-hormuz-deadline-satellites-oreshnik-2026-04-07.md)
...
- **Canonical video:** [raw-input frontmatter `source_url`](../../../../years/2026/provenance/2026-04-07/duran-mercouris-hormuz-deadline-satellites-oreshnik-2026-04-07.md) — replace TBD watch ID when pinned

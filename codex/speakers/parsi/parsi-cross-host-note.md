...
Purpose: keep the guest-distributed side of the Parsi object visible without overstating its maturity.
...
- it **does not yet confirm** a materially dense host-local speaker-arc on the guest side
- it therefore supports the Parsi speaker object without yet requiring a canonical double-speaker-helix claim
...
Create a `parsi-helix.md` only if one or more of the following becomes materially real:
...
Until then, keep Parsi classified as a stream-anchored speaker object with cross-host reinforcement.

...
`diesen` is a first-class strategy-codex cognition stream for volume 2026. Treat this stream as an interpretive voice in the polyphonic cognition lattice, not merely as a source channel.
...
- Speaker arc: [diesen-berletic-speaker-arc.md](diesen-berletic-speaker-arc.md)
- Speaker arc: [diesen-jermy-speaker-arc.md](diesen-jermy-speaker-arc.md)
...
- Speaker arc: [diesen-mcgovern-speaker-arc.md](diesen-mcgovern-speaker-arc.md)
...
Use civ-mem as a compact analytical spine: mechanisms, lenses, historical resonance, fit/mismatch/falsifier, and open analogy risk. The shelf should not duplicate civilization-memory; it should point to case-family labels and exact paths when known.

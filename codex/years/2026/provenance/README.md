...
Use `source-archive/statecraft/` for full source captures, and use repo-root `statecraft/` for live routing, bridge conditioning, continuity, and drafting control.

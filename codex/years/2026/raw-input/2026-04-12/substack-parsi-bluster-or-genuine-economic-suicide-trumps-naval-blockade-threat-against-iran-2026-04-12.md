...
kind: substack-post
thread: parsi
source_url: https://substack.com/@tritaparsi/p-193975700
publication: substack.com/@tritaparsi
slug: bluster-or-genuine-economic-suicide-trumps-naval-blockade-threat-against-iran
author: Trita Parsi
capture_note: Operator paste; public Substack body preserved verbatim from companion capture.
---

# Bluster or genuine economic suicide? Trump's Naval Blockade threat Against Iran
...
2. Stopping tankers carrying Iranian oil wouldn't just be an escalation vis-a-vis Iran, but also against the countries that are buying Iranian oil, which includes China, India, and other Asian countries. I doubt Trump is ready for that escalation, particularly given the upcoming summit in Beijing.

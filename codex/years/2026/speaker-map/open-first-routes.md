...
1. Open the relevant speaker folder under [`../../../speakers/`](../../../speakers/).
2. Read the `*-speaker-object.md` if present.
3. If the question is host-specific, open the matching `host x speaker` arc.
4. If the question is cross-host, open the helix or cross-host note.
5. Use raw-input only when provenance or transcript details matter.
...
- Dialogue Works x Freeman: open [`../alkorshid/alkorshid-freeman-speaker-arc.md`](../alkorshid/alkorshid-freeman-speaker-arc.md), then [`../../../speakers/freeman/freeman-helix.md`](../../../speakers/freeman/freeman-helix.md).
- Davis x Barnes: open [`../davis/davis-barnes-speaker-arc.md`](../davis/davis-barnes-speaker-arc.md), then the Barnes speaker folder if it exists.

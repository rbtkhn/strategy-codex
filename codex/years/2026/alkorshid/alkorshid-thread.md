...
**Companion files:** [alkorshid-profile.md](../../alkorshid/alkorshid-profile.md) and [alkorshid-transcript.md](alkorshid-transcript.md).
...
**Seed:** Minimal **host / interviewer** lane Ã¢â‚¬â€ **Dialogue Works** Ã¢â‚¬â€ opened so **Nima Alkorshid** has an indexed **`thread:alkorshid`** beside recurring guests (**e.g.** **`marandi`**, **`diesen`**) on shared long-forms. Not a substitute for guest analytic **`thread:`** rows.
...
- Inbox | cold: full text in [`transcript-marandi-dialogue-works-trump-plan-dead-after-strike-2026-04-28.md`](raw-input/2026-04-28/transcript-marandi-dialogue-works-trump-plan-dead-after-strike-2026-04-28.md) (pointer; SSOT raw-input **Marandi** episode **/** host lane Ã¢â‚¬â€ symmetric `crosses:marandi`) | thread:alkorshid

...
- The canonical thread shape now lives in [statecraft/templates/speaker-thread-template.md](../statecraft/templates/speaker-thread-template.md), while the canonical page scaffold it hosts lives in [strategy-codex-template-page.md](strategy-codex-template-page.md).
...
| Topic | Document / tool |
|-------|-----------------|
| Thread scaffold | [statecraft/templates/speaker-thread-template.md](../statecraft/templates/speaker-thread-template.md) |

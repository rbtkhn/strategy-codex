...
`alkorshid` is a first-class strategy-codex cognition stream for volume 2026. Treat this stream as an interpretive voice in the polyphonic cognition lattice, not merely as a source channel.
...
- Speaker arcs:
  ...
  - [alkorshid-aguilar-speaker-arc.md](alkorshid-aguilar-speaker-arc.md)
...
host-channel synthesis across long-form interviews and bridge guests.

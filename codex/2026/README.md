# Strategy-Codex Volume 2026

`codex/2026/` is the active year volume for the strategy-codex corpus. It organizes the current polyphonic cognition lattice into first-class cognition-stream shelves, shared source input, and cross-stream synthesis notes.

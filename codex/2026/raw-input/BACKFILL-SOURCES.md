...
| Short-form screenshot / OCR bundles | `scripts/backfill_shortform_bundle_raw_input.py` | `backfill_*_shortform_bundle_raw_input.py` | Generic daily bundle capture for X, Threads, Truth Social, Locals, and similar sources; source adapters should mostly pin platform, account, and thread routing. |

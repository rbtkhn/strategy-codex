...
**Companion files:** [ritter-profile.md](../../ritter/ritter-profile.md) and [ritter-transcript.md](ritter-transcript.md) (7-day verbatim). **See also** [ritter-thread.md](ritter-thread.md) (multi-month journal during split) and [README.md](README.md).

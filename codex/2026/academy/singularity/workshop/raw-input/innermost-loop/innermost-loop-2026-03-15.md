...
slug: the-first-open-source-agentic-ai
post_id: 191046346
---
...
The Singularity already writes code, trades stocks, and diagnoses tumors, but it has never done physics research end-to-end, until today.
...
Named as a nod to GSD (Get S*** Done) , whose adoption proved that AI-native command workflows can work in practice, GPD is free, Apache 2.0 licensed, and runs inside Claude Code, Gemini CLI, Codex, and OpenCode.

Get started at github.com/psi-oss/get-physics-done .
...
Star the repo, file issues, open PRs. The Singularity now has its first physicist on staff.

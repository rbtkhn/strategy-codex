...
**Expert note (PH / work-jiang):** **Predictive History** notebook-facing ingest routes here only Ã¢â‚¬â€ see [strategy-commentator-threads](strategy-commentator-threads.md) special routing rule; corpus lives under `research/external/work-jiang/` (operator scope).
...
- [strength: low] **Repeat:** PH channel hub Ã¢â‚¬â€ verify any calendar claim against lecture index before Links merge.
...
**Rules:** PH upstream only; hub / path anchors Ã¢â‚¬â€ not Record.

### 2026-01

- **2026-01** Ã¢â‚¬â€ No dated notebook ingest Ã¢â‚¬â€ Predictive History channel.  
  _Source:_ web: `https://www.youtube.com/@PredictiveHistory`

### 2026-02

- **2026-02** Ã¢â‚¬â€ No dated notebook ingest Ã¢â‚¬â€ repeat PH channel anchor (corpus: `research/external/work-jiang/`, WORK scope).  
  _Source:_ web: `https://www.youtube.com/@PredictiveHistory`
...
- [strength: high] **Signal (cold):** Jiang Ãƒâ€” Sneako Ãƒâ€” Dugin Ã¢â‚¬â€ [YouTube n44OF1Y7zgo](https://www.youtube.com/watch?v=n44OF1Y7zgo) Ã¢â‚¬â€ verify:work-jiang-vi-15 + `research/external/work-jiang/lectures/interviews-15-sneako-jiang-dugin-eschatology.md`.

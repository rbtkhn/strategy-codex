...
This note is a thin object shim. It does not replace [freeman-routing.md](/C:/dev/strategy-codex/codex/2026/speakers/freeman/freeman-routing.md), [freeman-helix.md](/C:/dev/strategy-codex/codex/2026/speakers/freeman/freeman-helix.md), or [freeman-thread.md](/C:/dev/strategy-codex/codex/2026/speakers/freeman/freeman-thread.md).

## Why Freeman matters

Freeman's utility profile is:

- **diplomatic memory**: distinguishes diplomacy, coercion, alliance, clientage, rivalry, hostility, and enmity
- **China literacy**: reads Beijing staging, Taiwan signaling, and U.S.-China hierarchy from long institutional memory
- **maritime-order transition**: treats Hormuz and Red Sea chokepoints as signs of the weakening of Anglo-American naval hegemony
- **West Asia statecraft**: separates Gulf-state interests, Israeli objectives, Iranian sovereignty, and U.S. military exhaustion
- **constitutional decay**: connects presidential war-making, congressional abdication, elite insulation, and plutocratic pressure
...
- [freeman-routing.md](/C:/dev/strategy-codex/codex/2026/speakers/freeman/freeman-routing.md)

For object shape:

- [freeman-helix.md](/C:/dev/strategy-codex/codex/2026/speakers/freeman/freeman-helix.md)

For recent accumulated prose:

- [freeman-thread.md](/C:/dev/strategy-codex/codex/2026/speakers/freeman/freeman-thread.md)

...
| John Helmer | `John Helmer` | Alkorshid, Mercouris | Hormuz, Beijing, and Gulf-power read; tracks escalation, pressure, and bargaining structure. | [lattice](COGNITION-STREAMS.md) / [threads](strategy-commentator-threads.md) |
...
| Larry Wilkerson | `Wilkerson` | Johnson, Alkorshid, Diesen | Former state-insider / war-gamble critique; strong on executive drift, escalation risk, and alliance exhaustion. | [lattice](COGNITION-STREAMS.md) / [threads](strategy-commentator-threads.md) |

...
**Arc:** Islamabad collapse → **04-13** expert scaffold → **04-14** batch-analysis / multi-page density → **04-15** daily-brief native overlay + external digest triage + **`weave`** into **`days.md`** **§1d/§1e** **Links** row (no new standalone knot file — pages live in **`experts/<id>/thread.md`**). **Legacy index:** [legacy page index](../../legacy page index) (empty **`knots:`** on disk). **`strategy-page` ids** (do not merge Judgment across pages without each page’s **Receipt** / **seams**):

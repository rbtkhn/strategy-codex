...
- **Ingest flow:** inbox first when practical; this file holds **canonical adjudication rows** + optional pointers from [`chapters/YYYY-MM/days.md`](chapters/2026-04/days.md) **`### Predictive Outlook`**. **Direct rows here are OK** without a prior inbox line when attribution is already solid.

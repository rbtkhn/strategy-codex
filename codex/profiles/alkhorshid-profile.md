...
Use `alkhorshid` as the canonical voice-shelf id in new routing and doctrine. `nima` remains a legacy thread compat spelling in ingest YAML where load-bearing.

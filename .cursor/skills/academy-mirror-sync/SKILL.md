...
description: Verify academy mirror folders against their public remotes and the parent strategy-codex gitlink. Use when the user asks whether a mirrored repo folder such as codex/academy/ph-civ is in sync with its GitHub repo, origin/main, or parent submodule pointer.
portable: true
version: 0.1.0
tags:
- operator
...
- Mirror folder: `codex/academy/ph-civ`
...
- For the public Predictive History mirror, keep `codex/academy/ph-civ` as the default mirror path.

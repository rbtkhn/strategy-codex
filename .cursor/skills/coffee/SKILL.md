...
When the operator asks for daily brief, Polymarket/polling, `last30days`, or current-events judgment, use explicit daily-brief / strategy / check-streams routes. Coffee C only owns the work once the output is a treaty framework, policy paper, negotiation brief, sanctions design, alliance architecture, sovereignty argument, or institutional memo.

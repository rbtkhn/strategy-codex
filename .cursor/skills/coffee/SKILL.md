...
**Coffee Hub Menu (terminology):** **`coffee` Step 2** fixed **A-D** hub (**Steward / Engineer / Strategist / Capitalist**) is the **Coffee Hub Menu**. **Conductor** is separate and routes directly by master name, `conductor`, or the standalone conductor skill. When routing continues into **Conductor**, resolution uses the **Master Selection Menu** (masters **A-E**, Toscanini through Bernstein) and then typically the **Conductor Action Menu** (four movement-labeled repo-grounded next moves; [CONDUCTOR-PASS - Conductor action MCQ](../../../docs/skill-work/work-coffee/CONDUCTOR-PASS.md#conductor-action-mcq)). Layer map: [CONDUCTOR-LAYER-MAP.md](../../../docs/skill-work/work-coffee/CONDUCTOR-LAYER-MAP.md).
...
**Letter-collision:** The **Master Selection Menu** (**masters A-E**) and the **Conductor Action Menu** (**four movements A-D** for the resolved slug) reuse letters that may also appear in the **Coffee Hub Menu**. When both a Coffee Hub Menu and a Conductor Action Menu could appear in one reply, **label** them explicitly; see [CONDUCTOR-PASS.md](../../../docs/skill-work/work-coffee/CONDUCTOR-PASS.md). **Do not** reuse bare **`pick E`** without naming which menu.
